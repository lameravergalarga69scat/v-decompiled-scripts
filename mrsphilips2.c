...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		__LIB_37__::func_201(Local_64.f_9, 0, 0, 0, 0, 0);
...
void func_246(int iParam0, int iParam1)//Position - 0x2F34D
{
	...
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		if (__LIB_0__::func_703(iParam1, 64))
		{
			...
			if (!__LIB_38__::func_226(Var0.f_3))
			{
...
int func_248(var uParam0, int iParam1, int iParam2, var uParam3)//Position - 0x2F46D
{
	...
	if (*uParam0 == 1)
	{
		...
		if (func_674(uParam0->f_2, &(uParam0->f_4), &(uParam0->f_7), &(uParam0->f_8)))
		{
			...
			{
				if ((func_654(uParam0->f_2, &sVar9, &cVar10) || __LIB_17__::func_691(uParam0->f_2, &sVar11, &uVar12, &uVar13, &uVar14, &uVar15, &uVar16, &uVar17)) || __LIB_17__::func_690(uParam0->f_2, &sVar18))
				{
			...
			if (iVar20 != 145)
			{
				...
				__LIB_36__::func_995(PLAYER::PLAYER_PED_ID(), &(Global_99845[iVar20 /*98*/]), &(Global_100148[iVar20 /*3*/]), &(Global_100158[iVar20]), &(Global_100140[iVar20]), &(Global_4541522[iVar20]));
	...
	if (*uParam0 == 4)
	{
		...
		{
			if (__LIB_38__::func_232(&(uParam0->f_62), iVar29, uParam3, fVar30, fVar31, bVar32, bVar33, &(uParam0->f_8), 0, 0))
			{
				bVar35 = true;
			}
		}
		else
		{
			...
			if (__LIB_38__::func_233(&(uParam0->f_62), uParam0->f_62.f_10, iVar29, uParam3, fVar30, fVar31, bVar32, bVar33, &Var36, 2))
			{
				bVar35 = true;
			}
		}
			...
			if (iVar39 >= iVar40)
			{
				...
				if (StackVal)
				{
					if (!uParam0->f_62.f_19)
					{
						...
						{
							bVar44 = false;
							if (__LIB_43__::func_529(&(uParam0->f_17), bVar27, bVar28, 0))
							{
								bVar44 = true;
							}
							if (bVar44)
...
int func_686(int iParam0, bool bParam1)//Position - 0x999C6
{
	...
	Global_22965.f_39 = 1;
	__LIB_43__::func_529(&Global_22965, 0, 0, 0);
