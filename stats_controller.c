...
void func_2()//Position - 0xD7
{
	...
	bVar1 = false;
	if ((iLocal_55 == 6 && __LIB_2__::func_273(64)) || (iLocal_55 == 5 && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("pilot_school")) > 0))
	{
		bVar1 = true;
		iLocal_60 = 1;
	}
	func_78();
	if (Global_97723 || (Global_97724 && !__LIB_0__::func_540(0)))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			while (iVar2 < 8)
			{
				__LIB_0__::func_636(iLocal_58, iVar2);
				iVar2++;
			}
			Global_97723 = 0;
		}
	...
	if (!bVar1)
	{
		if (((((((((PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !__LIB_0__::func_43(iLocal_58))) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) || __LIB_0__::func_201()) || CUTSCENE::IS_CUTSCENE_PLAYING()) || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || Global_78317) || Global_97725) || iLocal_61)
		{
			iLocal_82 = 1;
	...
	if (((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && (MISC::GET_GAME_TIMER() - iLocal_56) > 2000) || (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && NETWORK::IS_TIME_MORE_THAN(NETWORK::GET_NETWORK_TIME(), NETWORK::GET_TIME_OFFSET(iLocal_57, 2000)))) || bLocal_59)
	{
		...
		while (iVar12 < iVar11)
		{
			...
			__LIB_0__::func_479(iLocal_58, iVar8, &iVar6, &iVar7);
			if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
				iVar3 = __LIB_0__::func_369(iVar7, -1, 0);
			}
			else if (iVar8 == 0)
			{
			...
			if (func_56(iLocal_58, iVar8, iVar3, &iVar4))
			{
				if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
				{
					__LIB_0__::func_413(iVar7, iVar4, -1, 1, 0);
				}
				else if (iVar8 == 0)
				{
				...
				if (iVar4 > __LIB_39__::func_794(iLocal_58, iVar8, -1))
				{
					if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
					{
					...
					iVar14 = iVar4;
					iVar15 = (iVar14 - (iVar14 % __LIB_18__::func_30(iLocal_58, iVar8)));
					if ((iVar14 % __LIB_18__::func_30(iLocal_58, iVar8)) >= 0)
					{
						iVar15 = (iVar15 + __LIB_18__::func_30(iLocal_58, iVar8));
					}
					if (iVar14 >= iVar15)
					{
						iVar14 = iVar15;
					...
					{
						iVar14 = (iVar15 - __LIB_18__::func_30(iLocal_58, iVar8));
					}
					if (iVar4 > iVar14)
					{
						bVar13 = false;
							...
							if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
							{
								if (__LIB_0__::func_351(117, -1) == 0)
								{
									if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_9())
									{
										...
										__LIB_0__::func_513(117, 1, -1, 1);
									}
								}
							}
							iLocal_61 = 1;
							iLocal_64 = (iVar4 - iVar3);
							iLocal_64 = (iLocal_64 + (iVar3 % __LIB_18__::func_30(iLocal_58, iVar8)));
							iLocal_65 = iVar4;
							iLocal_62 = iLocal_58;
							iLocal_63 = iVar8;
						}
				...
				__LIB_0__::func_636(iLocal_58, iVar8);
			}
			else if (iVar4 < iVar5)
			{
				bVar16 = true;
...
int func_9()//Position - 0x84B
{
	...
	if ((HUD::IS_HUD_HIDDEN() && HUD::IS_RADAR_HIDDEN()) && !__LIB_4__::func_358(PLAYER::PLAYER_ID()))
	{
		return 0;
	}
	if (Global_1931617 == 1)
	...
	{
		if (__LIB_2__::func_85(PLAYER::PLAYER_PED_ID()) == joaat("WEAPON_SNIPERRIFLE") || __LIB_2__::func_85(PLAYER::PLAYER_PED_ID()) == joaat("WEAPON_HEAVYSNIPER"))
		{
			return 0;
		}
	}
	...
	if (!__LIB_0__::func_156(PLAYER::PLAYER_ID(), 1, 0))
	{
		return 0;
	}
	...
	if (__LIB_5__::func_847(PLAYER::PLAYER_ID()))
	{
		return 0;
	}
	Global_1931616 = 1;
...
int func_57(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x1789
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				fVar0 = SYSTEM::TO_FLOAT(__LIB_0__::func_369(64, iParam3, 0));
			}
			break;
		case 1:
			if (iParam0 == 0)
			...
			{
				fVar0 = (__LIB_0__::func_412(20, iParam3) / 175f);
				__LIB_39__::func_637(&fVar0);
			}
			if (iParam0 == 0)
			{
				fVar0 = (fVar0 + SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP0_TIME_SWIMMING"))));
			}
			else if (iParam0 == 1)
			{
				fVar0 = (fVar0 + SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP1_TIME_SWIMMING"))));
			}
			else if (iParam0 == 2)
			{
				fVar0 = (fVar0 + SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP2_TIME_SWIMMING"))));
			}
			else if (iParam0 == 3)
			{
				fVar0 = (fVar0 + SYSTEM::TO_FLOAT(__LIB_18__::func_35(func_63(50, iParam3))));
				__LIB_39__::func_637(&fVar0);
			}
			if (iParam0 == 0)
			{
				fVar0 = (fVar0 + SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP0_TIME_DRIVING_BICYCLE"))));
			}
			else if (iParam0 == 1)
			{
				fVar0 = (fVar0 + SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP1_TIME_DRIVING_BICYCLE"))));
			}
			else if (iParam0 == 2)
			{
				fVar0 = (fVar0 + SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP2_TIME_DRIVING_BICYCLE"))));
			}
			else if (iParam0 == 3)
			{
				fVar0 = (fVar0 + SYSTEM::TO_FLOAT(__LIB_18__::func_35(func_63(47, iParam3))));
				__LIB_39__::func_637(&fVar0);
			}
			if (iParam0 == 3)
			{
				fVar0 = (fVar0 + ((4f * Global_262145.f_24361 /* Tunable: -624142803 */) * IntToFloat(__LIB_0__::func_369(7237, -1, 0))));
			}
			if (iParam0 == 3)
			{
				fVar0 = (fVar0 * 0.25f);
		...
		case 3:
			if (iParam0 == 0)
			{
				fVar0 = (SYSTEM::TO_FLOAT(__LIB_18__::func_33(joaat("SP0_TIME_UNDERWATER"))) / 30f);
			}
			else if (iParam0 == 1)
			{
				fVar0 = (SYSTEM::TO_FLOAT(__LIB_18__::func_33(joaat("SP1_TIME_UNDERWATER"))) / 30f);
			}
			else if (iParam0 == 2)
			{
				fVar0 = (SYSTEM::TO_FLOAT(__LIB_18__::func_33(joaat("SP2_TIME_UNDERWATER"))) / 30f);
			}
			else if (iParam0 == 3)
			{
				fVar0 = (SYSTEM::TO_FLOAT(__LIB_18__::func_33(func_63(52, iParam3))) / 30f);
				__LIB_39__::func_637(&fVar0);
			}
			break;
		case 2:
			...
			{
				fVar0 = (SYSTEM::TO_FLOAT(__LIB_0__::func_369(1500, iParam3, 0)) / 20f);
				__LIB_39__::func_637(&fVar0);
			}
			break;
		case 4:
			...
			{
				fVar0 = (fVar0 + IntToFloat((__LIB_0__::func_369(113, iParam3, 0) / 50)));
				__LIB_39__::func_637(&fVar0);
			}
			break;
		case 5:
			if (iParam0 == 0)
			{
				fVar0 = (SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP0_TIME_DRIVING_PLANE"))) / 10f);
			}
			else if (iParam0 == 1)
			{
				fVar0 = (SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP1_TIME_DRIVING_PLANE"))) / 10f);
			}
			else if (iParam0 == 2)
			{
				fVar0 = (SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP2_TIME_DRIVING_PLANE"))) / 10f);
			}
			else if (iParam0 == 3)
			{
				fVar0 = (SYSTEM::TO_FLOAT(__LIB_18__::func_35(func_63(43, iParam3))) / 10f);
			}
			if (iParam0 == 0)
			{
				fVar0 = (fVar0 + (SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP0_TIME_DRIVING_HELI"))) / 10f));
			}
			else if (iParam0 == 1)
			{
				fVar0 = (fVar0 + (SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP1_TIME_DRIVING_HELI"))) / 10f));
			}
			else if (iParam0 == 2)
			{
				fVar0 = (fVar0 + (SYSTEM::TO_FLOAT(__LIB_18__::func_35(joaat("SP2_TIME_DRIVING_HELI"))) / 10f));
			}
			else if (iParam0 == 3)
			{
				fVar0 = (fVar0 + (SYSTEM::TO_FLOAT(__LIB_18__::func_35(func_63(45, iParam3))) / 10f));
			}
			if (iParam0 == 0)
			{
			...
			{
				fVar0 = (fVar0 + IntToFloat(__LIB_0__::func_369(61, iParam3, 0)));
				__LIB_39__::func_637(&fVar0);
			}
			if ((iParam0 == 0 || iParam0 == 1) || iParam0 == 2)
			{
				iVar4 = __LIB_16__::func_880(iParam0, 0);
				if (iParam0 == 2)
				{
					if (iVar4 == 3)
					{
				...
				iVar4 = __LIB_16__::func_880(iParam0, 1);
				if (iParam0 == 2)
				{
					if (iVar4 == 3)
					{
				...
				iVar4 = __LIB_16__::func_880(iParam0, 2);
				if (iVar4 == 3)
				{
					fVar0 = (fVar0 + 12f);
				}
				...
				iVar4 = __LIB_16__::func_880(iParam0, 3);
				if (iVar4 == 3)
				{
					fVar0 = (fVar0 + 12f);
				}
				...
				iVar4 = __LIB_16__::func_880(iParam0, 6);
				if (iVar4 == 3)
				{
					fVar0 = (fVar0 + 12f);
				}
				...
				iVar4 = __LIB_16__::func_880(iParam0, 4);
				if (iVar4 == 3)
				{
					fVar0 = (fVar0 + 5f);
				}
				...
				iVar4 = __LIB_16__::func_880(iParam0, 5);
				if (iVar4 == 3)
				{
					fVar0 = (fVar0 + 12f);
				}
				...
				iVar4 = __LIB_16__::func_880(iParam0, 7);
				if (iVar4 == 3)
				{
					fVar0 = (fVar0 + 12f);
				}
				...
				iVar4 = __LIB_16__::func_880(iParam0, 8);
				if (iVar4 == 3)
				{
					fVar0 = (fVar0 + 12f);
				}
				...
				iVar4 = __LIB_16__::func_880(iParam0, 11);
				if (iVar4 == 3)
				{
					fVar0 = (fVar0 + 12f);
				}
		...
		case 7:
			...
			{
				fVar0 = (__LIB_0__::func_412(19, iParam3) / 45f);
			}
			if (iParam0 == 0)
			{
			...
			{
				iVar3 = __LIB_0__::func_369(34, iParam3, 0);
		...
		case 6:
			...
			{
				iVar6 = __LIB_0__::func_369(172, iParam3, 0);
			...
			if ((iParam0 == 0 || iParam0 == 1) || iParam0 == 2)
			{
				...
				while (iVar7 < 22)
				{
					switch (__LIB_5__::func_108(iVar7, iParam0))
					{
						case 3:
							iVar8++;
							break;
			...
			{
				fVar0 = (fVar0 + IntToFloat(__LIB_0__::func_991(joaat("MPPLY_SHOOTINGRANGE_WINS")) * 1));
				__LIB_39__::func_637(&fVar0);
			}
			break;
	}
	if (iParam1 != 0)
	{
		iVar11 = __LIB_39__::func_794(iParam0, iParam1, iParam3);
		fVar0 = (fVar0 + IntToFloat(iVar11));
		fVar0 = (fVar0 + IntToFloat(func_58(iParam0, iParam1, iParam3)));
	}
	if (bParam2)
	{
		fVar12 = (fVar0 - (fVar0 % IntToFloat(__LIB_18__::func_30(iParam0, iParam1))));
		if ((fVar0 % IntToFloat(__LIB_18__::func_30(iParam0, iParam1))) >= 0f)
		{
			fVar12 = (fVar12 + IntToFloat(__LIB_18__::func_30(iParam0, iParam1)));
		}
		if (fVar0 >= fVar12)
		{
			fVar0 = fVar12;
		...
		{
			fVar0 = (fVar12 - IntToFloat(__LIB_18__::func_30(iParam0, iParam1)));
		}
	}
...
int func_58(int iParam0, int iParam1, int iParam2)//Position - 0x249C
{
	switch (iParam0)
	{
		...
		case 3:
			...
			{
				case 1:
					return __LIB_0__::func_369(72, iParam2, 0);
					break;
				case 3:
					return __LIB_0__::func_369(74, iParam2, 0);
					break;
				case 2:
					return __LIB_0__::func_369(73, iParam2, 0);
					break;
				case 4:
					return __LIB_0__::func_369(75, iParam2, 0);
					break;
				case 5:
					return __LIB_0__::func_369(76, iParam2, 0);
					break;
				case 6:
					return __LIB_0__::func_369(77, iParam2, 0);
					break;
				case 7:
					return __LIB_0__::func_369(78, iParam2, 0);
					break;
			}
			break;
	}
...
{
	return Global_2826809[iParam0 /*3*/][__LIB_0__::func_153(iParam1)];
}
...
void func_79()//Position - 0x2DE8
{
	...
	if (!iLocal_80)
	{
		if (iLocal_58 == 3)
		{
			if (Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_7)
			{
				iLocal_77 = __LIB_18__::func_33(func_63(148, -1));
				Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_7 = 0;
			}
			else
			{
				iLocal_77 = Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_6;
			}
			if (Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_4 == 0)
			{
				Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_4 = NETWORK::GET_CLOUD_TIME_AS_INT();
			}
			iLocal_79 = Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_4;
			iLocal_78 = Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_5;
		}
		else
		{
			if (Global_113386.f_2363.f_539.f_2292[iLocal_58])
			{
				...
				{
					case 0:
						iLocal_77 = __LIB_18__::func_33(joaat("SP0_TOTAL_WHEELIE_TIME"));
						break;
					case 1:
						iLocal_77 = __LIB_18__::func_33(joaat("SP1_TOTAL_WHEELIE_TIME"));
						break;
					case 2:
						iLocal_77 = __LIB_18__::func_33(joaat("SP2_TOTAL_WHEELIE_TIME"));
						break;
				}
	...
	else if ((NETWORK::GET_CLOUD_TIME_AS_INT() - iLocal_79) > 86400)
	{
		...
		if (iLocal_58 == 3)
		{
			Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_7 = 1;
		}
		else
		{
	...
	if (iLocal_81)
	{
		...
		{
			case 0:
				iVar0 = __LIB_18__::func_33(joaat("SP0_TOTAL_WHEELIE_TIME"));
				break;
			case 1:
				iVar0 = __LIB_18__::func_33(joaat("SP1_TOTAL_WHEELIE_TIME"));
				break;
			case 2:
				iVar0 = __LIB_18__::func_33(joaat("SP2_TOTAL_WHEELIE_TIME"));
				break;
			case 3:
				iVar0 = __LIB_18__::func_33(func_63(148, -1));
				break;
		}
		...
		if (iVar2 > 0)
		{
			__LIB_17__::func_216(iLocal_58, 4, iVar2);
	...
	if (iLocal_58 == 3)
	{
		Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_4 = iLocal_79;
		Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_5 = iLocal_78;
	}
	else
	{
...
void func_82(int iParam0, int iParam1)//Position - 0x31A7
{
	...
	if (iLocal_74)
	{
		...
		if ((!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && *iParam1) && !ENTITY::IS_ENTITY_IN_AIR(*iParam0))
		{
			...
			{
				__LIB_17__::func_216(iLocal_58, 4, 2);
				bVar0 = true;
			}
		}
		if (bVar0)
		...
		if (iLocal_67)
		{
			if (!ENTITY::IS_ENTITY_IN_AIR(*iParam0))
			{
				if (VEHICLE::IS_VEHICLE_ON_ALL_WHEELS(*iParam0))
				{
					...
					{
						__LIB_17__::func_216(iLocal_58, 4, 1);
					}
	...
	if (iLocal_61)
	{
		...
		switch (iLocal_62)
		{
			...
			case 2:
				...
				break;
			case 3:
				iVar1 = __LIB_3__::func_586(PLAYER::PLAYER_ID());
				if (iVar1 == 0)
				{
					return;
				}
...
void func_99()//Position - 0x39DA
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!BitTest(Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_1274, 2))
		{
			fVar0 = (SYSTEM::TO_FLOAT(__LIB_0__::func_369(193, -1, 0)) / 20f);
			iVar1 = SYSTEM::FLOOR(fVar0);
			iVar1 = __LIB_0__::func_340(iVar1, 0, 100);
			__LIB_17__::func_216(3, 2, iVar1);
			MISC::SET_BIT(&(Global_2359296[__LIB_0__::func_155() /*5567*/].f_681.f_1274), 2);
		}
	}
	bLocal_59 = true;
	iLocal_54 = 1;
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		while (iVar0 < 8)
		{
			if (iVar0 != 0)
			{
				...
				__LIB_0__::func_413(iVar2, __LIB_39__::func_794(3, iVar0, -1), -1, 1, 0);
			}
			iVar0++;
		}
		__LIB_0__::func_513(0, 1, -1, 1);
		Global_97723 = 1;
	}
	else
	{
		...
		while (iVar3 < 3)
		{
			...
			while (iVar4 < 8)
			{
				if (iVar4 != 0)
				{
					...
					STATS::STAT_SET_INT(iVar5, __LIB_39__::func_794(iVar3, iVar4, -1), true);
				}
				iVar4++;
			}
			iVar3++;
		}
		Global_113386.f_2363.f_539.f_2387[0] = __LIB_39__::func_794(0, 0, -1);
		Global_113386.f_2363.f_539.f_2387[1] = __LIB_39__::func_794(1, 0, -1);
		Global_113386.f_2363.f_539.f_2387[2] = __LIB_39__::func_794(2, 0, -1);
...
void func_104()//Position - 0x3C05
{
	if (iLocal_54 != 0 && iLocal_53 != 2)
	{
		...
		{
			if ((!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || !__LIB_0__::func_855(PLAYER::PLAYER_ID())) || __LIB_0__::func_3() != 0)
			{
				iLocal_53 = 2;
			}
		}
