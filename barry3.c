...
void __EntryFunction__()//Position - 0x0
{
	...
	if (__LIB_0__::func_323() == 1)
	{
		...
		__LIB_14__::func_865(&iVar0, 410.74f, -778.37f, 28.87f, 359.2f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
		Global_78564 = 0;
	}
	if (__LIB_0__::func_121(Local_39.f_28[0]))
	{
		__LIB_14__::func_878(&iLocal_45, &(Local_39.f_28[0]));
	}
	func_351(1);
	while (true)
	{
	...
	switch (iLocal_42)
	{
		case 0:
			if (func_240())
			{
				...
				__LIB_0__::func_229("LOSE_WANTED_LVL", 7500, 1);
				if (!bLocal_59[3] && __LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), iLocal_45, 15f, 1))
				{
					bLocal_59[3] = __LIB_2__::func_859(&uLocal_67, "BARR3AU", sLocal_65[3], 7, 1, 0, 0);
				}
				if (!bLocal_55)
				{
					func_221(1);
		...
		case 1:
			...
			{
				if ((__LIB_0__::func_725(iLocal_47[0], Local_237, 30f, 1) || __LIB_14__::func_736(iLocal_47[0], PLAYER::PLAYER_PED_ID(), 1126825984, 0)) || __LIB_14__::func_736(iLocal_47[1], PLAYER::PLAYER_PED_ID(), 1126825984, 0))
				{
...
int func_240()//Position - 0x27A1C
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iLocal_46) && STREAMING::HAS_MODEL_LOADED(iLocal_49)) && STREAMING::HAS_MODEL_LOADED(iLocal_50))
	{
		Var0 = { Local_235 };
		fVar1 = fLocal_240;
		if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), Local_235, 1) < __LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), Local_236, 1))
		{
			Var0 = { Local_236 };
			fVar1 = fLocal_241;
		}
	...
	switch (iLocal_42)
	{
		...
		case 1:
			if (!func_247())
			{
				...
				if (iLocal_58 < 3)
				{
					if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), iLocal_45, 15f, 1))
					{
						if (!bLocal_59[iLocal_58])
						{
							if ((MISC::GET_GAME_TIMER() - iLocal_66) > iLocal_232[iLocal_58])
							{
								bLocal_59[iLocal_58] = __LIB_2__::func_859(&uLocal_67, "BARR3AU", sLocal_65[iLocal_58], 7, 0, 0, 0);
							}
						}
						else
						{
			...
			else if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), iLocal_45, 15f, 1))
			{
				if (!bLocal_61)
				{
					bLocal_61 = __LIB_2__::func_859(&uLocal_67, "BARR3AU", "BARRY3_TRICK", 7, 0, 0, 0);
				}
			}
			if (!iLocal_53)
			{
				...
				else if (!__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), iLocal_45, 100f, 1))
				{
					iLocal_42 = 2;
				}
			}
...
{
	if (__LIB_0__::func_687(iLocal_45, PLAYER::PLAYER_PED_ID(), 7f, 1))
	{
		if (!PED::IS_PED_HEADTRACKING_PED(iLocal_45, PLAYER::PLAYER_PED_ID()))
		{
	...
	if (__LIB_0__::func_687(iLocal_45, PLAYER::PLAYER_PED_ID(), 6f, 1))
	{
		if (!PED::IS_PED_HEADTRACKING_PED(PLAYER::PLAYER_PED_ID(), iLocal_45))
		{
...
bool func_247()//Position - 0x27E1A
{
	if (PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (__LIB_0__::func_687(iLocal_45, PLAYER::PLAYER_PED_ID(), 40f, 1))
			{
				bLocal_54 = true;
			}
			else
		...
		{
			if (__LIB_0__::func_687(iLocal_45, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 15f, 1))
			{
				bLocal_55 = true;
				AUDIO::STOP_SCRIPTED_CONVERSATION(false);
				func_221(0);
	...
	switch (iLocal_42)
	{
		...
		case 1:
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_242))
			{
				if (iLocal_64 == 0)
				{
					if (__LIB_2__::func_859(&uLocal_67, "BARR3AU", "BAR_3_INT_LO", 8, 0, 0, 0))
					{
						iLocal_64 = 1;
					}
				}
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (__LIB_14__::func_740(1, 1093140480, 0))
			{
				...
				SYSTEM::WAIT(0);
				__LIB_14__::func_592(416.8295f, -762.7533f, 27.396f, 416.6834f, -767.3608f, 34.4159f, 6f, 411.6f, -773.5004f, 27.9818f, 4.0678f, 1, 1, 1, 0, 0);
...
void func_285(int iParam0, var uParam1, int iParam2)//Position - 0x29638
{
	...
	__LIB_16__::func_974(iParam0, &Var2, 0, -1);
	__LIB_16__::func_974(iParam0, uParam1, iParam2, -1);
	iVar5 = 0;
	iVar6 = 0;
	iVar0 = 0;
	while (iVar0 < 12)
...
void func_290()//Position - 0x2A202
{
	...
	{
		if (__LIB_0__::func_692(iLocal_45))
		{
			if (!bLocal_57 && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 415.47806f, -771.7041f, 27.855623f, 415.5606f, -759.9372f, 31.361616f, 7.25f, false, true, 0) || __LIB_7__::func_691()))
			{
				bLocal_57 = true;
				if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), iLocal_45, 5f, 1))
				{
					bLocal_63 = true;
				}
			}
			if (bLocal_57)
			{
				...
				if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), iLocal_45, 2.5f, 1))
				{
			...
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_45, sLocal_43, "lead_in", 3))
			{
				if (iLocal_62 == 0)
				{
					if (__LIB_2__::func_859(&uLocal_67, "BARR3AU", "BAR_3_INT_LI", 8, 0, 0, 0))
					{
						iLocal_62 = 1;
					}
				}
...
void func_301()//Position - 0x2A651
{
	...
	if (iLocal_42 == 0)
	{
		...
		__LIB_0__::func_222(&uLocal_67, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		__LIB_0__::func_222(&uLocal_67, 3, iLocal_45, "BARRY", 0, 1);
	...
	if (iLocal_42 == 1)
	{
		if ((HUD::HAS_ADDITIONAL_TEXT_LOADED(0) && STREAMING::HAS_MODEL_LOADED(iLocal_51)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_43))
		{
			if (__LIB_0__::func_323())
			{
				switch (__LIB_0__::func_344())
				{
					case 0:
						...
						__LIB_14__::func_659(iLocal_45, Local_234, fLocal_239, 1, 1);
						...
						func_264();
						__LIB_0__::func_427(Local_233, fLocal_238, 1, 0);
			...
			{
				__LIB_14__::func_851("BAR_5_RCM_p2", 0);
				if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
				{
					if (__LIB_0__::func_121(PLAYER::PLAYER_PED_ID()))
					{
...
int func_310()//Position - 0x2AB0E
{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(iLocal_45))
	{
		...
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_45, PLAYER::PLAYER_PED_ID(), true) || __LIB_17__::func_33(PLAYER::PLAYER_PED_ID(), iLocal_45, 1))
		{
		...
		else if (__LIB_17__::func_123(iLocal_45, 1, 1116471296, 1126825984, 0, 0, 0, 0) || __LIB_17__::func_33(PLAYER::PLAYER_PED_ID(), iLocal_45, 1))
		{
			if (!iLocal_53)
			{
...
void func_329()//Position - 0x2B4F9
{
	switch (iLocal_42)
	{
		case 0:
			...
			{
				__LIB_14__::func_880(sLocal_40, 1);
			}
			iLocal_42 = 1;
			break;
		case 1:
			...
			else if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_40))
			{
				if (__LIB_0__::func_692(iLocal_45))
				{
					if (__LIB_0__::func_692(PLAYER::PLAYER_PED_ID()) && __LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), iLocal_45, 15f, 1))
					{
						func_330();
					}
				}
...
int func_330()//Position - 0x2B57D
{
	...
	if (!bLocal_60)
	{
		...
		else
		{
			...
			if (iVar0 == 0)
			{
				bLocal_60 = __LIB_14__::func_535(&uLocal_67, "BARR3AU", "BARRY3_EEP", "BARRY3_EEP_1", 9, 1, 0);
			}
			else if (iVar0 == 1)
			{
				bLocal_60 = __LIB_14__::func_535(&uLocal_67, "BARR3AU", "BARRY3_EEP", "BARRY3_EEP_2", 9, 1, 0);
			}
			else
			{
				bLocal_60 = __LIB_14__::func_535(&uLocal_67, "BARR3AU", "BARRY3_EEP", "BARRY3_EEP_3", 9, 1, 0);
			}
		}
	}
	if (bLocal_60)
...
int func_464(var uParam0)//Position - 0x38466
{
	...
	switch (iLocal_37)
	{
		...
		case 2:
			...
			{
				if (__LIB_14__::func_842(&(uParam0->f_28[0]), 49, Var1, fVar2, "RC LAUNCHER: BARRY 3", 1))
				{
...
void func_475()//Position - 0x388BE
{
	...
	__LIB_0__::func_221(&uLocal_67, 1);
	__LIB_0__::func_221(&uLocal_67, 3);
	HUD::CLEAR_PRINTS();
