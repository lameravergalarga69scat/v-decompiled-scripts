...
{
	int iVar0;
	__LIB_3__::func_122(&(uParam0->f_43.f_5));
	func_5(uParam0, 1);
...
void func_9(var uParam0)//Position - 0x2C9
{
	...
	{
		case 0:
			__LIB_2__::func_487(&(uParam0->f_43), 11);
			func_65(uParam0, 1);
			break;
		case 1:
			Global_1946234 = 0;
			...
			if (__LIB_13__::func_598(PLAYER::PLAYER_PED_ID(), uParam0[uParam0->f_43.f_2 /*14*/]) && __LIB_15__::func_800(PLAYER::PLAYER_PED_ID(), (uParam0[uParam0->f_43.f_2 /*14*/])->f_8.f_3, (*uParam0)[uParam0->f_43.f_2 /*14*/]))
			{
				...
				else
				{
					...
					if (uParam0->f_43.f_5 == -1)
					{
						...
						{
							__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "MPJAC_SIT" /* GXT: Press ~INPUT_CONTEXT~ to sit down. */, 0, 0, 0, 0);
						}
					}
		...
		case 4:
			...
			__LIB_5__::func_848(uParam0->f_43.f_2);
			func_65(uParam0, 5);
			break;
		case 5:
			func_35(uParam0);
			...
			if ((iVar6 != 1 && iVar6 != 0) || __LIB_3__::func_526(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), fVar8, 5f))
			{
				...
				__LIB_2__::func_486(&(uParam0->f_43), 8);
				func_65(uParam0, 6);
			}
			break;
		case 6:
			if (__LIB_0__::func_624(&(uParam0->f_43), 10) || __LIB_6__::func_518())
			{
				__LIB_2__::func_487(&(uParam0->f_43), 10);
				func_30(uParam0);
			}
			func_35(uParam0);
			func_16(uParam0);
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar9))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar9) >= 1f)
				{
					...
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(uParam0->f_43.f_1);
					__LIB_2__::func_486(&(uParam0->f_43), 8);
					__LIB_2__::func_486(&(uParam0->f_43), 11);
				}
				else
				{
					__LIB_2__::func_487(&(uParam0->f_43), 8);
				}
			}
			else if (!__LIB_0__::func_624(&(uParam0->f_43), 8))
			{
				func_65(uParam0, 8);
			}
			break;
...
int func_11(var uParam0)//Position - 0x894
{
	...
	iVar0 = (uParam0->f_43.f_8.f_1 + 1 % __LIB_13__::func_740(uParam0->f_43.f_8));
...
void func_16(var uParam0)//Position - 0x98D
{
	...
	if (uParam0->f_43.f_4 == 6)
	{
		...
		if ((uParam0->f_43.f_4 == 6 && !ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), joaat("block_interrupt"))) && !__LIB_0__::func_624(&(uParam0->f_43), 12))
		{
		...
		else
		{
			...
			if (((((!HUD::IS_PAUSE_MENU_ACTIVE() && !__LIB_0__::func_624(&(uParam0->f_43), 0)) && !__LIB_0__::func_624(&(uParam0->f_43), 4)) && !__LIB_1__::func_512()) && !__LIB_2__::func_65(1)) && uParam0->f_43.f_8.f_2 != 3)
			{
				if (uParam0->f_43.f_5 == -1)
				{
					if (uParam0->f_43.f_8 == 1 || uParam0->f_43.f_8 == 0)
					{
						if (PAD::IS_USING_KEYBOARD_AND_MOUSE(2 /*FRONTEND_CONTROL*/))
						{
							if (bVar2)
							{
								...
								{
									__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_SEAT_PC_BM" /* GXT: Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up. */, 0, 0, 0, 0);
								}
								else if (__LIB_7__::func_974(PLAYER::PLAYER_ID()) == 2)
								{
									__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_SEAT_PC_TOU" /* GXT: Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up. */, 0, 0, 0, 0);
								}
								else
								{
									__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_SEAT_PC" /* GXT: Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up. */, 0, 0, 0, 0);
								}
							}
							else
							{
								__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "MPOF_AC_PC_EXIT" /* GXT: Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up. */, 0, 0, 0, 0);
							}
						}
						else if (bVar2)
						{
							if (__LIB_7__::func_974(PLAYER::PLAYER_ID()) == 3)
							{
								__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_SEAT_BM" /* GXT: Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up. */, 0, 0, 0, 0);
							}
							else if (__LIB_7__::func_974(PLAYER::PLAYER_ID()) == 2)
							{
								__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_SEAT_TOU" /* GXT: Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up. */, 0, 0, 0, 0);
							}
							else
							{
								__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_SEAT" /* GXT: Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up. */, 0, 0, 0, 0);
							}
						}
						else
						{
							__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "MPOF_AC_EXIT" /* GXT: Use ~INPUT_SCRIPT_LEFT_AXIS_X~ to change pose.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up. */, 0, 0, 0, 0);
						}
					}
					else if (uParam0->f_43.f_8 == 2)
					{
						if (PAD::IS_USING_KEYBOARD_AND_MOUSE(2 /*FRONTEND_CONTROL*/))
						{
							if (bVar2)
							{
								if (__LIB_7__::func_974(PLAYER::PLAYER_ID()) == 3)
								{
									__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_PSEAT_PC_BM" /* GXT: Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up. */, 0, 0, 0, 0);
								}
								else if (__LIB_7__::func_974(PLAYER::PLAYER_ID()) == 2)
								{
									__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_PSEAT_PC_TOU" /* GXT: Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up. */, 0, 0, 0, 0);
								}
								else
								{
									__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_PSEAT_PC" /* GXT: Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_SCRIPT_RRIGHT~ to stand up. */, 0, 0, 0, 0);
								}
							}
							else
							{
								__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "MPOFSEAT_PCEXIT" /* GXT: Press ~INPUT_SCRIPT_RRIGHT~ to stand up. */, 0, 0, 0, 0);
							}
						}
						else if (bVar2)
						{
							if (__LIB_7__::func_974(PLAYER::PLAYER_ID()) == 3)
							{
								__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_PSEAT_BM" /* GXT: Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up. */, 0, 0, 0, 0);
							}
							else if (__LIB_7__::func_974(PLAYER::PLAYER_ID()) == 2)
							{
								__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_PSEAT_TOU" /* GXT: Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up. */, 0, 0, 0, 0);
							}
							else
							{
								__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "DJ_PSEAT" /* GXT: Press ~INPUT_FRONTEND_X~ to watch DJ live stream.~n~Press ~INPUT_FRONTEND_RIGHT~ to stand up. */, 0, 0, 0, 0);
							}
						}
						else
						{
							__LIB_5__::func_569(&(uParam0->f_43.f_5), 4, "MPOFSEAT_EXIT" /* GXT: Press ~INPUT_FRONTEND_RIGHT~ to stand up. */, 0, 0, 0, 0);
						}
					}
				}
				if (uParam0->f_43.f_4 == 6)
	...
	__LIB_2__::func_487(&(uParam0->f_43), 9);
}

bool func_28(var uParam0)//Position - 0x11B9
{
	return __LIB_0__::func_624(&(uParam0->f_43), 9);
}
...
Vector3 func_47(var uParam0)//Position - 0x165B
{
	...
	if (__LIB_1__::func_394() && uParam0->f_43.f_8 == 0)
	{
...
int func_52(var uParam0)//Position - 0x1C25
{
	...
	switch (uParam0->f_43.f_8)
	{
		case 2:
			...
			break;
		default:
			iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, __LIB_13__::func_740(uParam0->f_43.f_8));
	}
	if (uParam0->f_43.f_8 == 1)
	{
		if (__LIB_1__::func_394())
...
{
	Stack.Push(!__LIB_0__::func_624(&(uParam0->f_43), 5));
...
int func_56(var uParam0)//Position - 0x1E2C
{
	...
	while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
			...
			{
				if (__LIB_13__::func_598(PLAYER::GET_PLAYER_PED(iVar1), uParam0[uParam0->f_43.f_2 /*14*/]) || __LIB_3__::func_678(iVar1) == uParam0->f_43.f_2)
				{
					return 1;
				}
			}
...
int func_57(var uParam0)//Position - 0x1EB5
{
	...
	while (iVar1 < 10)
	{
		if (((ENTITY::DOES_ENTITY_EXIST(uVar0[iVar1]) && !PED::IS_PED_INJURED(uVar0[iVar1])) && ENTITY::IS_ENTITY_VISIBLE(uVar0[iVar1])) && (__LIB_13__::func_598(uVar0[iVar1], uParam0[uParam0->f_43.f_2 /*14*/]) || SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uVar0[iVar1], false), (uParam0[uParam0->f_43.f_2 /*14*/])->f_1 + (uParam0[uParam0->f_43.f_2 /*14*/])->f_1.f_3 / Vector(2f, 2f, 2f)) < 1f))
		{
			return 1;
		}
		iVar1++;
...
{
	__LIB_13__::func_555(&(uParam0->f_43), 4, __LIB_0__::func_877());
	__LIB_13__::func_555(&(uParam0->f_43), 1, ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false));
	__LIB_13__::func_555(&(uParam0->f_43), 3, PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true));
	__LIB_13__::func_555(&(uParam0->f_43), 0, __LIB_0__::func_77(0));
	__LIB_13__::func_555(&(uParam0->f_43), 2, TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()));
}
