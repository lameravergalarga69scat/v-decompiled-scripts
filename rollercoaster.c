...
void __EntryFunction__()//Position - 0x0
{
	...
	__LIB_14__::func_813(&uLocal_41, 0, iLocal_40);
	__LIB_14__::func_813(&uLocal_41, 1, joaat("prop_roller_car_01"));
	__LIB_14__::func_813(&uLocal_41, 2, joaat("prop_roller_car_02"));
	...
	while (!__LIB_15__::func_238(&uLocal_41) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		__LIB_0__::func_91();
		__LIB_0__::func_715(PLAYER::PLAYER_PED_ID());
		SYSTEM::WAIT(0);
	...
	func_33(222, 1f, 3);
	func_33(232, 0.01f, 0);
	__LIB_12__::func_768(iLocal_191);
	func_30();
	func_29();
	...
	SYSTEM::WAIT(0);
	func_15();
	if (__LIB_0__::func_715(PLAYER::PLAYER_PED_ID()) && __LIB_0__::func_715(Local_164.f_9))
	{
	...
	if (__LIB_0__::func_715(PLAYER::PLAYER_PED_ID()))
	{
		...
		__LIB_15__::func_234(&Local_169, Var1, ENTITY::GET_ENTITY_ROTATION(Local_164.f_9, 2), 50f, Local_169.f_20, Local_169.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
		CAM::ATTACH_CAM_TO_ENTITY(Local_169.f_0, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0.5f, true);
	}
	SYSTEM::WAIT(0);
	if (__LIB_0__::func_715(PLAYER::PLAYER_PED_ID()) && __LIB_0__::func_715(Local_165.f_9))
	{
		__LIB_15__::func_236(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(Local_165.f_9, true), &fVar4, &fVar5, 1);
		__LIB_2__::func_819(&Local_169, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
	...
	while (true)
	{
		...
		fVar8 = (1f - __LIB_0__::func_158(Var3, Var2));
...
void func_6()//Position - 0x833
{
	...
	if (Local_192[iLocal_191 /*3*/].f_1 < Local_192[iVar3 /*3*/].f_1)
	{
		fLocal_190 = __LIB_0__::func_331(fLocal_190, Local_192[iLocal_191 /*3*/].f_1, Local_192[iVar3 /*3*/].f_1);
	}
	else
	{
		fLocal_190 = __LIB_0__::func_331(fLocal_190, Local_192[iVar3 /*3*/].f_1, Local_192[iLocal_191 /*3*/].f_1);
	}
}
...
void func_16(int iParam0, int iParam1)//Position - 0x120F
{
	float fVar0;
	float fVar1;
	__LIB_15__::func_236(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(iParam1, true), &fVar0, &fVar1, 1);
...
void func_17(var uParam0)//Position - 0x123B
{
	...
	*uParam0 = { *uParam0 + Local_160 };
	if (__LIB_0__::func_715(uParam0->f_9) && fVar0 != uParam0->f_3)
	{
...
void func_28(var uParam0, int iParam1, int iParam2)//Position - 0x174D
{
	...
	*uParam0 = { *uParam0 + Local_160 };
	...
	if (__LIB_0__::func_715(uParam0->f_9))
	{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x3E21
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_78130[1 /*14*/] = { __LIB_13__::func_798(iVar10, iVar0, func_70(iParam0, iVar0, -1), -1) };
...
void func_187(bool bParam0)//Position - 0x22179
{
	...
	__LIB_11__::func_684(&Local_169, 0, 1);
	__LIB_2__::func_814(&iLocal_182);
	__LIB_2__::func_814(&iLocal_183);
	__LIB_0__::func_715(PLAYER::PLAYER_PED_ID());
	...
	func_223();
	__LIB_14__::func_808(PLAYER::PLAYER_PED_ID(), -1631.3481f, -1112.6509f, 12.0206f);
...
void func_223()//Position - 0x2387D
{
	...
	while (iVar0 < iLocal_180)
	{
		if (__LIB_0__::func_715(iLocal_180[iVar0]))
		{
