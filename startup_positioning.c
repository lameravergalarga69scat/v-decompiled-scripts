...
void __EntryFunction__()//Position - 0x0
{
	...
	if (((!bVar2 || func_778()) || Global_113386.f_2363.f_4864 != 145) && !(MISC::IS_COMMANDLINE_END_USER_BENCHMARK() || MISC::LANDING_SCREEN_STARTED_END_USER_BENCHMARK()))
	{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && __LIB_0__::func_374(__LIB_14__::func_466()))
		{
			...
			__LIB_15__::func_975(PLAYER::PLAYER_PED_ID());
	...
	else
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (__LIB_17__::func_689(Var0, &Var27, &uVar28, &uVar29))
				{
					Var0 = { Var27 };
					fVar1 = uVar28;
				}
		...
		if (!bVar26 && iVar38 == -1)
		{
			if (!__LIB_39__::func_760(Var0, fVar1, 0, 1, 0))
			{
				if (__LIB_42__::func_756(&Var0, &fVar1, 0, 0, 1, 1065353216))
				{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && __LIB_0__::func_374(__LIB_14__::func_466()))
		{
			__LIB_15__::func_978(PLAYER::PLAYER_PED_ID(), 1, 1);
			__LIB_15__::func_975(PLAYER::PLAYER_PED_ID());
			__LIB_15__::func_974(PLAYER::PLAYER_PED_ID());
			func_746(PLAYER::PLAYER_PED_ID());
			PED::SET_PED_CAN_LOSE_PROPS_ON_DAMAGE(PLAYER::PLAYER_PED_ID(), false, 0);
	...
	if (__LIB_13__::func_797(uParam0))
	{
		if (iParam2 == 0)
		{
			if (VEHICLE::IS_THIS_MODEL_A_BOAT(uParam0->f_12.f_66))
			{
				if (uParam0->f_9 == 1)
				{
					__LIB_39__::func_785(&(uParam0->f_12), uParam0->f_11);
				}
				return 0;
			}
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (bVar10)
				{
					if (!__LIB_39__::func_784(*uParam0, iVar9))
					{
						if (!__LIB_42__::func_755(uParam0, iVar9))
						{
							if (uParam0->f_9 == 1)
							{
								__LIB_39__::func_785(&(uParam0->f_12), uParam0->f_11);
				...
				*uParam1 = __LIB_37__::func_528(uParam0, 0f, 0f, 0f, 0f, bParam6);
...
int func_116(var uParam0, int iParam1, int iParam2, var uParam3)//Position - 0xB3BF
{
	...
	if (*uParam0 == 1)
	{
		...
		if (func_667(uParam0->f_2, &(uParam0->f_4), &(uParam0->f_7), &(uParam0->f_8)))
		{
			...
			{
				if ((func_599(uParam0->f_2, &sVar9, &cVar10) || __LIB_17__::func_688(uParam0->f_2, &sVar11, &uVar12, &uVar13, &uVar14, &uVar15, &uVar16, &uVar17)) || __LIB_17__::func_687(uParam0->f_2, &sVar18))
				{
			...
			if (bVar20 != 145)
			{
				...
				__LIB_37__::func_321(PLAYER::PLAYER_PED_ID(), &(Global_99845[bVar20 /*98*/]), &(Global_100148[bVar20 /*3*/]), &(Global_100158[bVar20]), &(Global_100140[bVar20]), &(Global_4541522[bVar20]));
...
int func_179(var uParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x19362
{
	...
	if ((!PED::IS_PED_INJURED((*uParam0)[uParam0->f_7]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && (*uParam0)[uParam0->f_7] != PLAYER::PLAYER_PED_ID())
	{
		...
		__LIB_42__::func_606((*uParam0)[uParam0->f_7], 0);
		...
		__LIB_42__::func_761(__LIB_0__::func_517(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 145, 0));
...
void func_180()//Position - 0x19851
{
	...
	{
		__LIB_13__::func_817();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(__LIB_15__::func_889(Global_113386.f_2363.f_539.f_4321));
	}
	else
	{
...
int func_270(var uParam0, int iParam1, int iParam2, var uParam3, float fParam4, float fParam5, bool bParam6, bool bParam7, char* sParam8, int iParam9, bool bParam10, bool bParam11, int iParam12)//Position - 0x21AA3
{
		...
		if (STREAMING::IS_SAFE_TO_START_PLAYER_SWITCH())
		{
			...
			if ((!PED::IS_PED_INJURED(uParam0->f_13) || bParam10) && !PED::IS_PED_INJURED(uParam0->f_12))
			{
				...
				if (!bParam10)
				{
					...
					{
						GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(__LIB_15__::func_889(0));
					}
					else if (ENTITY::GET_ENTITY_MODEL(uParam0->f_12) == __LIB_12__::func_894(2))
					{
						GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(__LIB_15__::func_889(2));
					}
					else if (ENTITY::GET_ENTITY_MODEL(uParam0->f_12) == __LIB_12__::func_894(1))
					{
						GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(__LIB_15__::func_889(1));
					}
					else
					{
						GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER("");
	...
	if (uParam0->f_17)
	{
		...
		if (!bParam10)
		{
			...
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
			__LIB_15__::func_888();
			GRAPHICS::SET_CURRENT_PLAYER_TCMODIFIER(__LIB_15__::func_889(__LIB_14__::func_466()));
		}
		__LIB_7__::func_703(0);
...
int func_675(int iParam0, int iParam1, float fParam2, var uParam3, var uParam4, var uParam5, var uParam6, bool bParam7, bool bParam8)//Position - 0x97347
{
	...
	if (!bParam7 && !bParam8)
	{
		if (Global_97754[iParam0] == 1)
		{
			...
			{
				Var4 = { __LIB_15__::func_962(iVar3, iParam0) };
			}
			Var5 = { 0f, 0f, 0f };
			fVar6 = 0f;
			StringCopy(&cVar7, "", 32);
