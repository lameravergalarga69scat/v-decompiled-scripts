...
void __EntryFunction__()//Position - 0x0
{
	...
	while (bVar2)
	{
		...
		if (((ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && !CUTSCENE::IS_CUTSCENE_PLAYING()) && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
		{
			if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == iVar1 && !PED::IS_PED_JUMPING(PLAYER::PLAYER_PED_ID()))
			{
				if (!__LIB_0__::func_39(15))
				{
					if (!Global_113386.f_20564.f_100)
					{
						if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
						{
							...
							else if (!__LIB_13__::func_101("ATM_1TM_TUT" /* GXT: Bank balance and transaction log can be seen at any ATM. */))
							{
								__LIB_0__::func_697("ATM_1TM_TUT" /* GXT: Bank balance and transaction log can be seen at any ATM. */, 2, 0, -1, 10000, 7, 0, 0, 0);
							}
						}
					}
				...
				if ((((((((((((((!PED::IS_PED_USING_ANY_SCENARIO(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !__LIB_0__::func_77(0)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_503, 1f, 1f, 1f, false, true, 1)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false)) && !__LIB_0__::func_217()) && !func_80(iScriptParam_538, 0)) && !__LIB_12__::func_649()) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f) && __LIB_0__::func_492(PLAYER::PLAYER_ID()) != 171) && !__LIB_10__::func_382(Global_4718592.f_168757)) && !__LIB_25__::func_273(Global_4718592.f_168757)) && !__LIB_1__::func_435(Global_4718592.f_168757)) && !BitTest(Global_4718592.f_28, 1)) && !__LIB_0__::func_927(PLAYER::PLAYER_ID()))
				{
					...
					if (!bVar6)
					{
						if (iLocal_527 == -1)
						{
							__LIB_7__::func_954(&iLocal_527, 4, "FINH_ATMNEAR" /* GXT: Press ~a~ to access the ATM. */, 0, 0, 0, 0);
						}
						bVar4 = true;
						if (__LIB_3__::func_113(iLocal_527, 1))
						{
							Global_43985 = 1;
							...
							if (!PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), true))
							{
								if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
								{
									iLocal_513 = __LIB_0__::func_963(1, 1, 1, 1);
									iLocal_532 = 1;
									if (Global_78319)
									{
	...
	if (bLocal_512)
	{
		__LIB_1__::func_333(-706733491, 13, 0);
	}
	func_99();
}
			...
			if (((PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 202 /*INPUT_FRONTEND_CANCEL*/) || PAD::IS_CONTROL_JUST_PRESSED(2 /*FRONTEND_CONTROL*/, 238 /*INPUT_CURSOR_CANCEL*/)) || iVar6) && bVar5)
			{
				...
				if (Global_78319)
				{
					switch (*iParam1)
					{
						case 0:
							bVar4 = false;
							iLocal_513 = __LIB_0__::func_963(0, 1, iLocal_513, 1);
							break;
						case 1:
							iLocal_535 = 1;
							*iParam1 = 0;
				...
				{
					iLocal_513 = __LIB_0__::func_963(0, 1, iLocal_513, 0);
					bVar4 = false;
				}
			}
		}
...
int func_10(int iParam0, int iParam1)//Position - 0x1365
{
	...
	if (__LIB_0__::func_112())
	{
		...
		if (NETSHOPPING::NET_GAMESERVER_TRANSFER_BANK_TO_WALLET(__LIB_0__::func_991(joaat("MPPLY_LAST_MP_CHAR")), iParam1))
		{
...
int func_20(int iParam0, int iParam1)//Position - 0x2329
{
	...
	if (__LIB_0__::func_112())
	{
		...
		if (NETSHOPPING::NET_GAMESERVER_TRANSFER_WALLET_TO_BANK(__LIB_0__::func_991(joaat("MPPLY_LAST_MP_CHAR")), iParam1))
		{
			iVar3 = NETSHOPPING::NET_GAMESERVER_TRANSFER_WALLET_TO_BANK_GET_STATUS();
			while (iVar3 == 1 && !func_64(iParam0, 1))
			{
...
void func_26(int iParam0, int iParam1, var uParam2)//Position - 0x2676
{
	...
	__LIB_0__::func_700(PLAYER::GET_PLAYER_NAME(PLAYER::GET_PLAYER_INDEX()));
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("MPATM_ACBA" /* GXT: Account balance */);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	__LIB_0__::func_700(MONEY::NETWORK_GET_STRING_BANK_BALANCE());
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
int func_29(int iParam0)//Position - 0x2FE8
{
	...
	iVar1 = (Global_2359296[__LIB_0__::func_155() /*5567*/].f_5390 - 1);
	if (iVar1 < 0)
	{
		iVar1 = 15;
	}
	...
	while (iVar2 > 0)
	{
		if (Global_2359296[__LIB_0__::func_155() /*5567*/].f_5390.f_1[iVar1] > 0 && Global_2359296[__LIB_0__::func_155() /*5567*/].f_5390.f_132[iVar1] != joaat("MONEY_SPENT_BETTING"))
		{
			...
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_2359296[__LIB_0__::func_155() /*5567*/].f_5390.f_1[iVar1]);
			switch (Global_2359296[__LIB_0__::func_155() /*5567*/].f_5390.f_115[iVar1])
			{
				case 0:
				...
				case 2:
					...
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_2359296[__LIB_0__::func_155() /*5567*/].f_5390.f_18[iVar1 /*6*/]));
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
					break;
				case 3:
				...
				case 5:
					...
					{
						iVar4 = Global_2359296[__LIB_0__::func_155() /*5567*/].f_5390.f_132[iVar1];
						switch (iVar4)
						{
				...
				case 6:
					if (Global_2359296[__LIB_0__::func_155() /*5567*/].f_5390.f_132[iVar1] != 0)
					{
						iVar5 = Global_2359296[__LIB_0__::func_155() /*5567*/].f_5390.f_132[iVar1];
						switch (iVar5)
						{
...
void func_32(int iParam0)//Position - 0x33EA
{
	...
	int iVar4;
	int iVar5;
	iVar0 = Global_113386.f_28050[__LIB_0__::func_683() /*29*/].f_17;
	if (iVar0 == 4 || iVar0 == 3)
	{
		return;
	}
...
void func_53(bool bParam0, bool bParam1)//Position - 0x4277
{
	...
	if (Global_78319)
	{
		...
		if (bParam0)
		{
			...
			if (bParam1)
			{
				__LIB_0__::func_700(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2 /*FRONTEND_CONTROL*/, 198 /*INPUT_FRONTEND_RIGHT_AXIS_Y*/, true));
			}
			else
			{
...
int func_64(int iParam0, int iParam1)//Position - 0x4CEE
{
	...
	if (Global_78319 && __LIB_7__::func_84())
	{
		return 0;
	}
	if (!Global_78319 && __LIB_7__::func_83())
	{
		return 0;
	}
	if (Global_78319 && NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_99()//Position - 0x57D2
{
	...
	__LIB_13__::func_311("ATM_1TM_TUT" /* GXT: Bank balance and transaction log can be seen at any ATM. */, 1);
	if (iLocal_527 != -1)
	{
		__LIB_3__::func_422(&iLocal_527);
	}
	...
	__LIB_14__::func_619();
	Global_60335 = 0;
	__LIB_0__::func_963(0, 1, iLocal_513, 1);
	if (iLocal_531)
	{
