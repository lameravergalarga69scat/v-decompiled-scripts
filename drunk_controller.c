...
void func_2()//Position - 0xE3
{
	...
	if (Global_44205 > iVar1 || Global_44205 == -1)
	{
		...
		if (!CAM::IS_GAMEPLAY_CAM_SHAKING() && !__LIB_4__::func_358(PLAYER::PLAYER_ID()))
		{
...
void func_16(int iParam0)//Position - 0x770
{
	...
	{
		__LIB_0__::func_758(iParam0);
		return;
	}
	if (__LIB_4__::func_962(Global_43998[iParam0 /*5*/].f_1))
	{
		__LIB_0__::func_758(iParam0);
		return;
	}
...
void func_24(int iParam0)//Position - 0xA08
{
	int iVar0;
	func_27(iParam0);
	iVar0 = __LIB_3__::func_34(iParam0);
	if (iVar0 == -1)
	{
		return;
	}
	__LIB_39__::func_416(iVar0);
}

void func_27(int iParam0)//Position - 0xAAA
{
	__LIB_31__::func_987(iParam0);
	func_28(iParam0);
}
