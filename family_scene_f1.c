...
int func_1(int iParam0, var uParam1, struct<3> Param2, struct<3> Param3, var uParam4)//Position - 0xF3
{
	...
	while (iVar0 < 3)
	{
		...
		if (!__LIB_17__::func_22(iVar1))
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_97919[iVar0]))
			{
				if (__LIB_36__::func_722(iParam0, __LIB_17__::func_262(iVar1)))
				{
					return 0;
				}
			}
	...
	while (iVar2 < 3)
	{
		if (__LIB_36__::func_722(iParam0, __LIB_17__::func_262(iVar2)))
		{
			bVar3 = iVar2;
		}
		iVar2++;
	...
	if (!__LIB_17__::func_273(bVar3, __LIB_0__::func_683()))
	{
		return 0;
	}
	switch (bVar3)
	...
	if (__LIB_0__::func_169(bVar3, iVar4) == 1)
	{
		return 0;
	}
	...
	if (Global_95464 != 8)
	{
		if (Global_95465 == -1)
		{
			...
			if (__LIB_0__::func_680())
			{
				...
				if (__LIB_17__::func_271(iVar7, iVar10, iVar11, 6, __LIB_14__::func_792(), bVar3, iVar8, 10000, -1, 0, -1, 0, 1))
				{
			...
			else
			{
				...
				if (func_2(iVar7, 6, __LIB_14__::func_792(), bVar3, bVar3, iVar8, 10000, -1, -1, 0, -1, 0))
				{
					Global_95465 = MISC::GET_GAME_TIMER();
					return 1;
				}
...
void func_10(var uParam0, var uParam1)//Position - 0xAA8
{
	...
	if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
	{
		...
		else if (iVar1 == __LIB_0__::func_683())
		{
		}
		else if (!__LIB_36__::func_722(uParam0, __LIB_17__::func_262(iVar1)))
		{
		}
...
void func_36(var uParam0, int* iParam1, var uParam2, var uParam3, struct<3> Param4, char* sParam5)//Position - 0x1276
{
	...
	if (!*uParam0)
	{
		if (!__LIB_0__::func_702(iParam1))
		{
			*uParam0 = 1;
		}
		else if (__LIB_14__::func_803(iParam1, 1f))
		{
			*uParam0 = 1;
		}
	}
...
void func_51()//Position - 0x191F
{
	...
	__LIB_0__::func_222(&uLocal_121, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
}
...
void func_55(int iParam0)//Position - 0x1A6F
{
	...
	if (iVar1 != 145)
	{
		...
		{
			iVar0 = __LIB_0__::func_154(iVar1);
		}
		else
		{
			iVar0 = __LIB_2__::func_910(iVar1);
		}
	}
...
void func_60(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9)//Position - 0x1C59
{
	...
	__LIB_17__::func_312();
	__LIB_17__::func_329();
	__LIB_17__::func_113(-181320640);
	__LIB_17__::func_113(1418815087);
	__LIB_17__::func_113(2087297077);
	__LIB_17__::func_113(313472619);
	__LIB_17__::func_113(2038672434);
	__LIB_17__::func_113(1666308520);
	__LIB_17__::func_113(1894462438);
	__LIB_17__::func_113(1728635625);
	__LIB_17__::func_113(975196153);
	__LIB_17__::func_113(-710274964);
	__LIB_17__::func_113(1289879258);
	__LIB_17__::func_113(1621076324);
	__LIB_17__::func_113(1005256598);
	__LIB_17__::func_113(1127548000);
	__LIB_17__::func_113(-1291788156);
	__LIB_17__::func_113(1993031175);
	Global_95464 = 8;
	Global_95465 = -1;
}
