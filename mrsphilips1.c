...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		__LIB_14__::func_863(Local_77.f_9, 0, 0, 0, 0, 0);
...
void func_1()//Position - 0xCA
{
	...
	{
		case 0:
			__LIB_14__::func_851("TMOM_1_RCM", 0);
			iLocal_80 = 0;
			iLocal_81 = 0;
			iLocal_79 = 1;
			break;
			...
			switch (iLocal_80)
			{
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						{
							__LIB_14__::func_659(PLAYER::PLAYER_PED_ID(), 1974.513f, 3814.579f, 32.4266f, 270f, 0, 1);
					...
					else
					{
						...
						__LIB_14__::func_800(&Local_77, 0, 1);
						func_2();
					}
					break;
			}
...
void func_253()//Position - 0x28109
{
	...
	__LIB_14__::func_871(&Local_77, 1, 0, 0);
