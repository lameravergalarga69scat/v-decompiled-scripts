	...
	if (__LIB_37__::func_169(8))
	{
		...
		while (bVar0 <= (5 - 1))
		{
			...
			if (BitTest(Global_113386.f_24979.f_1, bVar0))
			{
				...
				{
					fVar2 = SYSTEM::VDIST2(__LIB_0__::func_85(PLAYER::PLAYER_ID()), __LIB_15__::func_964(iVar1, 0));
					if (fVar2 > 43681f)
					{
