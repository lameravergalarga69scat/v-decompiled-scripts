...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_80 = __LIB_2__::func_910(16);
	...
	__LIB_14__::func_868(&iLocal_83, &(Local_82.f_28[0]));
	while (true)
	{
		SYSTEM::WAIT(0);
...
void func_1()//Position - 0xF6
{
	switch (iLocal_87)
	{
		...
		case 3:
			...
			{
				__LIB_14__::func_592(-1608.1659f, 5246.844f, 1.97751f, -1604.4207f, 5238.246f, 4.996789f, 6f, -1596.4615f, 5232.455f, 2.9794f, 25.5125f, 1, 1, 1, 0, 0);
				__LIB_14__::func_785(-1596.4615f, 5232.455f, 2.9794f, 25.5125f, 0, 145);
				...
				__LIB_0__::func_364(58, 1);
				__LIB_0__::func_342(58);
				iLocal_85 = 1;
		...
		case 5:
			...
			if (__LIB_0__::func_645(1000) || MISC::GET_GAME_TIMER() > iLocal_86)
			{
			...
			{
				__LIB_0__::func_190("DIVING_HELP" /* GXT: A Dinghy is now available at the Marina property to search for the missing submarine pieces. */);
			}
			break;
	}
}
