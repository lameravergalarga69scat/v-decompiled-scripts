...
void func_3()//Position - 0x385
{
	...
	switch (iLocal_316)
	{
		...
		case 1:
			...
			__LIB_0__::func_221(&uLocal_446, 3);
			__LIB_0__::func_221(&uLocal_446, 5);
			__LIB_0__::func_222(&uLocal_446, 2, iLocal_354, "JIMMY", 0, 1);
			__LIB_0__::func_325();
			func_60(0, 1);
			iLocal_316++;
			break;
	...
	if (__LIB_0__::func_645(1000) && iLocal_316 < 4)
	{
...
void func_6()//Position - 0xA5A
{
	AUDIO::TRIGGER_MUSIC_EVENT("FAM1_FAIL");
	__LIB_0__::func_325();
	__LIB_17__::func_151(39, 0, 0);
	func_10(0);
	while (!__LIB_0__::func_223())
	{
		SYSTEM::WAIT(0);
	}
	__LIB_16__::func_836("YB_JIMTXT" /* GXT: Dad - Come quick! These guys are stealing ur yacht, we're headin down the freeway. Totes not my fault! */);
...
void func_59(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4)//Position - 0x2A65
{
	...
	HUD::CLEAR_HELP(true);
	__LIB_0__::func_532(bParam0, 1, iParam4, 0, 0, 0, 0);
...
void func_68()//Position - 0x2FF2
{
	...
	while (iVar0 < 28)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_227[iVar0]))
		{
			...
			__LIB_15__::func_906(iLocal_227[iVar0]);
		}
		iLocal_176[iVar0] = 0;
		iLocal_177[iVar0] = 0;
		if (!bLocal_110 && !bLocal_123)
...
void func_71()//Position - 0x3170
{
	...
	while (iVar0 < 35)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_226[iVar0]))
		{
			...
			__LIB_15__::func_906(iLocal_226[iVar0]);
		}
		iVar0++;
	}
	iVar0 = 0;
...
void func_72()//Position - 0x31F4
{
	...
	while (iVar0 < 144)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_224[iVar0]))
		{
			...
			__LIB_15__::func_906(iLocal_224[iVar0]);
		}
		iLocal_173[iVar0] = 0;
		iLocal_174[iVar0] = 0;
		if (!bLocal_110 && !bLocal_123)
...
void func_83()//Position - 0x34AE
{
	...
	__LIB_16__::func_19(&Local_283, 0);
	HUD::CLEAR_PRINTS();
...
void func_92()//Position - 0x3839
{
	...
	if ((!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_342, false) || __LIB_15__::func_927(&iLocal_342)) || FIRE::IS_ENTITY_ON_FIRE(iLocal_342))
	{
	}
...
void func_100()//Position - 0x3E4E
{
	...
	{
		if (__LIB_17__::func_595(39) || !__LIB_0__::func_545(39))
		{
			__LIB_0__::func_381("YB_BLEWSHOP");
			func_6();
		}
	}
	...
	if ((!__LIB_15__::func_218(39) && CAM::IS_SCREEN_FADED_OUT()) && iLocal_315 <= 1)
	{
	...
	{
		case 0:
			if ((!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && !__LIB_13__::func_755(&Local_283, 1)) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
			{
		...
		case 1:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
			{
				...
				__LIB_37__::func_500(1);
				__LIB_38__::func_392(39, 0);
				__LIB_0__::func_222(&uLocal_446, 3, 0, "HAO", 0, 1);
				ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(PLAYER::PLAYER_PED_ID(), false);
				__LIB_0__::func_222(&uLocal_446, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				__LIB_38__::func_392(39, 1);
				iLocal_3123 = 0;
				iLocal_3119 = 0;
				__LIB_0__::func_345(&uLocal_422, 0, 0);
				Global_113386.f_668.f_70 = 0;
				iLocal_3116 = MISC::GET_GAME_TIMER();
				__LIB_0__::func_229("YB_OBJ6", 7500, 1);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_342, false);
		...
		case 4:
		case 5:
			if (((iLocal_315 == 2 && !__LIB_13__::func_755(&Local_283, 1)) && (MISC::GET_GAME_TIMER() - iLocal_3127) > 5000) && CAM::IS_GAMEPLAY_CAM_RENDERING())
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_FIX2", 9, 0, 0, 0))
				{
					iLocal_315 = 4;
				}
			}
			if ((iLocal_315 == 4 && !__LIB_13__::func_755(&Local_283, 1)) && !CAM::IS_GAMEPLAY_CAM_RENDERING())
			{
				if (Global_113386.f_18574.f_389 == 1 && !BitTest(Global_113386.f_24979.f_2, 0))
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_HAO_SRL", 9, 0, 0, 0))
					{
						iLocal_315 = 5;
					}
				}
				if (Global_113386.f_18574.f_389 == 1 && BitTest(Global_113386.f_24979.f_2, 0))
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_HAO_SRW", 9, 0, 0, 0))
					{
						iLocal_315 = 5;
					}
				}
				...
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_HAO_SR", 9, 0, 0, 0))
					{
						iLocal_315 = 5;
					}
				}
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_342, false))
			{
				...
				if ((ENTITY::GET_ENTITY_HEALTH(iLocal_342) >= 1000 && VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_342) >= 1000f) && !__LIB_0__::func_921(39))
				{
					__LIB_17__::func_786(7, "STAGE_FIX_CAR_AND_TAKE_JIMMY_HOME", 1, 0, 0, 1);
					PLAYER::SET_AIR_DRAG_MULTIPLIER_FOR_PLAYERS_VEHICLE(PLAYER::PLAYER_ID(), 1f);
					HUD::REMOVE_BLIP(&iLocal_328);
					...
					__LIB_0__::func_377(iLocal_342, -1);
					iLocal_3124 = 0;
					iLocal_3125 = 0;
		...
		case 8:
			...
			if (iLocal_315 == 6)
			{
				__LIB_33__::func_610(&Local_283, -828.5845f, 172.413f, 69.4003f, 7f, 7f, 1.75f, 1, iLocal_354, 0, 0, iLocal_342, "YB_OBJ7", "CMN_JLEAVE" /* GXT: ~s~Return to ~b~Jimmy.~s~ */, "", "", "CMN_JLEAVE" /* GXT: ~s~Return to ~b~Jimmy.~s~ */, "YB_GETIN", "CMN_GENGETBCK" /* GXT: ~s~Get back in the ~b~car. */, 0, 1, 1, -1);
				if (__LIB_14__::func_291(39) > 20f)
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_HOME", 9, 0, 0, 0))
					{
						iLocal_3126 = 0;
						iLocal_315 = 7;
					}
			...
			{
				case 0:
					if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), -828.5845f, 172.413f, 69.4503f, 1) < 100f)
					{
						CUTSCENE::REQUEST_CUTSCENE("FAM_1_EXT_2", 8);
			...
			if (__LIB_33__::func_610(&Local_283, -828.5845f, 172.413f, 69.4003f, 5f, 5f, 1.75f, 1, iLocal_354, 0, 0, iLocal_342, "YB_OBJ7", "CMN_JLEAVE" /* GXT: ~s~Return to ~b~Jimmy.~s~ */, "", "", "CMN_JLEAVE" /* GXT: ~s~Return to ~b~Jimmy.~s~ */, "YB_GETIN", "CMN_GENGETBCK" /* GXT: ~s~Get back in the ~b~car. */, 0, 1, 1, -1))
			{
				while (!__LIB_0__::func_213(iLocal_342, 1093140480, 1, 1056964608, 0, 1, 0))
				{
					RECORDING::REPLAY_CHECK_FOR_EVENT_THIS_FRAME("M_FatherAndSon", 0);
					SYSTEM::WAIT(0);
				}
			...
			if (!__LIB_13__::func_755(&Local_283, 1) && iLocal_315 == 7)
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_FJCHAT", 9, 0, 0, 0))
				{
					iLocal_315 = 8;
				}
			}
			if ((iLocal_315 == 8 && (MISC::GET_GAME_TIMER() - iLocal_3128) > 10000) && !__LIB_13__::func_755(&Local_283, 1))
			{
				if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_FRKILL", 9, 0, 0, 0))
					{
			...
			else if (__LIB_0__::func_570(PLAYER::PLAYER_PED_ID(), iLocal_354))
			{
				if (__LIB_0__::func_568())
				{
...
void func_101()//Position - 0x458F
{
	...
	if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_342, false))
	{
		iVar0 = __LIB_17__::func_773();
		iVar1 = iVar0;
		if (!iLocal_3119 && !ENTITY::IS_ENTITY_DEAD(iLocal_342, false))
		{
			if (ENTITY::GET_ENTITY_HEALTH(iLocal_342) >= 1000 && VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_342) >= 1000f)
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_RECON", 9, 0, 0, 0))
				{
					iLocal_3120 = 0;
					iLocal_3119 = 1;
				}
		...
		if ((((((!iLocal_3118 && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) && !__LIB_13__::func_755(&Local_283, 1)) && iLocal_315 <= 4) && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) && __LIB_14__::func_291(39) < 6f) && ENTITY::GET_ENTITY_HEALTH(iLocal_342) < 1000)
		{
			if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_HAO", 9, 0, 0, 0))
			{
				iLocal_3118 = 1;
			}
		}
		if ((((MISC::GET_GAME_TIMER() - iLocal_3116) > 18000 && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) && !__LIB_13__::func_755(&Local_283, 1)) || ((iLocal_3117 - iVar1) != 0 && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())))
		{
			switch (iVar0)
			{
				case 10:
				...
				case 12:
				case 50:
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_MOD4", 9, 0, 0, 0))
					{
						iLocal_3116 = MISC::GET_GAME_TIMER();
					}
					break;
				case 38:
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_MOD2", 9, 0, 0, 0))
					{
						iLocal_3116 = MISC::GET_GAME_TIMER();
					}
					break;
				case 56:
				case 58:
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_MOD1", 9, 0, 0, 0))
					{
						iLocal_3116 = MISC::GET_GAME_TIMER();
					}
					break;
				case 60:
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_MOD6", 9, 0, 0, 0))
					{
						iLocal_3116 = MISC::GET_GAME_TIMER();
					}
					break;
				case 47:
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_MOD3", 9, 0, 0, 0))
					{
						iLocal_3116 = MISC::GET_GAME_TIMER();
					}
					break;
				case 8:
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_MOD5", 9, 0, 0, 0))
					{
						iLocal_3116 = MISC::GET_GAME_TIMER();
					}
					break;
				...
				case 44:
				case 46:
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_MODG", 9, 0, 0, 0))
					{
						iLocal_3116 = MISC::GET_GAME_TIMER();
					}
					break;
		...
		if (((((iLocal_3117 == iVar1 && (MISC::GET_GAME_TIMER() - iLocal_3116) > 20000) && !__LIB_13__::func_755(&Local_283, 1)) && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) && !ENTITY::IS_ENTITY_DEAD(iLocal_342, false))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_342, false) && !TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_342))
			{
				...
				else if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_NOMOD", 9, 0, 0, 0))
				{
					iLocal_3116 = MISC::GET_GAME_TIMER();
				}
			}
...
void func_232()//Position - 0xF982
{
	if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_342, false))
	{
		if (iLocal_3121 == 0)
		{
			iLocal_328 = __LIB_0__::func_639(iLocal_342, 0, 0);
			if (iLocal_3122 == 0)
			{
...
void func_261()//Position - 0x1048E
{
	...
	if (CAM::IS_SCREEN_FADED_IN())
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_342))
		{
			...
			if (__LIB_15__::func_927(&iLocal_342))
			{
				__LIB_0__::func_381("CMN_GENSTCK" /* GXT: ~s~The car got stuck. */);
				func_6();
			}
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_342, false))
			{
...
void func_262()//Position - 0x1066E
{
	...
	{
		case 0:
			__LIB_17__::func_151(39, 1, 0);
			__LIB_17__::func_230(39, 0);
			func_97();
			func_253();
			__LIB_0__::func_345(&uLocal_422, 0, 0);
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("trailers2"));
		...
		case 3:
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0) || CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Franklin", 0))
			{
				if (__LIB_14__::func_466() != 1)
				{
					__LIB_16__::func_893(&iLocal_56, 1);
					__LIB_17__::func_200(&iLocal_56, 1, 1, 1);
				}
			}
			if (!CUTSCENE::IS_CUTSCENE_ACTIVE())
			{
...
void func_318()//Position - 0x166D8
{
	...
	switch (iLocal_307)
	{
		...
		case 1:
			...
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_COAX", 9, 0, 0, 0))
				{
					__LIB_0__::func_345(&uLocal_422, 0, 0);
		...
		case 2:
			...
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_DIST", 9, 0, 0, 0))
				{
		...
		case 4:
			...
			if ((!ENTITY::DOES_ENTITY_EXIST(iLocal_346) || __LIB_0__::func_76(PLAYER::PLAYER_PED_ID(), iLocal_346, 1) > 250f) || !ENTITY::IS_ENTITY_ON_SCREEN(iLocal_346))
			{
				...
				__LIB_17__::func_786(5, "STAGE_TAKE_CAR_TO_CHOP_SHOP", 0, 0, 0, 1);
		...
		case 5:
			if (PED::IS_PED_IN_VEHICLE(func_2(), iLocal_342, false))
			{
				...
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_CHOP", 9, 0, 0, 0))
				{
				...
				{
					__LIB_33__::func_610(&Local_283, -1104.3127f, -1975.6726f, 12.0489f, 3.9f, 3.9f, 2.25f, 1, func_2(), 0, 0, iLocal_342, "YB_OBJ5", "CMN_FLEAVE" /* GXT: ~s~Return to ~b~Franklin.~s~ */, "", "", "CMN_FLEAVE" /* GXT: ~s~Return to ~b~Franklin.~s~ */, "YB_GETIN", "CMN_GENGETBCK" /* GXT: ~s~Get back in the ~b~car. */, 0, 1, 1, -1);
				}
			}
			break;
		case 6:
			__LIB_33__::func_610(&Local_283, -1104.3127f, -1975.6726f, 12.0489f, 3.9f, 3.9f, 2.25f, 1, func_2(), 0, 0, iLocal_342, "YB_OBJ5", "CMN_FLEAVE" /* GXT: ~s~Return to ~b~Franklin.~s~ */, "", "", "CMN_FLEAVE" /* GXT: ~s~Return to ~b~Franklin.~s~ */, "YB_GETIN", "CMN_GENGETBCK" /* GXT: ~s~Get back in the ~b~car. */, 0, 1, 1, -1);
			VEHICLE::SET_VEHICLE_DENSITY_MULTIPLIER_THIS_FRAME(0.35f);
			if (!__LIB_13__::func_755(&Local_283, 2))
			{
		...
		case 14:
		case 15:
			if (__LIB_33__::func_610(&Local_283, -1104.3127f, -1975.6726f, 12.0489f, 3.9f, 3.9f, 2.25f, 1, func_2(), 0, 0, iLocal_342, "YB_OBJ5", "CMN_FLEAVE" /* GXT: ~s~Return to ~b~Franklin.~s~ */, "", "", "CMN_FLEAVE" /* GXT: ~s~Return to ~b~Franklin.~s~ */, "YB_GETIN", "CMN_GENGETBCK" /* GXT: ~s~Get back in the ~b~car. */, 0, 1, 1, -1))
			{
				__LIB_0__::func_638();
				while (!__LIB_0__::func_213(iLocal_342, 4f, 1, 1056964608, 0, 1, 0))
				{
					SYSTEM::WAIT(0);
				}
				...
				__LIB_38__::func_392(39, 1);
				__LIB_17__::func_151(39, 1, 0);
				__LIB_16__::func_593(39);
				__LIB_16__::func_19(&Local_283, 0);
				iLocal_3022 = 9;
			}
			if (!__LIB_13__::func_755(&Local_283, 1) && iLocal_307 == 8)
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_DRIVE", 9, 0, 0, 0))
				{
					iLocal_307 = 9;
				}
			}
			if (!__LIB_13__::func_755(&Local_283, 1) && iLocal_307 == 9)
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_CAB", 9, 0, 0, 0))
				{
					iLocal_307 = 10;
				}
			}
			if (!__LIB_13__::func_755(&Local_283, 1) && iLocal_307 == 10)
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_OKAY", 9, 0, 0, 0))
				{
					if (!PED::IS_PED_INJURED(func_2()))
					{
						TASK::TASK_USE_MOBILE_PHONE(func_2(), true, 1);
						PED::SET_PED_PHONE_PALETTE_IDX(func_2(), __LIB_17__::func_163(1));
					}
					SYSTEM::SETTIMERA(0);
					iLocal_307 = 11;
				}
			}
			if ((!__LIB_13__::func_755(&Local_283, 1) && iLocal_307 == 11) && SYSTEM::TIMERA() > 3300)
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_FCALL", 9, 0, 0, 0))
				{
					iLocal_307 = 12;
				}
			}
			if (!__LIB_13__::func_755(&Local_283, 1) && iLocal_307 == 12)
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_CHEERS", 9, 0, 0, 0))
				{
					if (!PED::IS_PED_INJURED(func_2()))
					{
			...
			if (!__LIB_13__::func_755(&Local_283, 1) && iLocal_307 == 13)
			{
				...
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_TALK1", 9, 0, 0, 0))
					{
						iLocal_307 = 14;
					}
				}
			...
			if (!__LIB_13__::func_755(&Local_283, 1) && iLocal_307 == 14)
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_TALK2", 9, 0, 0, 0))
				{
					iLocal_3106 = 0;
					iLocal_307 = 15;
				}
			}
			if ((!__LIB_13__::func_755(&Local_283, 1) && !iLocal_3106) && iLocal_307 >= 15)
			{
				iLocal_3106 = 1;
			}
			if (!__LIB_13__::func_755(&Local_283, 1) && iLocal_3107 == 0)
			{
				...
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_DIROFF", 9, 0, 0, 0))
					{
						iLocal_3107 = 1;
					}
				}
			}
			if (!__LIB_13__::func_755(&Local_283, 1) && iLocal_3108 == 0)
			{
				...
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_LEFT", 9, 0, 0, 0))
					{
						iLocal_3108 = 1;
					}
				}
			}
			if (!__LIB_13__::func_755(&Local_283, 1) && iLocal_3109 == 0)
			{
	...
	if (iLocal_307 > 7)
	{
		if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), -1104.3127f, -1975.6726f, 12.0489f, 1) < (100f * 1.8f))
		{
			if (iLocal_3111 == 1 && iLocal_3112 == 0)
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_ARRIVE", 9, 0, 0, 0))
				{
					iLocal_3112 = 1;
				}
			}
	...
	if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), -1104.3127f, -1975.6726f, 12.0489f, 1) < (100f * 1.6f))
	{
		if (iLocal_3110 == 0)
		{
			CUTSCENE::REQUEST_CUTSCENE("FAM_1_MCS_2", 8);
			__LIB_14__::func_593(1, 96, 2000, 0, 0);
			iLocal_3110 = 1;
		}
		else
		{
	...
	{
		if (__LIB_0__::func_570(PLAYER::PLAYER_PED_ID(), func_2()))
		{
			__LIB_0__::func_620(0);
		}
	}
...
void func_349(int iParam0, float fParam1)//Position - 0x18440
{
	...
	if (!bLocal_104)
	{
		...
		if (iLocal_105)
		{
			...
			{
				__LIB_15__::func_906(iLocal_230);
				...
				if (iLocal_176[iVar0] == 0)
				{
					if (iLocal_175[iVar0] > 0)
					{
						if (!iLocal_98)
						{
							...
							{
								if (__LIB_15__::func_894(iLocal_220[iVar0]))
								{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_227[iVar0], false))
					{
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_227[iVar0]))
						{
							...
							if (!PED::IS_PED_INJURED(iVar1))
							{
								if (bVar9)
								{
									if (((!bLocal_102 && !iLocal_99) && !bLocal_118) && (((!bLocal_127 && !bLocal_126) && ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_227[iVar0])) || func_357(iLocal_227[iVar0])))
									{
										if (ENTITY::DOES_ENTITY_EXIST(iVar2))
										{
											...
											else
											{
												...
												else if (!__LIB_15__::func_923(iLocal_227[iVar0], iVar2, 45f))
												{
													bVar8 = true;
												}
												else if (__LIB_15__::func_939(iVar2, iLocal_227[iVar0], 0))
												{
													bVar8 = true;
												}
											}
...
int func_357(int iParam0)//Position - 0x19733
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			switch (iLocal_178[iVar0])
			{
						...
						if (!ENTITY::DOES_ENTITY_EXIST(iLocal_226[iVar0]))
						{
							...
							if (STREAMING::HAS_MODEL_LOADED(iLocal_219[iVar0]))
							{
								if ((iLocal_98 || iLocal_112) || (!bLocal_129 && !func_362(Local_197[iVar0 /*3*/], Var1, 5f, fLocal_164)))
								{
									...
									STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_219[iVar0]);
									if (VEHICLE::IS_VEHICLE_MODEL(iLocal_226[iVar0], __LIB_15__::func_908()))
									{
									...
									if (VEHICLE::IS_VEHICLE_MODEL(iLocal_226[iVar0], __LIB_15__::func_909()))
									{
				...
				case 2:
					if (!bVar3)
					{
						...
						{
							if (!__LIB_15__::func_939(iLocal_226[iVar0], iParam0, 0))
							{
								if (!bLocal_100)
								{
									__LIB_15__::func_906(iLocal_226[iVar0]);
					...
					if (iLocal_172[iVar0] > 0 && iLocal_218[iVar0] != 0)
					{
						if (!iLocal_98)
						{
							if (fLocal_153 < (fLocal_136[iVar0] + 20000f))
							{
								...
								{
									if (__LIB_15__::func_894(iLocal_218[iVar0]))
									{
						...
						if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_224[iVar0]))
						{
							...
							if (!PED::IS_PED_INJURED(iVar4))
							{
								if (bVar12)
								{
									...
									if (!bLocal_107)
									{
										if ((!bLocal_102 && !iLocal_99) && func_357(iLocal_224[iVar0]))
										{
											if (iVar2 < 3 && (iVar0 > iLocal_193 || iLocal_193 == 0))
											{
												...
												{
													bVar11 = false;
													if (!__LIB_15__::func_924(iLocal_224[iVar0], iVar5) || __LIB_15__::func_939(iVar5, iLocal_224[iVar0], 0))
													{
														bVar18 = true;
													}
												}
...
void func_368(int iParam0, float fParam1)//Position - 0x1AA1D
{
	...
	if (!bLocal_100)
	{
		...
		{
			__LIB_15__::func_893(iVar0);
			__LIB_15__::func_906(iLocal_224[iParam0]);
		}
	}
	else
	{
...
void func_379()//Position - 0x1B5F9
{
	...
	switch (iLocal_3023)
	{
		case 0:
			...
			func_453();
			func_452();
			__LIB_17__::func_786(2, "STAGE_DO_CHASE", 0, 0, 0, 1);
		...
		case 2:
			...
			{
				__LIB_17__::func_152(&uLocal_446, "FAM1AUD", "FAM1_START", 9, 0, 0, 0, 0);
				iLocal_3084 = 1;
			}
		...
		case 3:
			...
			if (!__LIB_13__::func_755(&Local_283, 1) && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				if (iLocal_277 == 0 && iLocal_3099 == 1)
				{
					if (MISC::GET_RANDOM_INT_IN_RANGE(0, 10) > 5)
					{
						if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_INIT1", 9, 0, 0, 0))
						{
							iLocal_277 = 1;
						}
					}
					else if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_INIT2", 9, 0, 0, 0))
					{
						iLocal_277 = 1;
					}
					SYSTEM::SETTIMERA(0);
				...
				if (iLocal_3099 == 0)
				{
					if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_342, false))
					{
						__LIB_0__::func_229("YB_OBJ1B", 7500, 1);
						iLocal_3099 = 1;
					}
				}
			}
		...
		case 5:
			func_449(iLocal_322, func_2(), 0f, 0f, 0f, -0.05f, 0.05f, 2f, 2f);
			func_447(iLocal_322, 0f, 0f, 0f, -0.05f, 0.05f, 2f, 2f, 0);
			if (((MISC::GET_GAME_TIMER() - iLocal_296) > iLocal_257 && iLocal_252 == 0) && MISC::ACOS(__LIB_0__::func_158(ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_342), ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_346))) < 45f)
			{
				if (MISC::GET_RANDOM_INT_IN_RANGE(0, 10) > 5)
				{
			...
			switch (iLocal_306)
			{
				case 0:
					...
					{
						if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_DNTSHT", 8, 0, 0, 0))
						{
							iLocal_306++;
						}
					}
				...
				case 1:
					if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_342, false))
					{
						if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_RESP1", 8, 0, 0, 0))
						{
							iLocal_306++;
						}
					}
		...
		case 9:
			...
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_JUMP", 9, 0, 0, 0))
				{
					iLocal_362 = 0;
					iLocal_361 = 1;
				}
		...
		case 12:
			...
			iLocal_358 = 0;
			__LIB_0__::func_222(&uLocal_446, 3, iLocal_350, "YACHTPED1", 0, 1);
			iLocal_357 = 0;
		...
		case 13:
			...
			if (func_444(iLocal_369) > 0.35f)
			{
				if (iLocal_357 == 0)
				{
					...
					__LIB_0__::func_325();
					__LIB_14__::func_654(&uLocal_446, "FAM1AUD", "FAM1_NOISE", 9, 0, 0);
					iLocal_357 = 1;
				}
			}
			if (func_444(iLocal_369) >= 1f)
			...
			if (__LIB_0__::func_76(PLAYER::PLAYER_PED_ID(), iLocal_346, 1) < 100f || iLocal_3065)
			{
				...
				switch (iLocal_264)
				{
					case 0:
						...
						{
							__LIB_0__::func_325();
							if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_WHO", 8, 0, 0, 0))
							{
								iLocal_264++;
							}
						}
					...
					case 2:
						if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_369) >= 0.531f)
						{
							...
							__LIB_0__::func_709(PLAYER::PLAYER_PED_ID(), "GENERIC_FRIGHTENED_HIGH", "MICHAEL_NORMAL", 3);
							iLocal_264++;
						}
						break;
					case 3:
					...
					case 9:
						if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
						{
							if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_CARSH", 9, 0, 0, 0))
							{
								iLocal_264++;
							}
						}
		...
		case 15:
			...
			if (func_444(iLocal_369) >= 0.95f)
			{
				...
				__LIB_14__::func_654(&uLocal_446, "FAM1AUD", "FAM1_ARG", 8, 0, 0);
				RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3.5f, 2f, 3);
				iLocal_3023 = 16;
			}
			break;
		...
		case 18:
			if (__LIB_0__::func_76(PLAYER::PLAYER_PED_ID(), iLocal_346, 0) < 65f)
			{
				...
				STREAMING::REQUEST_PTFX_ASSET();
				__LIB_0__::func_609(iLocal_351, 0);
				__LIB_0__::func_222(&uLocal_446, 4, iLocal_351, "YACHTPED2", 0, 1);
		...
		case 19:
			...
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_HIDE", 8, 0, 0, 0))
				{
					iLocal_411 = 1;
				}
			}
			...
			{
				if (__LIB_13__::func_755(&Local_283, 1))
				{
					if (__LIB_0__::func_680())
					{
						__LIB_0__::func_709(func_2(), "FAM1_DDAA", "FRANKLIN", 4);
						SYSTEM::SETTIMERB(0);
					}
					else if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_ATTACK", 9, 1, 0, 0))
					{
						SYSTEM::SETTIMERB(0);
					}
				}
				...
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_ENC4", 9, 0, 0, 0))
					{
						SYSTEM::SETTIMERB(0);
					}
				}
				else if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_ATTACK", 9, 0, 0, 0))
				{
					SYSTEM::SETTIMERB(0);
				}
			}
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_351, false) && iLocal_53 == 1)
			{
				...
				{
					__LIB_0__::func_709(func_2(), "GENERIC_FRIGHTENED_HIGH", "FRANKLIN_NORMAL", 4);
					ENTITY::SET_ENTITY_HEALTH(iLocal_351, 0, 0);
					HUD::REMOVE_BLIP(&iLocal_337);
					HUD::SET_BLIP_DISPLAY(iLocal_410, 4);
					__LIB_0__::func_229("YB_OBJ1", 7500, 1);
		...
		case 20:
			...
			if (!PED::IS_PED_INJURED(func_2()) && !ENTITY::IS_ENTITY_DEAD(iLocal_346, false))
			{
				if (!__LIB_13__::func_755(&Local_283, 1))
				{
					...
					{
						case 0:
							if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_FIGHT", 8, 0, 0, 0))
							{
								iLocal_312++;
							}
							break;
		...
		case 22:
			...
			if (((((((ENTITY::DOES_ENTITY_EXIST(iLocal_354) && !ENTITY::IS_ENTITY_DEAD(iLocal_354, false)) && PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(iLocal_354)) && !PED::IS_PED_INJURED(func_2())) && !ENTITY::IS_ENTITY_DEAD(iLocal_345, false)) && !ENTITY::IS_ENTITY_DEAD(iLocal_346, false)) && STREAMING::HAS_ANIM_DICT_LOADED("MISSFAM1_YachtBattleonYacht02_")) && STREAMING::HAS_ANIM_DICT_LOADED("MISSFAM1_YachtBattle"))
			{
				...
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_FINDJIM", 9, 0, 0, 0))
					{
						__LIB_0__::func_497(201, 1, 0);
						bLocal_3014 = false;
						bLocal_3015 = false;
						__LIB_17__::func_786(3, "STAGE_JIMMY_APPEARS", 0, 0, 0, 1);
		...
		case 23:
			...
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && iLocal_280 == 0)
			{
				...
				if (__LIB_17__::func_152(&uLocal_446, "FAM1AUD", "FAM1_JIMX", 9, 0, 0, 0, 0))
				{
					iLocal_280 = 1;
				}
			}
		...
		case 24:
			...
			Local_3102 = { __LIB_13__::func_743() };
			Local_3081 = { __LIB_0__::func_486() };
			...
			if ((((((((!PED::IS_PED_INJURED(func_2()) && !PED::IS_PED_INJURED(iLocal_354)) && !ENTITY::IS_ENTITY_DEAD(iLocal_345, false)) && !ENTITY::IS_ENTITY_DEAD(iLocal_346, false)) && STREAMING::HAS_MODEL_LOADED(joaat("IG_JimmyDiSanto"))) && STREAMING::HAS_ANIM_DICT_LOADED("MISSFAM1_YachtBattleonYacht02_")) && iLocal_3082) && (((!MISC::ARE_STRINGS_EQUAL("FAM1_JIMX_1", &Local_3102) && !MISC::ARE_STRINGS_EQUAL("FAM1_JIMX_2", &Local_3102)) && !MISC::ARE_STRINGS_EQUAL("FAM1_JIMX_3", &Local_3102)) && !MISC::ARE_STRINGS_EQUAL("FAM1_JIMX_4", &Local_3102))) && (((((MISC::ARE_STRINGS_EQUAL("FAM1_JIMX_5", &Local_3102) || MISC::ARE_STRINGS_EQUAL("FAM1_JIMX_6", &Local_3102)) || MISC::ARE_STRINGS_EQUAL("FAM1_JIMX_7", &Local_3102)) || MISC::ARE_STRINGS_EQUAL("FAM1_JIMX_8", &Local_3102)) || MISC::ARE_STRINGS_EQUAL("FAM1_JIMX_9", &Local_3102)) || !__LIB_0__::func_75()))
			{
				...
				__LIB_0__::func_222(&uLocal_446, 5, iLocal_352, "YACHTPED4", 0, 1);
				__LIB_0__::func_609(iLocal_352, 0);
				...
				SYSTEM::SETTIMERA(0);
				STREAMING::REMOVE_ANIM_DICT("MISSFAM1_YachtBattleonyacht01_");
				__LIB_0__::func_709(iLocal_352, "FAM1_HCAA", "JIMMY", 4);
				iLocal_3023 = 25;
			}
		...
		case 25:
			...
			if (!iLocal_281)
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_HELP", 9, 0, 0, 0))
				{
					iLocal_281 = 1;
				}
			}
			...
			if ((!PED::IS_PED_INJURED(func_2()) && !ENTITY::IS_ENTITY_DEAD(iLocal_345, false)) && !ENTITY::IS_ENTITY_DEAD(iLocal_346, false))
			{
				...
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_369))
				{
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_369) >= 1f || PED::IS_PED_INJURED(iLocal_352))
					{
						...
						fLocal_408 = 0.8f;
						HUD::SET_BLIP_DISPLAY(iLocal_410, 0);
						iLocal_339 = __LIB_0__::func_666(iLocal_354, 0, 145);
						__LIB_0__::func_382("YB_OBJ3", 7500, 1);
						__LIB_0__::func_151("YB_HELPJ", 15000);
						__LIB_0__::func_499(196, 0);
						iLocal_262 = 0;
						fLocal_259 = 0f;
						iLocal_3098 = 0;
						SYSTEM::SETTIMERA(0);
			...
			switch (iLocal_268)
			{
				case 0:
					...
					if (SYSTEM::TIMERB() > 4500 && __LIB_0__::func_76(PLAYER::PLAYER_PED_ID(), iLocal_346, 1) < 70f)
					{
						if (__LIB_0__::func_680())
						{
							__LIB_0__::func_709(iLocal_354, "FAM1_AYAA", "JIMMY", 4);
						}
						else if (!iLocal_366)
						{
							__LIB_0__::func_709(func_2(), "FAM1_CBAA", "FRANKLIN", 4);
							iLocal_366 = 1;
						}
						else
						{
							__LIB_0__::func_709(func_2(), "FAM1_DMAA", "FRANKLIN", 4);
						}
						SYSTEM::SETTIMERB(0);
					}
					break;
				case 1:
					if (SYSTEM::TIMERB() > 5000 && __LIB_0__::func_76(PLAYER::PLAYER_PED_ID(), iLocal_346, 1) < 70f)
					{
						if (MISC::GET_RANDOM_INT_IN_RANGE(0, 10) > 5)
						{
							if (iLocal_3100)
							{
								__LIB_0__::func_709(iLocal_354, "FAM1_GCAA", "JIMMY", 4);
								iLocal_3100 = 0;
							}
							else
							{
				...
				case 2:
					if (SYSTEM::TIMERB() > 4000 && __LIB_0__::func_76(PLAYER::PLAYER_PED_ID(), iLocal_346, 1) < 70f)
					{
						if (__LIB_0__::func_680())
						{
							__LIB_0__::func_709(iLocal_354, "FAM1_GDAA", "JIMMY", 4);
							SYSTEM::SETTIMERB(0);
						}
					}
					break;
			...
			if ((!ENTITY::IS_ENTITY_DEAD(iLocal_354, false) && !ENTITY::IS_ENTITY_DEAD(iLocal_342, false)) && STREAMING::HAS_ANIM_DICT_LOADED("MISSFAM1_YachtBattleinCar02_"))
			{
				if (func_418(1065353216))
				{
					if (func_442(1119092736))
					{
						...
						__LIB_0__::func_709(iLocal_354, "MAST_FALL", "JIMMY_NORMAL", 4);
						...
						iLocal_3023 = 27;
						HUD::SET_BLIP_DISPLAY(iLocal_410, 4);
						__LIB_14__::func_654(&uLocal_446, "FAM1AUD", "FAM1_CATCH", 9, 0, 0);
					}
					else if (iLocal_250 == 0)
					{
						__LIB_0__::func_429();
						__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_STEADY", 9, 0, 0, 0);
						iLocal_250 = 1;
					}
				}
				else
		...
		case 27:
			...
			{
				__LIB_0__::func_429();
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_CATCH2", 9, 0, 0, 0))
				{
					iLocal_250 = 1;
				}
			}
		...
		case 28:
			...
			{
				HUD::CLEAR_PRINTS();
				__LIB_0__::func_221(&uLocal_446, 4);
		...
		case 32:
			func_420();
			__LIB_17__::func_786(4, "STAGE_FRANKLIN_JUMPS_BACK_ONTO_BOAT", 0, 0, 0, 1);
			iLocal_3023 = 30;
			break;
		case 30:
			if (CAM::IS_SCREEN_FADED_OUT())
			...
			if (!iLocal_364)
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_LEAP", 8, 0, 0, 0))
				{
					iLocal_364 = 1;
				}
			}
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_371))
			{
				if ((PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_371) >= 1f && !ENTITY::IS_ENTITY_DEAD(iLocal_346, false)) && !ENTITY::IS_ENTITY_DEAD(func_2(), false))
				{
					...
					HUD::SET_BLIP_DISPLAY(iLocal_410, 0);
					iLocal_340 = __LIB_0__::func_666(func_2(), 0, 145);
					iLocal_359 = 0;
					iLocal_3023 = 31;
				}
			}
		...
		case 33:
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_342, false))
			{
				if ((iLocal_359 == 0 && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_342, false)) && !__LIB_13__::func_755(&Local_283, 2))
				{
					__LIB_0__::func_229("YB_OBJ4", 7500, 1);
					iLocal_359 = 1;
				}
			}
			func_420();
			if ((SYSTEM::TIMERB() > 2500 && iLocal_359 == 1) && !func_441(1f, 1))
			{
				if (__LIB_13__::func_755(&Local_283, 1))
				{
					__LIB_0__::func_709(func_2(), "FAM1_AAAA", "FRANKLIN", 4);
					SYSTEM::SETTIMERB(0);
				}
				else if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_CTCHF", 8, 0, 0, 0))
				{
					SYSTEM::SETTIMERB(0);
				}
			}
		...
		case 36:
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_371))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_371) >= 0.022f && iLocal_3017 == 0)
				{
					...
					__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_LEAP2", 9, 0, 0, 0);
			...
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_371))
			{
				...
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_SAFE", 9, 0, 0, 0))
					{
		...
		case 38:
			...
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_CARFUCK", 9, 0, 0, 0) || (MISC::GET_GAME_TIMER() - iLocal_3101) > 15000)
				{
		...
		case 42:
			...
			if (iLocal_3023 < 27)
			{
				while (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_F1", 9, 0, 0, 0))
				{
					SYSTEM::WAIT(0);
				}
			}
			...
			{
				while (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_F2", 9, 0, 0, 0))
				{
					SYSTEM::WAIT(0);
				}
				while (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_F3", 9, 0, 0, 0))
				{
					SYSTEM::WAIT(0);
				}
			}
			__LIB_0__::func_381("YB_FAIL3");
			AUDIO::TRIGGER_MUSIC_EVENT("FAM1_FAIL");
			SYSTEM::SETTIMERA(0);
			func_6();
			break;
	...
	if (fLocal_392 > 191000f && iLocal_3023 < 34)
	{
		switch (iLocal_368)
		{
			...
			case 1:
				if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_GNAFAIL", 9, 0, 0, 0))
					{
						iLocal_368 = 1;
					}
				}
...
void func_381()//Position - 0x1F45A
{
	...
	__LIB_39__::func_723(iLocal_325, iLocal_54, fLocal_389);
	__LIB_39__::func_723(iLocal_326, iLocal_55, fLocal_389);
	switch (iLocal_270)
	{
		case 0:
			if (fLocal_392 > 0f)
	...
	if ((((((((!ENTITY::IS_ENTITY_DEAD(iLocal_342, false) && iLocal_3023 > 8) && iLocal_3023 < 36) && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_342)) && fVar2 < 3f) && !__LIB_0__::func_77(0)) && __LIB_6__::func_177(ENTITY::GET_ENTITY_HEADING(iLocal_342), ENTITY::GET_ENTITY_HEADING(iLocal_346), 50f)) && !ENTITY::IS_ENTITY_AT_COORD(iLocal_342, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_346, Local_387), 8f, 14f, 5f, false, true, 0)) || bLocal_3014)
	{
		...
		if (__LIB_13__::func_796(&uLocal_434, 0, 0, 0) || bLocal_3014)
		{
...
{
	__LIB_16__::func_39(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, bParam5, bParam6);
}
		...
		switch (iLocal_3098)
		{
			...
			case 3:
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_380) >= 0.5f && ENTITY::DOES_ENTITY_EXIST(iLocal_356))
				{
					...
					__LIB_0__::func_640(func_2(), "MELEE_LARGE_GRUNT", 3);
					ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_356);
				}
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_380) >= 0.544f)
				{
					__LIB_0__::func_709(iLocal_352, "SCREAM_TERROR", "WAVELOAD_PAIN_MALE", 3);
					ENTITY::PROCESS_ENTITY_ATTACHMENTS(iLocal_352);
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_369))
		{
			switch (iLocal_262)
			{
				...
				case 2:
					if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
					{
						if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_B4", 8, 0, 0, 0))
						{
							iLocal_262++;
						}
					}
...
void func_420()//Position - 0x21A3F
{
	switch (iLocal_3055)
	{
		case 0:
			if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) && (MISC::GET_GAME_TIMER() - iLocal_297) > 2200)
			{
				...
				__LIB_0__::func_222(&uLocal_446, 6, iLocal_353, "YACHTPED3", 0, 1);
				...
				__LIB_0__::func_609(iLocal_353, 0);
		...
		case 2:
			...
			if (iLocal_3023 > 28)
			{
				if (!PED::IS_PED_INJURED(iLocal_353) && !ENTITY::IS_ENTITY_DEAD(iLocal_346, false))
				{
					...
					{
						__LIB_0__::func_709(iLocal_353, "SCREAM_TERROR", "WAVELOAD_PAIN_MALE", 3);
		...
		case 4:
			if (iLocal_3023 < 27)
			{
				...
				if ((MISC::GET_GAME_TIMER() - iLocal_3088) > 20000)
				{
					...
					__LIB_0__::func_709(iLocal_354, "SCREAM_TERROR", "WAVELOAD_PAIN_MALE", 3);
	...
	if (((!__LIB_13__::func_755(&Local_283, 1) && iLocal_3055 >= 2) && iLocal_3055 <= 6) && iLocal_3023 < 29)
	{
		if (!PED::IS_PED_INJURED(iLocal_353))
		{
			if (iLocal_360 == 0)
			{
				__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_B3", 7, 0, 0, 0);
				iLocal_360 = 1;
			}
		}
	}
...
void func_429()//Position - 0x225E1
{
	switch (iLocal_267)
	{
		...
		case 1:
		case 2:
			if ((!ENTITY::IS_ENTITY_DEAD(iLocal_351, false) && iLocal_267 == 1) && !__LIB_13__::func_755(&Local_283, 1))
			{
				__LIB_14__::func_654(&uLocal_446, "FAM1AUD", "FAM1_WHERE", 9, 0, 0);
				iLocal_267 = 2;
			}
		...
		case 4:
			if (func_444(iLocal_369) > 0.35f)
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_351, false))
				{
					__LIB_0__::func_229("YB_OBJ2", 5500, 1);
					iLocal_337 = __LIB_0__::func_666(iLocal_351, 1, 145);
				}
				HUD::SET_BLIP_DISPLAY(iLocal_410, 0);
		...
		switch (iLocal_3024)
		{
			...
			case 4:
				if (!func_441(1.35f, 1))
				{
					...
					__LIB_0__::func_709(func_2(), "GENERIC_SHOCKED_MED", "FRANKLIN_NORMAL", 4);
					iLocal_3024 = 1;
				}
				break;
			case 5:
				switch (iLocal_253)
				{
					case 0:
						...
						__LIB_0__::func_709(func_2(), "FAM1_BWAA", "FRANKLIN", 4);
						iLocal_253++;
						break;
					case 1:
						if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_378))
					...
					case 1:
						if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_378))
						{
							if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_378) >= 1f)
							{
								...
								__LIB_0__::func_709(func_2(), "GENERIC_FRIGHTENED_MED", "FRANKLIN_NORMAL", 4);
								iLocal_253++;
							}
						}
						break;
			...
			case 7:
				...
				__LIB_0__::func_709(func_2(), "GENERIC_SHOCKED_HIGH", "FRANKLIN_NORMAL", 4);
				iLocal_3024 = 1;
				break;
			case 11:
				__LIB_0__::func_709(func_2(), "GENERIC_FRIGHTENED_HIGH", "FRANKLIN_NORMAL", 4);
...
int func_441(float fParam0, bool bParam1)//Position - 0x232A2
{
	...
	fVar4 = (2.3f * fParam0);
	if (__LIB_0__::func_724(iLocal_342, Var0, 0) < fVar4)
	{
		if (bParam1)
		{
	...
	if (__LIB_0__::func_724(iLocal_342, Var1, 0) < fVar4)
	{
		if (bParam1)
		{
			if (ENTITY::GET_ENTITY_SPEED(iLocal_346) < ENTITY::GET_ENTITY_SPEED(iLocal_342))
	...
	if (__LIB_0__::func_724(iLocal_342, Var2, 0) < fVar4)
	{
		if (bParam1)
		{
			if (ENTITY::GET_ENTITY_SPEED(iLocal_346) < ENTITY::GET_ENTITY_SPEED(iLocal_342))
	...
	if (__LIB_0__::func_724(iLocal_342, Var3, 0) < fVar4)
	{
		if (bParam1)
		{
			if (ENTITY::GET_ENTITY_SPEED(iLocal_346) < ENTITY::GET_ENTITY_SPEED(iLocal_342))
...
void func_447(int iParam0, struct<3> Param1, float fParam2, float fParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x23695
{
	...
	else
	{
		...
		__LIB_17__::func_148(&Local_241, Local_240.f_0, fLocal_242, 0);
		if (bParam6)
		{
			__LIB_17__::func_148(&(Local_241.f_1), Local_240.f_1, (fVar0 * Var1.f_1), 0);
		}
		__LIB_17__::func_148(&(Local_241.f_2), Local_240.f_2, (fVar0 * Var1.f_2), 0);
	}
...
void func_449(int iParam0, int iParam1, struct<3> Param2, float fParam3, float fParam4, float fParam5, float fParam6)//Position - 0x23805
{
	...
	{
		__LIB_17__::func_148(&Local_241, Local_240.f_0, fLocal_242, 0);
		__LIB_17__::func_148(&(Local_241.f_1), Local_240.f_1, fLocal_242, 0);
		__LIB_17__::func_148(&(Local_241.f_2), Local_240.f_2, fLocal_242, 0);
	}
...
void func_460()//Position - 0x23E33
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_3094) > 3000)
	{
		if (!__LIB_0__::func_75())
		{
			iVar0 = VEHICLE::GET_CLOSEST_VEHICLE(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 10f, 0, __LIB_15__::func_914());
			if (!ENTITY::IS_ENTITY_DEAD(iVar0, false))
			{
				bVar2 = false;
				iVar3 = 0;
	...
	while (iVar0 <= 143)
	{
		...
		if (iLocal_301)
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_302) > 500)
			{
				if (!__LIB_13__::func_755(&Local_283, 1))
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_NEARMIS", 8, 0, 0, 0))
					{
						iLocal_301 = 0;
					}
				}
...
void func_463()//Position - 0x2412F
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_346, false) && iLocal_277 == 1)
	{
		...
		{
			case 0:
				__LIB_0__::func_222(&uLocal_446, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
				iLocal_269++;
				break;
			case 1:
				...
				break;
			case 2:
				if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && !__LIB_13__::func_755(&Local_283, 1))
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_CRASH", 9, 0, 0, 0))
					{
						iLocal_269++;
					}
				}
			...
			case 3:
				...
				break;
			case 4:
				if ((!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && !__LIB_13__::func_755(&Local_283, 1)) && __LIB_0__::func_76(PLAYER::PLAYER_PED_ID(), iLocal_345, 0) < fVar1)
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_CRASH", 9, 0, 0, 0))
					{
						iLocal_269++;
			...
			case 8:
				if ((!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && !__LIB_13__::func_755(&Local_283, 1)) && __LIB_0__::func_76(PLAYER::PLAYER_PED_ID(), iLocal_345, 0) < fVar1)
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_GARB", 9, 0, 0, 0))
					{
						iLocal_269++;
					}
				}
	...
	if ((!ENTITY::IS_ENTITY_DEAD(iLocal_342, false) && iLocal_277 == 1) && iLocal_261)
	{
		if (((MISC::GET_GAME_TIMER() - iLocal_258) > iVar0 && ENTITY::GET_ENTITY_SPEED(iLocal_342) > 0.1f) && __LIB_0__::func_76(PLAYER::PLAYER_PED_ID(), iLocal_345, 0) < fVar1)
		{
			...
			{
				if ((!__LIB_13__::func_755(&Local_283, 1) && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) && !AUDIO::IS_AMBIENT_SPEECH_PLAYING(func_2()))
				{
					if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", sLocal_260, 9, 0, 0, 0))
					{
						if (iLocal_3073 < 3)
						{
							iLocal_3073++;
		...
		{
			if ((!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING() && !__LIB_13__::func_755(&Local_283, 1)) && iLocal_3023 < 9)
			{
				iLocal_300 = 1;
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_COLLIDE", 7, 0, 0, 0))
				{
					iLocal_300 = 0;
				}
			}
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_345))
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_345, false) && iLocal_3023 != 38)
				{
					if (iLocal_3023 < 34)
					{
						...
						{
							if (((!__LIB_13__::func_755(&Local_283, 1) && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_342, false)) && iLocal_276 == 0)
							{
								__LIB_0__::func_229("YB_WARN1", 7500, 1);
								iLocal_276 = 1;
							}
				...
				__LIB_14__::func_655(iLocal_410, iLocal_346, 300f, 0.85f, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_346, false))
			{
			}
...
void func_469()//Position - 0x25037
{
	...
	switch (iLocal_305)
	{
		...
		case 1:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				if (__LIB_17__::func_152(&uLocal_446, "FAM1AUD", "FAM1_BANT", 9, 0, 0, 0, 0))
				{
					iLocal_305++;
				}
			}
		...
		case 3:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				if (__LIB_17__::func_152(&uLocal_446, "FAM1AUD", "FAM1_START", 9, 0, 0, 0, 0))
				{
					iLocal_305++;
				}
			}
...
void func_474(float fParam0)//Position - 0x25848
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_345, false) && !ENTITY::IS_ENTITY_DEAD(iLocal_346, false))
	{
		...
		__LIB_39__::func_724(iLocal_325, iLocal_54, "Fam1Cam", 3);
		__LIB_39__::func_724(iLocal_326, iLocal_55, "Fam1Cam", 4);
...
{
	if (((((((VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(1, "Fam1New") && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(1, "Fam1Cine")) && __LIB_39__::func_719(3, "Fam1Cam")) && __LIB_39__::func_719(4, "Fam1Cam")) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("FAMILY_1_CHASE_01", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("FAMILY_1_CHASE_02", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CAR_CRASHES_01", false, -1)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("FAMILY_1_BOAT_STRAIN", false, -1))
	{
...
void func_485()//Position - 0x2A8ED
{
	...
	__LIB_39__::func_720(3, "Fam1Cam");
	__LIB_39__::func_720(4, "Fam1Cam");
	STREAMING::REQUEST_ANIM_DICT("MISSFAM1_YachtBattle");
...
void func_489()//Position - 0x2AA1D
{
	...
	switch (iLocal_304)
	{
		case 0:
			...
			break;
		case 1:
			if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_ACAR", 9, 0, 0, 0))
			{
				iLocal_304++;
			}
			break;
		case 2:
			if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_342, true))
			{
				if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				{
					if (__LIB_16__::func_6(&uLocal_446, 14, "FAM1AUD", "FAM1_PHONEX", 9, 1, 0, 0, 1))
					{
						iLocal_304++;
					}
				}
		...
		case 3:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				if ((__LIB_3__::func_579() || __LIB_1__::func_859()) || __LIB_16__::func_596())
				{
					if (iLocal_3079 == 0)
					{
						SYSTEM::SETTIMERB(0);
			...
			{
				__LIB_17__::func_67(14, "YB_JIMTXT" /* GXT: Dad - Come quick! These guys are stealing ur yacht, we're headin down the freeway. Totes not my fault! */, 1, 1, 0, 0, 0, 1, 0, 1);
			}
			if (((SYSTEM::TIMERB() > 1000 && !AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) && iLocal_3079 == 0) || (SYSTEM::TIMERB() > 4000 && iLocal_3079 == 1))
			{
				if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_CHANGE", 9, 0, 0, 0))
				{
					RECORDING::REPLAY_RECORD_BACK_FOR_TIME(3f, 5f, 4);
					iLocal_304++;
				}
			...
			break;
		case 4:
			if (__LIB_16__::func_5(&uLocal_446, "FAM1AUD", "FAM1_HELPOUT", 9, 0, 0, 0))
			{
				iLocal_304++;
			}
			break;
		case 5:
			if (!AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				...
				{
					__LIB_0__::func_229("YB_GETIN", 7500, 1);
				}
				iLocal_304++;
			}
			break;
	...
	if (SYSTEM::TIMERA() > 0)
	{
		__LIB_33__::func_610(&Local_283, Local_329, 0.0001f, 0.0001f, 2.01f, 0, func_2(), 0, 0, iLocal_342, "YB_GETTO", "CMN_FLEAVE" /* GXT: ~s~Return to ~b~Franklin.~s~ */, "", "", "CMN_FLEAVE" /* GXT: ~s~Return to ~b~Franklin.~s~ */, "YB_GETIN", "CMN_GENGETBCK" /* GXT: ~s~Get back in the ~b~car. */, 0, 1, 1, -1);
	}
	func_470();
}
...
int func_529(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, bool bParam12, bool bParam13)//Position - 0x2D587
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_78130[1 /*14*/] = { __LIB_3__::func_84(iVar5, iVar0, func_657(iParam0, iVar0, -1), -1) };
	...
	else
	{
		...
		else if (iParam1 == 8)
		{
			...
			if (iParam5 == 0)
			{
				iVar6 = func_640(iVar5, iParam2, __LIB_0__::func_350(iParam0, 11), __LIB_0__::func_350(iParam0, 4));
			}
		}
		else if (iParam1 == 9)
		{
		...
		else if (iParam1 == 4)
		{
			...
			if (iParam5 == 0)
			{
				iVar6 = func_640(iVar5, __LIB_0__::func_350(iParam0, 8), __LIB_0__::func_350(iParam0, 11), iParam2);
			}
				...
				while (iVar2 < 15)
				{
					...
					if (iVar3 != -99)
					{
						...
						else if (iVar2 == 8)
						{
							if (iVar6 != -99)
							{
								iVar6 = func_640(iVar5, iVar3, __LIB_0__::func_350(iParam0, 11), __LIB_0__::func_350(iParam0, 4));
							}
						}
					}
					iVar2++;
	...
	if (iVar10 != -1)
	{
		iVar84 = __LIB_0__::func_282(iVar5, func_657(iParam0, 3, -1), iVar10);
		if (iVar84 != -1)
		{
			if (iVar5 == joaat("MP_M_Freemode_01"))
			{
			...
			switch (iVar0)
			{
				...
				case 1:
					switch (iVar1)
					{
						...
						case 7:
						case 12:
							iVar2 = __LIB_0__::func_676(joaat("MP_M_Freemode_01"), 11, func_657(iParam0, 11, -1), 0);
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar7 = __LIB_0__::func_676(joaat("MP_F_Freemode_01"), 11, func_657(iParam0, 11, -1), 0);
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar10 = __LIB_0__::func_676(joaat("MP_F_Freemode_01"), 11, func_657(iParam0, 11, -1), 0);
				...
				case 1:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar11 = __LIB_0__::func_676(joaat("MP_F_Freemode_01"), 11, func_657(iParam0, 11, -1), 0);
	...
	switch (iParam0)
	{
		case joaat("MP_M_Freemode_01"):
			...
			else if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar2, joaat("BIKER_VEST"), 0) && !FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar2, joaat("JACKET_ONLY"), 0))
			{
				...
				{
					iVar0 = func_640(iParam0, -99, __LIB_0__::func_357(iParam0, iParam1, 0), iParam3);
					if (iVar0 == -99)
					{
						iVar0 = 0;
					}
...
int func_647(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x55738
{
	...
	*iParam1 = 0;
	...
	if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAZ_MASK"), 0) && !__LIB_0__::func_348(iVar0, 14, func_657(iParam0, 14, 0), -1))
	{
		return 1;
	}
	else
					...
					while (iVar1 < iVar5)
					{
						if (iVar1 < Global_4538446)
						{
							if (Global_4538446[iVar1] != -1)
							{
								...
								{
									func_666(iParam0, __LIB_0__::func_33(Global_4538457[iVar1]), __LIB_0__::func_204(iParam0, Global_4538446[iVar1], __LIB_0__::func_33(Global_4538457[iVar1]), 3), 1);
								}
								else
								{
									func_666(iParam0, __LIB_0__::func_33(Global_4538457[iVar1]), __LIB_0__::func_204(iParam0, Global_4538446[iVar1], __LIB_0__::func_33(Global_4538457[iVar1]), 4), 1);
								}
							}
						}
						iVar1++;
			...
			if (bParam3 == 1)
			{
				if (iParam0 == joaat("MP_M_Freemode_01"))
				{
					...
					else if (iParam1 == 11)
					{
						...
						else if (iParam2 >= 220 && iParam2 <= 235)
						{
							...
							{
								case 220:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_0"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_0"), 8, 3), 0);
									break;
								case 221:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_1"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_1"), 8, 3), 0);
									break;
								case 222:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_2"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_2"), 8, 3), 0);
									break;
								case 223:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_3"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_3"), 8, 3), 0);
									break;
								case 224:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_4"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_4"), 8, 3), 0);
									break;
								case 225:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_5"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_5"), 8, 3), 0);
									break;
								case 226:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_6"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_6"), 8, 3), 0);
									break;
								case 227:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_7"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_7"), 8, 3), 0);
									break;
								case 228:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_8"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_8"), 8, 3), 0);
									break;
								case 229:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_9"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_9"), 8, 3), 0);
									break;
								case 230:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_10"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_10"), 8, 3), 0);
									break;
								case 231:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_11"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_11"), 8, 3), 0);
									break;
								case 232:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_12"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_12"), 8, 3), 0);
									break;
								case 233:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_13"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_13"), 8, 3), 0);
									break;
								case 234:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_14"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_14"), 8, 3), 0);
									break;
								case 235:
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS4_15"), 8, 3), 0);
									func_666(iParam0, 8, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_M_ACCS5_15"), 8, 3), 0);
									break;
								}
						}
					}
					else if (iParam1 == 7)
					{
						if (iParam2 >= 41 && iParam2 <= 56)
						{
							...
							{
								case 0:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_0"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_0"), 7, 3), 0);
									break;
								case 1:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_1"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_1"), 7, 3), 0);
									break;
								case 2:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_2"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_2"), 7, 3), 0);
									break;
								case 3:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_3"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_3"), 7, 3), 0);
									break;
								case 4:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_4"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_4"), 7, 3), 0);
									break;
								case 5:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_5"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_5"), 7, 3), 0);
									break;
								case 6:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_6"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_6"), 7, 3), 0);
									break;
								case 7:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_7"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_7"), 7, 3), 0);
									break;
								case 8:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_8"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_8"), 7, 3), 0);
									break;
								case 9:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_9"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_9"), 7, 3), 0);
									break;
								case 10:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_10"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_10"), 7, 3), 0);
									break;
								case 11:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_11"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_11"), 7, 3), 0);
									break;
								case 12:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_12"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_12"), 7, 3), 0);
									break;
								case 13:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_13"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_13"), 7, 3), 0);
									break;
								case 14:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_14"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_14"), 7, 3), 0);
									break;
								case 15:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH0_15"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH2_15"), 7, 3), 0);
									break;
							}
						}
						else if (iParam2 >= 73 && iParam2 <= 88)
						{
							...
							{
								case 0:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_0"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_0"), 7, 3), 0);
									break;
								case 1:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_1"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_1"), 7, 3), 0);
									break;
								case 2:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_2"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_2"), 7, 3), 0);
									break;
								case 3:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_3"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_3"), 7, 3), 0);
									break;
								case 4:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_4"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_4"), 7, 3), 0);
									break;
								case 5:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_5"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_5"), 7, 3), 0);
									break;
								case 6:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_6"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_6"), 7, 3), 0);
									break;
								case 7:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_7"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_7"), 7, 3), 0);
									break;
								case 8:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_8"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_8"), 7, 3), 0);
									break;
								case 9:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_9"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_9"), 7, 3), 0);
									break;
								case 10:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_10"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_10"), 7, 3), 0);
									break;
								case 11:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_11"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_11"), 7, 3), 0);
									break;
								case 12:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_12"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_12"), 7, 3), 0);
									break;
								case 13:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_13"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_13"), 7, 3), 0);
									break;
								case 14:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_14"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_14"), 7, 3), 0);
									break;
								case 15:
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH1_15"), 7, 3), 0);
									func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI2_M_TEETH3_15"), 7, 3), 0);
									break;
								}
							}
					}
				...
				if (iParam1 == 11)
				{
					...
					if (iParam2 >= 192 && iParam2 <= 203)
					{
						...
						{
							case 199:
								func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_F_ACCS2_0"), 7, 4), 0);
								break;
							case 200:
								func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_F_ACCS2_1"), 7, 4), 0);
								break;
							case 201:
								func_666(iParam0, 7, __LIB_0__::func_204(iParam0, joaat("DLC_MP_BUSI_F_ACCS2_2"), 7, 4), 0);
								break;
							}
					}
				}
...
int func_778(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x8B3E9
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_78130[1 /*14*/] = { __LIB_13__::func_798(iVar10, iVar0, func_794(iParam0, iVar0, -1), -1) };
				if (BitTest(Global_78130[1 /*14*/].f_6, 3))
				{
					if (iVar0 == 2)
					{
...
void func_795(int iParam0)//Position - 0x8DD07
{
	...
	__LIB_37__::func_535(17, 0);
	STREAMING::REQUEST_MODEL(__LIB_12__::func_894(1));
	HUD::REQUEST_ADDITIONAL_TEXT("FAMILY1", 0);
	HUD::REQUEST_ADDITIONAL_TEXT("FAM1AUD", 6);
	while ((((!VEHICLE::HAS_VEHICLE_ASSET_LOADED(joaat("sentinel2")) || !__LIB_37__::func_537(17, 0)) || !STREAMING::HAS_MODEL_LOADED(__LIB_12__::func_894(1))) || !HUD::HAS_ADDITIONAL_TEXT_LOADED(6)) || !HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
	{
	...
	{
		if (!__LIB_0__::func_363(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0, 0))
		{
			__LIB_16__::func_934(-843.9858f, 158.65485f, 64.90799f, -777.54004f, 183.18657f, 81.33534f, 34.25f, -858.9615f, 147.4493f, 61.4344f, 357.0481f, 5f, 7f, 8.5f, 1, 1, 1, 1, 0);
		}
	}
	if (iParam0 != 1)
	{
	...
	__LIB_0__::func_505(iLocal_342, -1);
	...
	PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 32, false);
	__LIB_0__::func_222(&uLocal_446, 1, func_2(), "FRANKLIN", 0, 1);
}
		...
		if (!Global_100362[iVar0])
		{
			...
			if (iVar0 == 0)
			{
				if (!__LIB_0__::func_422(49))
				{
					...
					func_821(__LIB_12__::func_894(0), 12, 16, 0, 0, 0, 0);
				}
				if (!__LIB_0__::func_422(44))
				{
					...
					func_821(__LIB_12__::func_894(0), 3, 70, 1, 0, 0, 0);
					func_821(__LIB_12__::func_894(0), 3, 71, 1, 0, 0, 0);
					func_821(__LIB_12__::func_894(0), 3, 72, 1, 0, 0, 0);
					func_821(__LIB_12__::func_894(0), 3, 73, 1, 0, 0, 0);
					func_821(__LIB_12__::func_894(0), 3, 74, 1, 0, 0, 0);
					func_821(__LIB_12__::func_894(0), 3, 75, 1, 0, 0, 0);
					func_821(__LIB_12__::func_894(0), 4, 41, 1, 0, 0, 0);
					func_821(__LIB_12__::func_894(0), 4, 42, 1, 0, 0, 0);
					func_821(__LIB_12__::func_894(0), 4, 43, 1, 0, 0, 0);
					func_821(__LIB_12__::func_894(0), 4, 44, 1, 0, 0, 0);
					func_821(__LIB_12__::func_894(0), 4, 45, 1, 0, 0, 0);
				}
			}
			else if (iVar0 == 2)
			{
...
int func_829(int iParam0, bool bParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0x90370
{
	...
	if (!__LIB_0__::func_374(bParam1))
	{
		...
		Var0.f_31 = 49;
		Var0.f_81 = 2;
		__LIB_17__::func_149(bParam1, &Var0, iParam5);
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
		...
		if ((bParam1 == 17 && Global_113386.f_2363.f_539.f_3618[0 /*197*/][0 /*98*/] == Var0.f_0) || (bParam1 == 15 && Global_113386.f_2363.f_539.f_3618[0 /*197*/][1 /*98*/] == Var0.f_0))
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar1 /*98*/], Param2, fParam3, false, false, false);
				...
				__LIB_0__::func_670(iParam0, &(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_31), &(Global_113386.f_2363.f_539.f_3618[0 /*197*/][iVar1 /*98*/].f_81));
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var0.f_0))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var0.f_0, Param2, fParam3, false, false, false);
				...
				VEHICLE::SET_VEHICLE_CAN_SAVE_IN_GARAGE(*iParam0, false);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(*iParam0, true);
				__LIB_17__::func_340(iParam0, Var0);
...
void func_848()//Position - 0x91C5B
{
	...
	switch (iLocal_308)
	{
		...
		case 1:
			...
			{
				__LIB_17__::func_40("Franklin", joaat("Player_One"), 21);
			}
			__LIB_17__::func_40("Michael", joaat("Player_Zero"), 34);
		...
		case 5:
			if (CUTSCENE::IS_CUTSCENE_PLAYING() && iLocal_308 == 3)
			{
				...
				__LIB_0__::func_325();
				__LIB_15__::func_228(&uLocal_3028, 0, 0, 2000, 1, 1, 0, 1);
				func_59(0, 0, 2000, 1, 0);
				__LIB_0__::func_468(17);
				iLocal_308 = 4;
			}
			if (iLocal_308 == 4)
			{
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
			{
				if (__LIB_14__::func_466() != 0)
				{
					__LIB_16__::func_893(&iLocal_56, 0);
					__LIB_17__::func_200(&iLocal_56, 1, 0, 0);
				}
				iLocal_3062 = 1;
...
void func_853()//Position - 0x92438
{
	...
	bLocal_303 = __LIB_13__::func_804(0);
	...
	if (__LIB_0__::func_323())
	{
		...
		func_863(0, 1);
		__LIB_0__::func_222(&uLocal_446, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		iLocal_3058 = __LIB_0__::func_344();
...
void func_854(int iParam0, bool bParam1)//Position - 0x926F5
{
	...
	switch (*iParam0)
	{
		case 3:
			...
			iLocal_304 = 5;
			__LIB_17__::func_779(0f);
			__LIB_0__::func_433(iLocal_342, -1, 1);
			if (!ENTITY::IS_ENTITY_DEAD(func_2(), false))
			{
		...
		case 9:
			...
			__LIB_17__::func_786(6, "STAGE_CHOP_SHOP_CUTSCENE", 0, 0, 0, 1);
			STREAMING::REQUEST_MODEL(joaat("IG_JimmyDiSanto"));
		...
		case 10:
			...
			__LIB_17__::func_786(7, "STAGE_FIX_CAR_AND_TAKE_JIMMY_HOME", 0, 0, 0, 1);
			__LIB_17__::func_151(39, 1, 0);
			__LIB_16__::func_593(39);
			__LIB_17__::func_230(39, 1);
			if (__LIB_0__::func_682(__LIB_14__::func_466()) != 1)
			{
				__LIB_16__::func_893(&iLocal_56, 1);
				__LIB_17__::func_200(&iLocal_56, 0, 0, 0);
			}
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(PLAYER::PLAYER_PED_ID(), false);
			PED::DELETE_PED(&(iLocal_56[0]));
			STREAMING::REQUEST_MODEL(joaat("IG_JimmyDiSanto"));
...
void func_860(bool bParam0, struct<3> Param1, float fParam2)//Position - 0x939F6
{
	if (bParam0)
	{
		__LIB_16__::func_1(Param1, fParam2, 1, 0);
	}
	else
	{
...
int func_863(int iParam0, bool bParam1)//Position - 0x93AEB
{
	...
	Global_22965.f_39 = 1;
	__LIB_17__::func_200(&Global_22965, 0, 0, 0);
	...
	switch (iLocal_3042)
	{
		...
		case 2:
			...
			if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
			{
				if (!__LIB_0__::func_363(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0, 0))
				{
					__LIB_16__::func_934(-843.9858f, 158.65485f, 64.90799f, -777.54004f, 183.18657f, 81.33534f, 34.25f, -858.9615f, 147.4493f, 61.4344f, 357.0481f, 5f, 7f, 8.5f, 1, 1, 1, 0, 0);
					__LIB_17__::func_195(-825.1512f, 178.9821f, 70.3781f, 25f, 0);
					__LIB_33__::func_625(-858.9615f, 147.4493f, 61.4344f, 357.0481f, 0, 145);
				}
			}
			func_59(1, 0, 2000, 1, 1);
			func_40();
		...
		case 4:
			...
			if (__LIB_17__::func_153(17, &uLocal_3028, 1, 0, 0, 1, 0) && iLocal_3051 == 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_56[1]))
				{
					iLocal_3042++;
			...
			else
			{
				if (!iLocal_3040)
				{
					...
					__LIB_0__::func_222(&uLocal_446, 0, 0, "TRACEY", 0, 1);
					__LIB_17__::func_152(&uLocal_446, "FAM1AUD", "FAM1_INT_LI", 9, 0, 0, 0, 0);
					HUD::DISPLAY_RADAR(false);
					iLocal_3040 = 1;
				}
			...
			break;
		case 5:
			if ((iLocal_3040 == 1 && iLocal_3041 == 0) && __LIB_0__::func_682(__LIB_14__::func_466()) == 0)
			{
				__LIB_13__::func_783();
				iLocal_3042++;
				iLocal_3041 = 1;
		...
		case 100:
			HUD::HIDE_HUD_AND_RADAR_THIS_FRAME();
			if ((__LIB_17__::func_153(17, &uLocal_3028, 1, 0, 0, 1, 0) && ENTITY::DOES_ENTITY_EXIST(iLocal_56[0])) && iLocal_3051 == 1)
			{
				iLocal_3042 = 101;
			}
...
int func_870(int iParam0)//Position - 0x94707
{
	if (__LIB_0__::func_374(iParam0))
	{
		return STREAMING::HAS_MODEL_LOADED(__LIB_12__::func_894(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_871(int iParam0)//Position - 0x94730
{
	if (__LIB_0__::func_374(iParam0))
	{
		STREAMING::REQUEST_MODEL(__LIB_12__::func_894(iParam0));
	}
	else if (iParam0 != 145)
	{
	}
