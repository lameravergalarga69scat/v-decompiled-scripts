...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_78 = __LIB_2__::func_910(64);
	uLocal_79 = __LIB_2__::func_910(63);
...
void func_1()//Position - 0x12C
{
	switch (iLocal_261)
	{
		...
		case 1:
			if (!bLocal_262)
			{
				bLocal_262 = __LIB_0__::func_787(&uLocal_95, "NIG1AAU", "NIG1A_COMM", 7, 0, 0, 0);
			}
...
void func_232()//Position - 0x2764A
{
	...
	{
		case 0:
			__LIB_14__::func_851("NMT_1_RCM", 1);
			iLocal_264 = 0;
			iLocal_261 = 1;
			break;
		case 1:
			switch (iLocal_264)
			{
				...
				case 1:
					...
					{
						__LIB_14__::func_614(-1103.3269f, 786.844f, 157.71326f, -1090.2865f, 788.60144f, 168.52283f, 10f, -1107.0227f, 788.9111f, 163.0734f, 187.0703f, __LIB_13__::func_790(), 1, 1, 1, 0, 0);
						__LIB_14__::func_785(-1107.0227f, 788.9111f, 163.0734f, 187.0703f, 0, 145);
				...
				case 2:
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						if (__LIB_0__::func_121(Local_94.f_35[0]))
						{
							__LIB_14__::func_659(Local_94.f_35[0], -1094.4845f, 785.5936f, 163.2927f, 102.2748f, 0, 1);
...
int func_341(var uParam0)//Position - 0x300E5
{
	...
	switch (iLocal_77)
	{
		case 0:
			...
			__LIB_14__::func_825(&uLocal_82, "rcmnigel1", "base_mrs_thornhill", "base_mrs_thornhill");
			iLocal_77 = 1;
			break;
		case 1:
		...
		case 2:
			bVar3 = true;
			if (!__LIB_14__::func_842(&(uParam0->f_28[0]), 64, -1100.5f, 789.8f, 164.34f, 1.82f, "RC: NIGEL", 1))
			{
				bVar3 = false;
			}
			if (!__LIB_14__::func_842(&(uParam0->f_28[1]), 63, -1099.35f, 789.15f, 164.47f, 0f, "RC: MRS THORNHILL", 1))
			{
				bVar3 = false;
			}
...
void func_352()//Position - 0x30A3D
{
	...
	PED::CLEAR_PED_NON_CREATION_AREA();
	__LIB_14__::func_871(&Local_94, 1, 0, 0);
