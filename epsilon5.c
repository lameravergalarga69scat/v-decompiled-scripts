...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		__LIB_35__.func_898(Local_84.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_81)
		{
			case 0:
				func_258();
...
void func_1()//Position - 0x147
{
	...
	{
		case 0:
			__LIB_26__.func_478("ep_5_rcm", 0);
			iLocal_82 = 1;
			break;
		case 1:
			if (__LIB_18__.func_170(1, 1093140480, 0))
			{
				if (__LIB_0__.func_121(Local_84.f_28[0]))
				{
				...
				__LIB_32__.func_755(638.7248f, 108.215866f, 87.00301f, 644.46674f, 124.22216f, 94.64042f, 12.5f, 638.915f, 101.537f, 88.1472f, 331.3091f, __LIB_9__.func_996(), 1, 1, 1, 0, 0);
		...
		case 3:
			...
			__LIB_10__.func_700(&Local_84, 0, 1);
			func_2();
			break;
	}
}
...
void func_2()//Position - 0x2E5
{
	int iVar0;
	__LIB_31__.func_624();
	__LIB_18__.func_203("EPSROBE_HE" /* GXT: Buy robes from the Epsilon Program website and wear them for 10 cumulative days. */, 1, 0, -1, 10000, 1, 0, 0, 0);
	__LIB_38__.func_127(4, 16, 0);
	STATS::STAT_GET_INT(joaat("NUM_EPSILON_STEP"), &iVar0, -1);
	if (iVar0 < 14)
	{
		STATS::STAT_SET_INT(joaat("NUM_EPSILON_STEP"), 14, true);
		__LIB_0__.func_4(23, 14);
	}
	func_3(322, 1);
	func_316();
}
...
void func_229()//Position - 0x28201
{
	if (__LIB_0__.func_121(Local_84.f_28[0]))
	{
		...
		{
			__LIB_0__.func_0(&(Local_84.f_28[0]));
		}
	}
}
...
void func_258()//Position - 0x29301
{
	...
	switch (iLocal_82)
	{
		case 0:
			...
			break;
		case 1:
			if (__LIB_0__.func_76(PLAYER::PLAYER_PED_ID(), Local_84.f_28[0], 1) >= 4.5f)
			{
			...
			if (iLocal_252 == 0)
			{
				if (__LIB_0__.func_76(PLAYER::PLAYER_PED_ID(), Local_84.f_28[0], 1) <= 2.5f)
				{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmepsilonism5"))
			{
				if (__LIB_0__.func_121(Local_84.f_28[0]))
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_84.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 3))
					{
						...
						{
							__LIB_0__.func_203(&uLocal_85, 4, Local_84.f_28[0], "MARNIE", 0, 1);
							__LIB_0__.func_203(&uLocal_85, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			...
			if (__LIB_0__.func_121(Local_84.f_28[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_84.f_28[0], "rcmepsilonism5", "leadin_action", 3))
				{
					if (iLocal_251 == 0)
					{
						...
						{
							if (__LIB_37__.func_799(&uLocal_85, "EPS5AUD", "EP5_RCM_LI", 8, 0, 0, 0))
							{
								iLocal_251 = 1;
							}
						}
...
int func_307(var uParam0)//Position - 0x2AC7B
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				if (__LIB_26__.func_256(&(uParam0->f_28[0]), 60, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && __LIB_1__.func_197(PLAYER::PLAYER_PED_ID()))
				{
...
void func_316()//Position - 0x2B00E
{
	...
	__LIB_32__.func_757(&Local_84, 0, 0, 0);
