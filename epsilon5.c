...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		__LIB_14__::func_863(Local_84.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_81)
		{
			case 0:
				func_258();
...
void func_1()//Position - 0x147
{
	...
	{
		case 0:
			__LIB_14__::func_851("ep_5_rcm", 0);
			iLocal_82 = 1;
			break;
		case 1:
			if (__LIB_14__::func_740(1, 1093140480, 0))
			{
				...
				__LIB_14__::func_614(638.7248f, 108.215866f, 87.00301f, 644.46674f, 124.22216f, 94.64042f, 12.5f, 638.915f, 101.537f, 88.1472f, 331.3091f, __LIB_13__::func_790(), 1, 1, 1, 0, 0);
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcmepsilonism5"))
			{
				if (__LIB_0__::func_121(Local_84.f_28[0]))
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_84.f_28[0], "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 3))
					{
						...
						{
							__LIB_0__::func_222(&uLocal_85, 4, Local_84.f_28[0], "MARNIE", 0, 1);
							__LIB_0__::func_222(&uLocal_85, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			...
			if (__LIB_0__::func_121(Local_84.f_28[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_84.f_28[0], "rcmepsilonism5", "leadin_action", 3))
				{
					if (iLocal_251 == 0)
					{
						...
						{
							if (__LIB_0__::func_787(&uLocal_85, "EPS5AUD", "EP5_RCM_LI", 8, 0, 0, 0))
							{
								iLocal_251 = 1;
							}
						}
...
int func_307(var uParam0)//Position - 0x2AC7B
{
	...
	switch (iLocal_77)
	{
		...
		case 2:
			...
			{
				if (__LIB_14__::func_842(&(uParam0->f_28[0]), 60, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && __LIB_0__::func_692(PLAYER::PLAYER_PED_ID()))
				{
...
void func_316()//Position - 0x2B00E
{
	...
	__LIB_14__::func_871(&Local_84, 0, 0, 0);
