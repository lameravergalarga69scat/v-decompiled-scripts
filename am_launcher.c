...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		switch (__LIB_30__::func_397(PLAYER::NETWORK_PLAYER_ID_TO_INT()))
		{
			case 0:
				if (func_395() == 1)
				{
...
void func_1()//Position - 0x18E
{
	...
	switch (Global_2779753.f_2)
	{
		case 0:
			if (func_320())
			{
				__LIB_0__::func_794(&(Global_2779753.f_179));
				func_318(1);
			}
			break;
		case 1:
					...
					switch (Global_2779753.f_3)
					{
						...
						default:
							if (func_298(Global_2779753.f_3))
							{
								...
								if (func_18(func_296(), &(Global_2779753.f_183), &(Global_2779753.f_184), __LIB_0__::func_162()))
								{
									func_318(6);
								}
								else
...
int func_11()//Position - 0x105B
{
	...
	if (NETWORK::NETWORK_GET_HOST_OF_SCRIPT("AM_IMP_EXP", -1, 0) != __LIB_0__::func_162())
	{
...
int func_14()//Position - 0x10FA
{
	...
	if (func_300(4))
	{
		if (!func_300(3))
		{
			__LIB_0__::func_794(&(Global_2779753.f_177));
			func_17(3);
		}
...
int func_18(int iParam0, var uParam1, var uParam2, int iParam3)//Position - 0x1226
{
	...
	if (iVar0 != -1)
	{
		...
		while (iVar1 == -1)
		{
			...
			iVar0 = __LIB_35__::func_656(iParam0, &uVar2);
			if (iVar0 == -1)
			{
			}
			else
...
int func_20(var[] uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, int iParam20)//Position - 0x1313
{
	int iVar0;
	int iVar1;
	if (iParam20 == __LIB_0__::func_162())
	{
		return 0;
	}
	...
	while (iVar0 < 10)
	{
		if (Global_2681762.f_199.f_962[iVar0 /*75*/] == __LIB_0__::func_162() || Global_2681762.f_199.f_962[iVar0 /*75*/] == iParam20)
		{
...
int func_24(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x1518
{
	...
	bool bVar1;
	int iVar2;
	iVar0 = __LIB_29__::func_832(iParam1, iParam2, iParam3);
	if (iVar0 <= 0)
	{
		return 0;
	}
	bVar1 = true;
	if (__LIB_20__::func_95(iParam0, iParam1, iParam2, iParam3, &bVar1, 0) == 0)
	{
		return 0;
	}
	if (!bVar1)
	...
	__LIB_28__::func_399(uParam4);
	uParam4->f_19 = iVar0;
	iVar2 = 0;
	while (iVar2 < uParam4->f_19)
	{
		(*uParam4)[iVar2] = __LIB_20__::func_95(iParam0, iParam1, iParam2, iParam3, &bVar1, iVar2);
		iVar2++;
	}
	return 1;
}
...
int func_77(int iParam0, int iParam1, int iParam2)//Position - 0x2CD1
{
	...
	float fVar7;
	int iVar8;
	iVar0 = __LIB_28__::func_420(iParam0, iParam1);
	iVar1 = ((iVar0 + __LIB_28__::func_419(iParam0, iParam1)) - 1);
	if (iVar0 == iVar1)
	{
	}
	iVar5 = __LIB_28__::func_418(iParam0, iParam1, iVar0, iVar1);
	iVar6 = iVar0;
	while (iVar6 <= iVar1)
	{
		if (__LIB_28__::func_417(iParam0, iVar6))
		{
		}
		else if (__LIB_40__::func_878(iParam0, iVar6, iParam2))
		{
		}
		...
		{
			uVar2[iVar6] = __LIB_28__::func_402(iParam0, iVar6);
		}
		iVar6++;
	}
	iVar6 = iVar0;
...
{
	if (__LIB_28__::func_403(__LIB_2__::func_55(iParam1)) <= iParam0)
	{
		return 0;
	}
	return 1;
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x2ED4
{
	...
	if (iVar0 >= 1 && iVar0 <= 22)
	{
		if (!__LIB_28__::func_404(iParam2, iVar0))
		{
			return 0;
		}
		return 1;
...
int func_97(int iParam0, int iParam1, int iParam2)//Position - 0x325D
{
	switch (iParam0)
	{
		...
		case 14:
			...
			{
				case 34:
					return !__LIB_40__::func_878(256, 35, iParam2);
				case 35:
					return !__LIB_40__::func_878(256, 34, iParam2);
				default:
			}
			break;
	}
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x32FA
{
	...
	if (__LIB_28__::func_406(iParam0, iParam1, iParam2))
	{
		if (!func_100(&Var0))
		{
			return 0;
...
int func_100(var uParam0)//Position - 0x46D8
{
	...
	while (iVar0 < iVar3)
	{
		if (!__LIB_28__::func_405(uParam0, iVar0) && !func_101(&(uParam0->f_767.f_1[iVar0 /*15*/]), iVar0))
		{
			return 0;
		}
		iVar0++;
...
int func_128(var uParam0, int iParam1, int iParam2)//Position - 0x50A9
{
	switch (__LIB_0__::func_955(iParam1))
	{
		...
		case 2:
			...
			{
				if (!__LIB_28__::func_407(uParam0->f_129, uParam0->f_767, uParam0->f_1220, ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(iParam2), false)))
				{
					return 0;
				}
			}
...
int func_139(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x5402
{
	...
	if (__LIB_0__::func_156(iParam4, 0, 1))
	{
		...
		fVar2 = __LIB_35__::func_657(iParam1, iParam2);
		fVar3 = __LIB_28__::func_408(iParam1, iParam2);
...
Vector3 func_144(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x56FB
{
	switch (iParam1)
	{
		case 271:
			...
			break;
		case 277:
			return __LIB_42__::func_194(__LIB_28__::func_411(iParam2, iParam3));
		case 262:
			return uParam0->f_129.f_1[0 /*21*/].f_3;
		case 300:
			return __LIB_42__::func_194(__LIB_19__::func_316(iParam2, iParam3));
		case 292:
			return __LIB_42__::func_194(__LIB_28__::func_410(iParam2, iParam3));
		case 295:
			return __LIB_42__::func_194(770);
		case 296:
			return __LIB_42__::func_194(__LIB_19__::func_314(iParam2, iParam3, 0, PLAYER::PLAYER_ID()));
	}
...
int func_216(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x98DA
{
	...
	struct<3> Var10;
	float fVar11;
	iVar0 = __LIB_28__::func_413(iParam1);
	if (iVar0 == -1)
	{
		return 1;
	}
	iVar1 = __LIB_28__::func_419(iParam1, iParam2);
	if (iVar1 <= iVar0)
	{
		return 1;
	}
	iVar2 = __LIB_28__::func_420(iParam1, iParam2);
	iVar3 = ((iVar2 + iVar1) - 1);
	Var4 = { __LIB_0__::func_85(iParam4) };
	Var5 = { __LIB_28__::func_412(uParam0, iParam1) };
	...
	while (iVar9 <= iVar3)
	{
		...
		{
			Var10 = { __LIB_28__::func_412(&Var7, iParam1) };
...
{
	if (!__LIB_19__::func_272(iParam1))
	{
		return 1;
	}
	return __LIB_43__::func_838(__LIB_35__::func_655(iParam1, iParam2, iParam3), uParam0, &uLocal_179);
}
...
int func_277(int iParam0, int iParam1, var uParam2)//Position - 0xEB8B
{
	int iVar0;
	iVar0 = 0;
	while (iVar0 < __LIB_28__::func_401(iParam0))
	{
		if (__LIB_28__::func_422(iParam0, iVar0))
		{
		}
	...
	return __LIB_35__::func_656(iParam0, uParam2);
}
...
int func_283(int iParam0, int iParam1)//Position - 0xED4D
{
	...
	switch (iParam0)
	{
		case 0:
			...
			if (__LIB_20__::func_731(iParam1, 0))
			{
				return 0;
			}
		...
		case 1:
			...
			if (__LIB_20__::func_731(iParam1, 1))
			{
				return 0;
			}
			if (!__LIB_1__::func_167(iParam1))
		...
		case 2:
			...
			if (__LIB_20__::func_731(iParam1, 2))
			{
				return 0;
			}
			if (!__LIB_1__::func_167(iParam1))
		...
		case 3:
			...
			if (__LIB_20__::func_731(iParam1, 3))
			{
				return 0;
			}
		...
		case 4:
			...
			if (__LIB_20__::func_731(iParam1, 4))
			{
				return 0;
			}
			if (!__LIB_1__::func_124(iParam1))
		...
		case 5:
			...
			if (__LIB_20__::func_731(iParam1, 5))
			{
				return 0;
			}
			if (!__LIB_1__::func_124(iParam1))
		...
		case 6:
			...
			if (__LIB_20__::func_731(iParam1, 6))
			{
				return 0;
			}
			if (!__LIB_1__::func_124(iParam1))
...
{
	int iVar0;
	iVar0 = __LIB_28__::func_421(iParam1);
	if (iVar0 == -1)
	{
		return 0;
	}
	if (__LIB_20__::func_779(iParam0) != iVar0)
	{
		return 0;
	}
	switch (iParam0)
...
{
	if (__LIB_0__::func_955(__LIB_27__::func_394(iParam0)) == 1)
	{
		return 1;
	}
	return 0;
	...
	switch (Local_210[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_2)
	{
		case 0:
			if (Global_2779753.f_2 >= 4 && Global_2779753.f_2 != 8)
			{
				...
				if (!__LIB_30__::func_391(PLAYER::PLAYER_ID(), 1))
				{
					func_392(4);
				}
				else if (!__LIB_30__::func_391(PLAYER::PLAYER_ID(), 3))
				{
			...
			else if (__LIB_30__::func_391(PLAYER::PLAYER_ID(), 1))
			{
				MISC::CLEAR_BIT(&(Local_210[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*3*/].f_1), 1);
			}
			break;
		case 4:
			if (__LIB_30__::func_391(PLAYER::PLAYER_ID(), 0))
			{
		...
		case 6:
			...
			if (!func_331())
			{
				if (!__LIB_30__::func_391(PLAYER::PLAYER_ID(), 2))
				{
					Local_200.f_16 = -1;
	...
	if (Global_2681762.f_84.f_2 == 1)
	{
		if (!BitTest(Global_2815059.f_206.f_1, 1))
		{
			if (((Global_262145.f_45 /* Tunable: CRATE_DROP_SPECIAL_FREQUENCY */ * 120000) - __LIB_1__::func_724(&(Global_2779753.f_177), 0, 0)) < 360000)
			{
				if (!BitTest(Global_2815059.f_206.f_1, 1))
				{
					if (__LIB_33__::func_241(31, 0, 0) && !__LIB_0__::func_629())
					{
...
int func_354(int iParam0)//Position - 0x11C5C
{
	...
	switch (iParam0)
	{
		...
		case 4:
			return (((((__LIB_33__::func_241(20, 0, 0) && !__LIB_0__::func_979(PLAYER::PLAYER_ID(), 1)) && !__LIB_0__::func_979(PLAYER::PLAYER_ID(), 2)) && !__LIB_0__::func_979(PLAYER::PLAYER_ID(), 3)) && !Global_2703735.f_3428) && !func_355());
		default:
	}
	return 1;
}
...
{
	return __LIB_33__::func_241(__LIB_27__::func_394(iParam0), 0, 0);
}
