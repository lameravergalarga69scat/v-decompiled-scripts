...
void func_2(int iParam0)//Position - 0x13C
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		if (iLocal_19 == 1)
		{
			...
			{
				case 2:
					__LIB_0__::func_709(iParam0, "BUDDY_SEES_TREVOR_DEATH", "FRANKLIN_NORMAL", 3);
					break;
				case 0:
					__LIB_0__::func_709(iParam0, "BUDDY_SEES_MICHAEL_DEATH", "FRANKLIN_NORMAL", 3);
					break;
			}
		}
		else if (iLocal_19 == 2)
		{
			...
			{
				case 1:
					__LIB_0__::func_709(iParam0, "BUDDY_SEES_FRANKLIN_DEATH", "TREVOR_NORMAL", 3);
					break;
				case 0:
					__LIB_0__::func_709(iParam0, "BUDDY_SEES_MICHAEL_DEATH", "TREVOR_NORMAL", 3);
					break;
			}
		}
		else if (iLocal_19 == 0)
		{
			...
			{
				case 2:
					__LIB_0__::func_709(iParam0, "BUDDY_SEES_TREVOR_DEATH", "MICHAEL_NORMAL", 3);
					break;
				case 1:
					__LIB_0__::func_709(iParam0, "BUDDY_SEES_FRANKLIN_DEATH", "MICHAEL_NORMAL", 3);
					break;
				}
			}
	}
			...
			if (Global_97810[iLocal_18] != PLAYER::PLAYER_PED_ID())
			{
				if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(Global_97810[iLocal_18]))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Global_97810[iLocal_18], false) || !ENTITY::IS_ENTITY_ATTACHED(Global_97810[iLocal_18]))
					{
						...
						{
							iLocal_19 = __LIB_0__::func_216(Global_97810[iLocal_18]);
							if ((iLocal_19 == 0 || iLocal_19 == 2) || iLocal_19 == 1)
							{
								if (iLocal_19 != __LIB_0__::func_683())
								{
