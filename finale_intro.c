...
void func_6()//Position - 0x1F6
{
	...
	{
		if (!__LIB_0__::func_776(iVar0, 1, 1))
		{
			__LIB_14__::func_588(12.5881f, 545.7901f, 174.9232f, 5f, 0);
		}
	}
	else
	{
	...
	{
		__LIB_14__::func_614(26.15189f, 560.65405f, 190.3232f, -14.36067f, 539.86017f, 170.3472f, 30f, 3.518f, 546.92346f, 173.7262f, 125.6127f, __LIB_13__::func_790(), 1, 1, 1, 0, 0);
	}
	else
	{
		__LIB_14__::func_592(26.15189f, 560.65405f, 190.3232f, -14.36067f, 539.86017f, 170.3472f, 30f, 9.039f, 554.2676f, 175.12f, 119.3638f, 1, 1, 1, 0, 0);
	}
	bVar1 = false;
