...
void __EntryFunction__()//Position - 0x0
{
	...
	__LIB_0__::func_467();
	__LIB_0__::func_222(&uLocal_50, 8, 0, "TANNOY", 0, 1);
	while (true)
	{
		SYSTEM::WAIT(0);
		__LIB_0__::func_467();
				...
				case 0:
					...
					else
					{
						...
						if (SYSTEM::TIMERA() > 125)
						{
							...
							if (__LIB_1__::func_873(bLocal_37, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)))
							{
										...
										if (!bLocal_40)
										{
											if (func_38(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), bLocal_37, 0, 0))
											{
												...
												else if (bLocal_37 != 4)
												{
													if (!iLocal_41)
													{
														if (__LIB_0__::func_787(&uLocal_50, "FH1AUD", "FH1_TANNOY", 8, 0, 0, 0))
														{
															iLocal_41 = 1;
														}
													}
