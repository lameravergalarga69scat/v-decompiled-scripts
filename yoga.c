	...
	switch (*iParam0)
	{
		...
		case 1:
			if (!bLocal_168)
			{
				...
				__LIB_35__::func_94(&iLocal_160);
				if ((((STREAMING::HAS_ANIM_DICT_LOADED("mini@yoga") && STREAMING::HAS_MODEL_LOADED(Local_136.f_1)) && STREAMING::HAS_MODEL_LOADED(Local_148.f_1)) && STREAMING::HAS_ANIM_DICT_LOADED("move_p_m_zero_idles@generic")) && __LIB_11__::func_960(&iLocal_160))
				{
					*iParam0++;
				}
			}
		...
		case 2:
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_173))
			{
				...
				{
					__LIB_11__::func_958(&iLocal_160, 1, 0);
				}
				...
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_173) >= 1f)
				{
					if (iLocal_87 == 1)
					{
						...
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(PLAYER::PLAYER_PED_ID()))
						{
							...
							__LIB_30__::func_202(&Local_148, 1);
							*iParam0 = 20;
						}
					}
		...
		case 10:
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_174))
			{
				...
				__LIB_30__::func_202(&Local_136, 1);
				__LIB_30__::func_202(&Local_148, 1);
...
void func_10(int iParam0, int iParam1, float fParam2, float fParam3)//Position - 0xEFF
{
	if (iParam1 == 1)
	{
		switch (iParam0->f_7)
		{
			...
			case 6:
			case 7:
				__LIB_11__::func_892(&(iParam0->f_50), iParam0->f_51, 0.0001f, 1);
				GRAPHICS::SET_TIMECYCLE_MODIFIER_STRENGTH(iParam0->f_50);
				break;
		}
	}
	...
	{
		__LIB_11__::func_892(&(iParam0->f_50), fParam2, fParam3, 1);
		GRAPHICS::SET_TIMECYCLE_MODIFIER_STRENGTH(iParam0->f_50);
	}
}
		...
		if (!Global_100362[iVar0])
		{
			...
			if (iVar0 == 0)
			{
				if (!__LIB_0__::func_365(49))
				{
					...
					func_133(__LIB_6__::func_757(0), 12, 16, 0, 0, 0, 0);
				}
				if (!__LIB_0__::func_365(44))
				{
					...
					func_133(__LIB_6__::func_757(0), 3, 70, 1, 0, 0, 0);
					func_133(__LIB_6__::func_757(0), 3, 71, 1, 0, 0, 0);
					func_133(__LIB_6__::func_757(0), 3, 72, 1, 0, 0, 0);
					func_133(__LIB_6__::func_757(0), 3, 73, 1, 0, 0, 0);
					func_133(__LIB_6__::func_757(0), 3, 74, 1, 0, 0, 0);
					func_133(__LIB_6__::func_757(0), 3, 75, 1, 0, 0, 0);
					func_133(__LIB_6__::func_757(0), 4, 41, 1, 0, 0, 0);
					func_133(__LIB_6__::func_757(0), 4, 42, 1, 0, 0, 0);
					func_133(__LIB_6__::func_757(0), 4, 43, 1, 0, 0, 0);
					func_133(__LIB_6__::func_757(0), 4, 44, 1, 0, 0, 0);
					func_133(__LIB_6__::func_757(0), 4, 45, 1, 0, 0, 0);
				}
			}
			else if (iVar0 == 2)
			{
...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, bool bParam12, bool bParam13)//Position - 0x1FC94
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_78130[1 /*14*/] = { __LIB_35__::func_544(iVar5, iVar0, func_272(iParam0, iVar0, -1), -1) };
				if (BitTest(Global_78130[1 /*14*/].f_6, 3))
				{
	...
	else
	{
		...
		else if (iParam1 == 8)
		{
			...
			if (iParam5 == 0)
			{
				iVar6 = func_257(iVar5, iParam2, __LIB_6__::func_795(iParam0, 11), __LIB_6__::func_795(iParam0, 4));
			}
		}
		else if (iParam1 == 9)
		{
		...
		else if (iParam1 == 4)
		{
			...
			if (iParam5 == 0)
			{
				iVar6 = func_257(iVar5, __LIB_6__::func_795(iParam0, 8), __LIB_6__::func_795(iParam0, 11), iParam2);
			}
				...
				while (iVar2 < 15)
				{
					...
					if (iVar3 != -99)
					{
						...
						else if (iVar2 == 8)
						{
							if (iVar6 != -99)
							{
								iVar6 = func_257(iVar5, iVar3, __LIB_6__::func_795(iParam0, 11), __LIB_6__::func_795(iParam0, 4));
							}
						}
					}
					iVar2++;
	...
	if (iVar10 != -1)
	{
		iVar84 = __LIB_0__::func_254(iVar5, func_272(iParam0, 3, -1), iVar10);
		if (iVar84 != -1)
		{
			if (iVar5 == joaat("MP_M_Freemode_01"))
			{
			...
			switch (iVar0)
			{
				...
				case 1:
					switch (iVar1)
					{
						...
						case 7:
						case 12:
							iVar2 = __LIB_18__::func_431(joaat("MP_M_Freemode_01"), 11, func_272(iParam0, 11, -1), 0);
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar7 = __LIB_18__::func_431(joaat("MP_F_Freemode_01"), 11, func_272(iParam0, 11, -1), 0);
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar10 = __LIB_18__::func_431(joaat("MP_F_Freemode_01"), 11, func_272(iParam0, 11, -1), 0);
				...
				case 1:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar11 = __LIB_18__::func_431(joaat("MP_F_Freemode_01"), 11, func_272(iParam0, 11, -1), 0);
	...
	switch (iParam0)
	{
		case joaat("MP_M_Freemode_01"):
			...
			else if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar2, joaat("BIKER_VEST"), 0) && !FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar2, joaat("JACKET_ONLY"), 0))
			{
				...
				{
					iVar0 = func_257(iParam0, -99, __LIB_6__::func_807(iParam0, iParam1, 0), iParam3);
					if (iVar0 == -99)
					{
						iVar0 = 0;
					}
...
int func_263(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x46F94
{
	...
	*iParam1 = 0;
	...
	if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iParam3, joaat("HAZ_MASK"), 0) && !__LIB_0__::func_709(iVar0, 14, func_272(iParam0, 14, 0), -1))
	{
		return 1;
	}
	else
	...
	*uParam0 = PLAYER::PLAYER_PED_ID();
	...
	switch (uParam0->f_7)
	{
		...
		case 2:
			...
			uParam0->f_52 = 0;
			uParam0->f_51 = 0f;
			uParam0->f_54 = __LIB_0__::func_301((uParam0->f_54 - 0.08f), 0f, 0.5f);
			uParam0->f_53 = 0;
			func_337(&iLocal_55);
			if (MISC::IS_PC_VERSION())
			{
			...
			break;
		case 3:
			if (__LIB_11__::func_307(1000, uParam0->f_19))
			{
				uParam0->f_12 = 0;
			}
			if (iParam7 == 1)
				...
				if (__LIB_11__::func_307(1000, uParam0->f_19))
				{
					if (uParam0->f_53 == 0)
					{
						if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(*uParam0))
						{
							...
							{
								case 0:
									__LIB_6__::func_834(*uParam0, "GENERIC_CURSE_MED", 6);
									break;
							}
							uParam0->f_53 = 1;
						}
			...
			if (__LIB_11__::func_307(2500, uParam0->f_19))
			{
				uParam0->f_19 = MISC::GET_GAME_TIMER();
				uParam0->f_7 = 4;
			}
		...
		case 4:
			...
			if (func_365())
			{
				...
				else if (__LIB_11__::func_307(3000, uParam0->f_19))
				{
					if (!PED::IS_PED_INJURED(*uParam0))
					{
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(*uParam0);
						__LIB_31__::func_868(uParam0, 1);
						uParam0->f_19 = MISC::GET_GAME_TIMER();
						uParam0->f_7 = 5;
					}
				}
		...
		case 6:
			if (AUDIO::HAS_SOUND_FINISHED(uParam0->f_25))
			{
				...
				__LIB_26__::func_515(__LIB_18__::func_168(*uParam0), 1, iParam5);
				__LIB_26__::func_515(__LIB_18__::func_168(*uParam0), 2, iParam5);
				__LIB_26__::func_515(__LIB_18__::func_168(*uParam0), 3, iParam5);
...
void func_340(var uParam0, int iParam1)//Position - 0x6431A
{
	...
	if (iLocal_53 == 1)
	{
		if (iLocal_54 == 0)
		{
			__LIB_31__::func_864(&iLocal_55);
			if (MISC::IS_PC_VERSION())
			{
				__LIB_31__::func_864(&iLocal_56);
			}
			iLocal_54 = 1;
		}
		if (uParam0->f_9 == 2)
		{
			...
			{
				__LIB_31__::func_863(uParam0, &iLocal_56, iVar0, iVar1, iVar2);
			}
			else
			{
				__LIB_31__::func_863(uParam0, &iLocal_55, iVar0, iVar1, iVar2);
			}
		}
	}
	else
...
int func_346(var uParam0, int iParam1, int iParam2, int iParam3, float fParam4, int iParam5, int iParam6)//Position - 0x64975
{
	...
	switch (uParam0->f_9)
	{
		case 0:
			...
			{
				uParam0->f_19 = MISC::GET_GAME_TIMER();
				func_355(uParam0, Local_38[iParam1 /*16*/][uParam0->f_16 * 2], Local_38[iParam1 /*16*/][uParam0->f_16 * 2 + 1]);
				uParam0->f_49 = 1;
				uParam0->f_52 = 1;
				uParam0->f_9 = 1;
			}
					...
					case 1:
						...
						if (uParam0->f_43 == 1)
						{
							...
							if (uParam0->f_16 == iLocal_33[iParam1])
							{
								...
								{
									func_355(uParam0, Local_38[iParam1 /*16*/][(iLocal_34[iParam1] - 1)], "START_POSE");
									uParam0->f_49 = 1;
									uParam0->f_9 = 4;
								}
							}
		...
		case 3:
			...
			uParam0->f_31 = 1;
			uParam0->f_32 = 1;
			__LIB_35__::func_524(Local_39[iParam1 /*22*/][(uParam0->f_16 - 1) /*3*/][0], Local_39[iParam1 /*22*/][uParam0->f_16 /*3*/][0], Local_40[iParam1 /*22*/][uParam0->f_16 /*3*/][0], &(uParam0->f_27), 4);
			__LIB_35__::func_524(Local_39[iParam1 /*22*/][(uParam0->f_16 - 1) /*3*/][1], Local_39[iParam1 /*22*/][uParam0->f_16 /*3*/][1], Local_40[iParam1 /*22*/][uParam0->f_16 /*3*/][1], &(uParam0->f_28), 4);
...
void func_355(var uParam0, char* sParam1, char* sParam2)//Position - 0x6554A
{
	int iVar0;
	if (!PED::IS_PED_INJURED(*uParam0))
	{
...
int func_356(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x655C8
{
	...
	fLocal_59 = __LIB_31__::func_867(fLocal_59, 100f);
		...
		case 4:
			if (CAM::DOES_CAM_EXIST(iLocal_58))
			{
				if (CAM::IS_CAM_RENDERING(iLocal_58) || CAM::IS_CAM_INTERPOLATING(iLocal_58))
				{
					...
					else if (__LIB_11__::func_307(iLocal_48[uParam0->f_17], uParam0->f_56))
					{
						CAM::DESTROY_CAM(iLocal_58, false);
					}
				}
...
int func_371(int iParam0)//Position - 0x683A5
{
	switch (*iParam0)
	{
		case 0:
			...
			STREAMING::REQUEST_MODEL(Local_148.f_1);
			__LIB_35__::func_94(&iLocal_160);
			if (((STREAMING::HAS_ANIM_DICT_LOADED("mini@yoga") && STREAMING::HAS_MODEL_LOADED(Local_136.f_1)) && STREAMING::HAS_MODEL_LOADED(Local_148.f_1)) && __LIB_11__::func_960(&iLocal_160))
			{
				*iParam0++;
			}
			break;
		case 1:
			...
			{
				__LIB_32__::func_742(Local_152.f_4, Local_152.f_7, Local_152.f_10, Local_152, Local_152.f_3, 0, 0, 1, 0, 0);
		...
		case 3:
			if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_172))
			{
				if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_172) >= 1f)
				{
					...
					__LIB_23__::func_169(PLAYER::PLAYER_PED_ID(), Local_89, Local_89.f_3, 0, 0, 0);
...
int func_385(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)//Position - 0x693BD
{
	...
	if (*iParam1 == 2)
	{
		...
		{
			__LIB_23__::func_169(PLAYER::PLAYER_PED_ID(), Local_89, Local_89.f_3, 0, 1, 0);
		}
		*iParam1++;
	}
	if (*iParam1 == 3)
...
void func_389(int iParam0)//Position - 0x6968C
{
	...
	if (__LIB_0__::func_394(Var0, -790.906f, 186.293f, 71.835f, 15f, 0))
	{
		iLocal_88 = 0;
	...
	else if (__LIB_0__::func_394(Var0, 2862.15f, 5945.49f, 357.11f, 15f, 0))
	{
		iLocal_88 = 1;
...
void func_398()//Position - 0x6AC8F
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_893))
	{
		if (iLocal_894)
		{
			__LIB_6__::func_498(&uLocal_184);
			__LIB_2__::func_33(PAD::GET_CONTROL_INSTRUCTIONAL_BUTTONS_STRING(2 /*FRONTEND_CONTROL*/, 51 /*INPUT_CONTEXT*/, true), "H_YOGA_QUIT", &uLocal_184, 0);
		}
		__LIB_6__::func_918(&iLocal_893, &uLocal_884, &uLocal_184, __LIB_1__::func_57(&uLocal_184));
	}
	else
	{
			...
			if ((*uParam0 == 2 || *uParam0 == 3) || *uParam0 == 4)
			{
				if (iLocal_895[1] == 1)
				{
					if (Local_90.f_14 == 3)
					{
						if (Local_90.f_7 == 4)
						{
							if (__LIB_31__::func_860(Local_90.f_0, 2))
							{
								func_384();
								*uParam1 = 1;
								*uParam0 = 6;
...
void func_412()//Position - 0x6B31F
{
	...
	__LIB_30__::func_202(&Local_136, 1);
	__LIB_30__::func_202(&Local_133, 1);
	__LIB_30__::func_202(&Local_139, 1);
	__LIB_30__::func_202(&Local_142, 1);
	__LIB_30__::func_202(&Local_145, 1);
	__LIB_30__::func_202(&Local_148, 1);
