...
void __EntryFunction__()//Position - 0x0
{
	...
	if (!__LIB_0__::func_323())
	{
		if ((__LIB_0__::func_692(Local_80.f_28[0]) && __LIB_0__::func_692(PLAYER::PLAYER_PED_ID())) && !__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 4f, 1))
		{
			iLocal_305 = 1;
		}
	}
	while (true)
	{
		...
		__LIB_14__::func_863(Local_80.f_9, 0, 0, 0, 0, 0);
		...
		{
			if (__LIB_0__::func_692(PLAYER::PLAYER_PED_ID()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1668.8821f, -19.652481f, 172.67476f, 1653.8553f, 8.008027f, 175.02478f, 7f, false, true, 0))
			{
				if (__LIB_0__::func_692(Local_91.f_0))
				{
					if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), Local_91.f_0, 10f, 1))
					{
						func_300();
					}
				}
...
void func_1()//Position - 0x20C
{
	switch (iLocal_83)
	{
		case 0:
			...
			{
				__LIB_14__::func_880(sLocal_92, 1);
			}
			iLocal_83 = 1;
			break;
		case 1:
	...
	switch (iLocal_85)
	{
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_102))
			{
				...
				{
					if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), iLocal_102, 1f, 1))
					{
		...
		case 2:
			...
			{
				if (__LIB_2__::func_859(&uLocal_106, "EXT4AUD", "EXT4_WIL2", 8, 0, 0, 0))
				{
					func_9();
				}
			}
...
void func_232()//Position - 0x2733B
{
	...
	__LIB_0__::func_222(&uLocal_106, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	__LIB_2__::func_859(&uLocal_106, "EXT4AUD", "EXT4_DUMB", 7, 0, 0, 0);
}
				...
				if (func_263(1, 20f, 1))
				{
					if ((!iLocal_305 || MISC::GET_GAME_TIMER() > iLocal_306 + 3000) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, false, true, 0))
					{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							...
							__LIB_14__::func_592(1654.7211f, 4.166876f, 172.5245f, 1662.5616f, -8.920052f, 178.27415f, 6.25f, Local_272, fLocal_273, 1, 1, 1, 0, 0);
						}
						else
						{
							Local_272 = { 1649.793f, 11.7826f, 172.7745f };
...
int func_263(int iParam0, float fParam1, int iParam2)//Position - 0x28EBC
{
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		if ((!PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_IN_ANY_BOAT(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				iVar0 = 0;
				if (!__LIB_6__::func_572(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
				{
...
void func_270()//Position - 0x2920C
{
	...
	{
		case 0:
			if (__LIB_0__::func_692(Local_80.f_28[0]))
			{
				PED::SET_PED_COMBAT_ATTRIBUTES(Local_80.f_28[0], 17, true);
			}
			iLocal_290 = 0;
			iLocal_305 = 1;
			__LIB_0__::func_229("EXT4_01", 7500, 1);
			iLocal_94 = __LIB_14__::func_661(Local_91.f_0, 1, 1, 5);
			SYSTEM::SETTIMERA(0);
			iLocal_85 = 1;
			break;
		case 1:
			...
			if (__LIB_0__::func_692(PLAYER::PLAYER_PED_ID()))
			{
				if (__LIB_0__::func_692(Local_91.f_0))
				{
					if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), Local_91.f_0, 100f, 1))
					{
						CUTSCENE::REQUEST_CUTSCENE_WITH_PLAYBACK_LIST("es_4_rcm_p2_concat", 6, 8);
						if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
						{
					...
					if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), Local_91.f_0, 32f, 1))
					{
						if (__LIB_14__::func_858(Local_91.f_0, 1, 0, 0, 0))
						{
							if (iLocal_93 == 0)
							{
								if (!__LIB_0__::func_75())
								{
									__LIB_14__::func_535(&uLocal_106, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_1", 7, 0, 0);
									iLocal_93 = 1;
								}
							}
							else if (iLocal_93 == 1)
							{
								if (!__LIB_0__::func_75())
								{
									__LIB_14__::func_535(&uLocal_106, "EXT4AUD", "EXT4_ATTACK", "EXT4_ATTACK_2", 7, 0, 0);
									iLocal_93 = 2;
								}
							}
						}
						else
						{
							if (!iLocal_300)
							{
								if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), Local_91.f_0, 30f, 1) && !__LIB_0__::func_75())
								{
									if (__LIB_2__::func_859(&uLocal_106, "EXT4AUD", "EXT4_COMM", 7, 0, 0, 0))
									{
										iLocal_300 = 1;
									}
								}
	...
	if (!__LIB_0__::func_75())
	{
		if (iLocal_290 < 5)
		{
			if (MISC::GET_GAME_TIMER() > (iLocal_291 + (8000 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))))
			{
				...
				{
					if (__LIB_2__::func_859(&uLocal_106, "EXT4AUD", "EXT4_DOM", 6, 0, 0, 0))
					{
...
{
	if (__LIB_0__::func_323() == 0)
	{
		func_294();
	}
	else
	{
		__LIB_0__::func_427(1732.1328f, 91.9424f, 169.7872f, 128.6917f, 1, 0);
	...
	if (iLocal_88 == 1)
	{
		__LIB_14__::func_800(&Local_80, 0, 1);
		func_284();
	}
}
...
void func_284()//Position - 0x29B44
{
	...
	{
		__LIB_14__::func_659(Local_80.f_28[0], 1737.4534f, 101.7498f, 170.0243f, 288.5211f, 0, 1);
	}
	else
	{
	...
	if (__LIB_0__::func_692(Local_91.f_0))
	{
		...
		__LIB_0__::func_222(&uLocal_106, 4, Local_91.f_0, "DOM", 0, 1);
...
void func_294()//Position - 0x2A1C8
{
	switch (iLocal_86)
	{
		case 0:
			func_299();
			iLocal_87 = 0;
			__LIB_14__::func_851("es_4_rcm_p1", 0);
			if (__LIB_14__::func_740(1, 1093140480, 0))
			{
				if (!iLocal_305 || MISC::GET_GAME_TIMER() > iLocal_306 + 3500)
				{
					...
					SYSTEM::WAIT(0);
					CAM::STOP_GAMEPLAY_HINT(false);
					__LIB_14__::func_592(1729.9216f, 89.4162f, 174.01227f, 1739.7454f, 101.28158f, 167.82816f, 7f, 1739.9564f, 97.8651f, 169.9797f, 140.876f, 1, 1, 1, 0, 0);
					__LIB_14__::func_592(1743.1155f, 105.83296f, 169.63617f, 1732.0288f, 93.77112f, 172.60745f, 4f, 1739.9564f, 97.8651f, 169.9797f, 140.876f, 1, 1, 1, 0, 0);
		...
		case 1:
			...
			break;
		case 2:
			__LIB_14__::func_659(PLAYER::PLAYER_PED_ID(), 1732.2219f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			PED::FORCE_PED_MOTION_STATE(PLAYER::PLAYER_PED_ID(), joaat("MotionState_Walk"), false, 1, false);
			PED::SET_PED_MIN_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID(), 1f);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(PLAYER::PLAYER_PED_ID(), 1723.4518f, 80.729f, 169.6701f, 1f, -1, 1f, 2113, 40000f);
			CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
...
void func_299()//Position - 0x2A4AB
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!__LIB_0__::func_323() && __LIB_0__::func_692(Local_80.f_28[0])) && __LIB_0__::func_692(PLAYER::PLAYER_PED_ID())) && iLocal_305 == 1)
	{
		...
		{
			if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 4f, 1))
			{
...
void func_321()//Position - 0x2B1F2
{
	...
	Local_91.f_5 = __LIB_2__::func_910(52);
	...
	{
		__LIB_14__::func_842(&Local_91, 52, Local_91.f_1, Local_91.f_4, "Ext4-Dom", 1);
...
void func_339(int iParam0)//Position - 0x2BA47
{
	...
	__LIB_14__::func_871(&Local_80, 1, 0, 0);
