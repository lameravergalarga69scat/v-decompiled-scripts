...
void func_419()//Position - 0x330C6
{
	switch (iLocal_58)
	{
		...
		case 3:
			...
			{
				__LIB_17__::func_121(&uLocal_324);
				__LIB_0__::func_638();
			}
			break;
		case 4:
...
int func_438(int* iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4)//Position - 0x33A73
{
	...
	__LIB_17__::func_25(iParam0, iLocal_41, Param1, fParam2);
	...
	if (iLocal_318 && iLocal_55 != 14)
	{
		switch (iLocal_316)
		{
			...
			case 1:
				...
				{
					if (__LIB_17__::func_126(iLocal_69, 1, 1116471296, 1126825984, 0, 0, 0, 0) || __LIB_17__::func_126(iLocal_70, 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
					...
					else if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(iLocal_69, Local_63.f_0))
					{
						if (__LIB_0__::func_75())
						{
							if (__LIB_38__::func_301() == 3 || __LIB_38__::func_301() == 4)
							{
								__LIB_0__::func_429();
							}
							else
