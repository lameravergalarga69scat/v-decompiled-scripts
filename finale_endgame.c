...
void __EntryFunction__()//Position - 0x0
{
	...
	if (__LIB_17__::func_65(2))
	{
		if (__LIB_17__::func_65(0))
		{
			__LIB_17__::func_696(Global_98880[74 /*3*/], -1082130432, 350, 1114636288, 0);
			func_433(74, 64);
		...
		else
		{
			...
			__LIB_17__::func_696(Global_98880[267 /*3*/], -1082130432, 350, 1114636288, 0);
			func_433(267, 64);
			func_419(&(Global_113386.f_2363.f_539), 1, 73);
		}
	}
	else
	{
		...
		__LIB_17__::func_696(Global_98880[83 /*3*/], -1082130432, 350, 1114636288, 0);
		func_433(83, 64);
		func_419(&(Global_113386.f_2363.f_539), 1, 73);
	}
	iVar0 = 0;
...
int func_435(var uParam0, int iParam1, int iParam2, var uParam3)//Position - 0x74348
{
	...
	if (*uParam0 == 1)
	{
		...
		if (func_609(uParam0->f_2, &(uParam0->f_4), &(uParam0->f_7), &(uParam0->f_8)))
		{
			...
			{
				if ((func_588(uParam0->f_2, &sVar9, &cVar10) || __LIB_17__::func_691(uParam0->f_2, &sVar11, &uVar12, &uVar13, &uVar14, &uVar15, &uVar16, &uVar17)) || __LIB_17__::func_690(uParam0->f_2, &sVar18))
				{
...
void func_637(int iParam0)//Position - 0x93B6F
{
	...
	while (iVar1 < Global_113386.f_7688.f_136)
	{
		...
		{
			__LIB_17__::func_379(Global_113386.f_7688[iVar1 /*15*/]);
			iVar1 = 0;
		}
		else
		{
	...
	while (iVar1 < Global_113386.f_7688.f_650)
	{
		...
		{
			__LIB_17__::func_379(Global_113386.f_7688.f_199[iVar1 /*15*/]);
			iVar1 = 0;
		}
		else
		{
	...
	while (iVar1 < Global_113386.f_7688.f_764)
	{
		...
		{
			__LIB_17__::func_379(Global_113386.f_7688.f_651[iVar1 /*14*/]);
			iVar1 = 0;
		}
		else
		{
	...
	while (iVar1 < Global_113386.f_7688.f_866)
	{
		...
		{
			__LIB_17__::func_379(Global_113386.f_7688.f_765[iVar1 /*10*/]);
			iVar1 = 0;
		}
		else
		{
...
void func_655(int iParam0)//Position - 0x944BC
{
	int iVar0;
	iVar0 = iParam0;
	if (Global_113386.f_9085_FLOW_STRUCT_isGameflowActive.f_330_MF_MISSION_ARRAY[iVar0 /*6*/] == 0)
	{
		__LIB_17__::func_910(iVar0, joaat("CITIES_PASSED"), 1);
	}
}
...
int func_661()//Position - 0x94914
{
	...
	switch (iLocal_71)
	{
		case 0:
			...
			__LIB_38__::func_614(&iLocal_91, 0, 0, 1, 1);
			__LIB_17__::func_697(&iLocal_91, "CONTINUE", 2, 201, 1, 1, 0);
			__LIB_38__::func_611(&iLocal_91, 1);
			__LIB_39__::func_366(&iLocal_91, 1);
		...
		case 1:
			GRAPHICS::SET_SCRIPT_GFX_DRAW_ORDER(1);
			GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_72, 255, 255, 255, 255, 0);
			__LIB_16__::func_970(&iLocal_91, 1128792064, 1, 0, 1, 1065353216);
...
struct<4> func_692(var uParam0)//Position - 0x95927
{
	...
	else if ((Global_113386.f_9085_FLOW_STRUCT_isGameflowActive.f_330_MF_MISSION_ARRAY[50 /*6*/] == 1 && Global_113386.f_9085_FLOW_STRUCT_isGameflowActive.f_330_MF_MISSION_ARRAY[51 /*6*/] == 1) && Global_113386.f_9085_FLOW_STRUCT_isGameflowActive.f_330_MF_MISSION_ARRAY[52 /*6*/] == 1)
	{
		StringCopy(&(uParam0->f_7), "Y", 4);
		StringConCat(&Var0, "Y", 16);
	}
