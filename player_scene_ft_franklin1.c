...
void __EntryFunction__()//Position - 0x0
{
	...
	func_56();
	__LIB_17__::func_501();
	while (iLocal_235 && __LIB_39__::func_36(6, 0))
	{
		SYSTEM::WAIT(0);
		switch (iLocal_68)
		{
...
int func_3()//Position - 0x1BE
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_238[0], false))
	{
		if (!PED::IS_PED_INJURED(iLocal_236[0]))
		{
			...
			__LIB_33__::func_604(iLocal_69, &sVar2, &cVar3, &cVar4, &uVar5, &uVar6);
...
int func_6()//Position - 0x1AC5
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_238[0], false))
	{
		if (!PED::IS_PED_INJURED(iLocal_236[0]))
		{
			...
			{
				if (!__LIB_16__::func_786(9))
				{
					if (__LIB_37__::func_632(iLocal_236[0], 135f))
					{
					}
				}
			}
...
void func_56()//Position - 0x2DE6
{
	...
	while (iVar0 < 1)
	{
		if (iLocal_239[iVar0] != joaat("freight"))
		{
			...
			{
				__LIB_17__::func_806(&(iLocal_238[iVar0]), 0, Local_244 + Local_240[iVar0 /*3*/], (fLocal_245 + fLocal_241[iVar0]), 1, 1);
			}
		}
		else
		{
