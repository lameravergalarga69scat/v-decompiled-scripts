...
int func_30(int iParam0)//Position - 0x105A
{
	switch (iParam0)
	{
		...
		case 36:
			...
			break;
		case 37:
			return __LIB_0__.func_137(27, -1);
		case 38:
...
int func_39(int iParam0)//Position - 0x153C
{
	...
	switch (iParam0)
	{
		...
		case 5:
			if ((((__LIB_0__.func_109() || __LIB_0__.func_109()) || MISC::IS_PC_VERSION()) || __LIB_0__.func_52()) || __LIB_0__.func_53())
			{
				iVar0 += 2;
				iVar0 += 2;
				iVar0++;
			...
			break;
		case 6:
			if ((NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT() || __LIB_0__.func_109()) || __LIB_0__.func_109())
			{
				iVar0 = 0;
				iVar0 += 19;
				iVar0 += 8;
