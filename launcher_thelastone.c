...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		__LIB_37__::func_342(&Var0, Var1, "SAS1AUD", "SAS1_AMB", 4, "HUNTER" /* GXT: FH-1 Hunter */, 10000);
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			else if (*iParam0 == -1)
			{
				...
				{
					__LIB_37__::func_242(iParam0, 1);
				}
			}
			else
			{
				if (__LIB_37__::func_231(*iParam0) == 2)
				{
					CUTSCENE::STOP_CUTSCENE(false);
					CUTSCENE::REMOVE_CUTSCENE();
					__LIB_36__::func_981(*iParam0, 0);
				}
				else
				{
