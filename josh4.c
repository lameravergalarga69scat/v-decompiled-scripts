...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_38 = __LIB_2__.func_108(58);
	...
	__LIB_11__.func_797("*** Now in Josh 4 loop ***");
	Local_386 = { ScriptParam_418 };
	__LIB_20__.func_264(&Local_386);
	...
	{
		__LIB_11__.func_797("*** Setting up initial scene for replay");
		__LIB_0__.func_370(Local_53, fLocal_54, 1, 0);
		__LIB_11__.func_797("*** Replay setup started");
		Global_78564 = 1;
		iLocal_37 = 0;
		...
		__LIB_11__.func_797("*** Josh 4 scene set up");
		__LIB_10__.func_700(&Local_386, 0, 1);
		Global_78564 = 0;
	}
	...
	__LIB_11__.func_797("*** About to set up positions...");
	func_452();
	__LIB_24__.func_951(58, 2, 0);
	if (__LIB_0__.func_294())
	{
		__LIB_11__.func_797("*** Creating replay vehicle and jumping to post-cutscene");
		__LIB_41__.func_639(&iLocal_44, -1100.04f, 280.6f, 63.53f, 267.48f, 0, 0, 1, 1, 0, joaat("asterope"), 0, 145, 1);
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		__LIB_35__.func_898(Local_386.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_45)
		{
			case 0:
				func_302();
...
void func_1()//Position - 0x233
{
	...
	switch (iLocal_46)
	{
		case 0:
			...
			__LIB_0__.func_210("JOSH4_LOSECOPS", 7500, 1);
...
void func_2()//Position - 0x3D9
{
	if (__LIB_0__.func_121(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			__LIB_11__.func_797("Starting 'JOSH4_COPS_LOST_RADIO'");
		}
		else
		{
			AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_COPS_LOST");
			__LIB_11__.func_797("Starting 'JOSH4_COPS_LOST'");
		}
	}
	else
	{
		AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_COPS_LOST");
		__LIB_11__.func_797("Player is somehow not alive when passing the mission - starting 'JOSH4_COPS_LOST'");
	}
	func_3(91, 1);
	func_468();
}
...
void func_210()//Position - 0x26F71
{
	if (iLocal_414 == 0)
	{
		if (__LIB_0__.func_529(PLAYER::PLAYER_PED_ID(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
			AUDIO::PLAY_POLICE_REPORT("SCRIPTED_SCANNER_REPORT_JOSH_4_01", 0f);
			__LIB_11__.func_797("*** Played special Josh 4 police report ***");
			iLocal_414 = 1;
		}
	}
}
...
void func_212()//Position - 0x26FF1
{
	if (iLocal_409 == 0)
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1208.5807f, 309.8494f, 80.691895f, -1041.6449f, 319.5811f, 60.402634f, 178.5f, false, true, 0))
		{
			...
			__LIB_0__.func_203(&uLocal_221, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			__LIB_0__.func_203(&uLocal_221, 4, Local_386.f_28[0], "JOSH", 0, 1);
	...
	else if (iLocal_409 == 1)
	{
		if (iLocal_49 != 0)
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_412) > 6000)
			{
				if (iLocal_49 == 3)
				{
					__LIB_35__.func_536(&uLocal_221, "JOSH4AU", "JOSH4CAR2", 9, 0, 0, 0);
				}
				else if (iLocal_49 == 1)
				{
					if (__LIB_0__.func_121(Local_386.f_28[0]))
					{
						...
						{
							__LIB_35__.func_536(&uLocal_221, "JOSH4AU", "JOSH4CAR3", 9, 0, 0, 0);
						}
						else
						{
							__LIB_35__.func_536(&uLocal_221, "JOSH4AU", "JOSH4CAR1", 9, 0, 0, 0);
						}
					}
				}
				else if (iLocal_49 == 2)
			...
			if (iLocal_48 == 3)
			{
				if (__LIB_0__.func_121(Local_386.f_28[0]))
				{
					...
					if (__LIB_1__.func_183(iLocal_391))
					{
						...
						{
							__LIB_11__.func_797("Back gate clear");
							TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
							if (__LIB_1__.func_183(iLocal_391))
							{
					...
					{
						__LIB_11__.func_797("Josh car not ok - do Josh flee anyway");
						TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_55, 2f, 20000, 1f, 1, 40000f);
						if (__LIB_1__.func_183(iLocal_391))
						{
		...
		case 1:
			if (__LIB_0__.func_121(Local_386.f_28[0]))
			{
				if (!iLocal_406)
				{
					if (iLocal_398[0] || iLocal_398[1])
					{
						if (__LIB_0__.func_76(Local_386.f_28[0], PLAYER::PLAYER_PED_ID(), 0) < 20f)
						{
							...
							{
								__LIB_0__.func_296();
								__LIB_10__.func_617(&uLocal_221, "JOSH4AU", "JOSH4COP3", 9, 0, 0);
							}
							else
							{
								__LIB_35__.func_536(&uLocal_221, "JOSH4AU", "JOSH4COP3", 9, 0, 0, 0);
							}
							__LIB_11__.func_797("Doing Josh comment");
						}
						else
						{
							__LIB_11__.func_797("Too far away to do Josh comment");
						}
						iLocal_406 = 1;
					}
				}
				if (__LIB_1__.func_183(iLocal_391))
				{
					...
					if (PED::IS_PED_BEING_JACKED(Local_386.f_28[0]))
					{
						if (iLocal_407 == 0)
						{
							if (__LIB_35__.func_536(&uLocal_221, "JOSH4AU", "JOSH4BEGS", 9, 0, 0, 0))
							{
								iLocal_407 = 1;
							}
						}
				...
				{
					__LIB_11__.func_797("Deleting Josh, setting as lost");
					__LIB_0__.func_0(&(Local_386.f_28[0]));
					__LIB_11__.func_32(&iLocal_391);
					iLocal_49 = 2;
				}
				if (__LIB_0__.func_121(PLAYER::PLAYER_PED_ID()) && __LIB_0__.func_121(Local_386.f_28[0]))
				{
					if (iLocal_410 < 3)
					{
						if (__LIB_0__.func_76(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 1) < 10f)
						{
							...
							{
								if (__LIB_35__.func_536(&uLocal_221, "JOSH4AU", "JOSH4CHASE", 9, 0, 0, 0))
								{
									iLocal_410++;
									iLocal_413 = MISC::GET_GAME_TIMER();
								}
			...
			else
			{
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_386.f_28[0], PLAYER::PLAYER_PED_ID(), true))
				{
					...
					__LIB_11__.func_797("Player killed Josh!");
					__LIB_0__.func_498(776);
				}
				__LIB_11__.func_797("Josh - DEAD!");
				if (__LIB_0__.func_75())
				{
					__LIB_0__.func_296();
				}
				if (__LIB_35__.func_536(&uLocal_221, "JOSH4AU", "JOSH4KILL", 9, 0, 0, 0))
				{
					iLocal_49 = 3;
				}
			}
	...
	switch (Local_47.f_11)
	{
		case 0:
			...
			while (iLocal_393 <= 4)
			{
				...
				{
					__LIB_11__.func_796("Player detected inside flee direction trigger: ", iLocal_393);
					...
					__LIB_11__.func_796("iFlee value is: ", iLocal_393);
					__LIB_11__.func_797("Requesting flee recording: ");
					__LIB_11__.func_796(Local_47.f_10, Local_47.f_9);
					...
					__LIB_11__.func_797("Flee car has loaded!");
					Local_47.f_11 = 1;
				}
				iLocal_393++;
			}
		...
		case 1:
			if (!ENTITY::DOES_ENTITY_EXIST(Local_47.f_7))
			{
				...
				__LIB_11__.func_797("Flee car created!");
				Local_47.f_11 = 2;
			}
			break;
		case 2:
			if (__LIB_1__.func_183(Local_47.f_7))
			{
				if (__LIB_0__.func_121(Local_47.f_8))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(Local_47.f_8, false))
					{
						...
						__LIB_11__.func_796("*** m_AI_FleeCar.iRecNum: ", Local_47.f_9);
						switch (Local_47.f_9)
						{
							case 0:
						...
						__LIB_11__.func_797("Flee car playing!");
						Local_47.f_11 = 3;
					}
				}
			}
			...
			if (__LIB_1__.func_183(Local_47.f_7))
			{
				if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_47.f_7))
				{
					if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(Local_47.f_9, Local_47.f_10))
					{
						...
						__LIB_11__.func_797("Flee car recording finished!");
						Local_47.f_11 = 4;
					}
				}
				else
		...
		case 4:
			...
			__LIB_11__.func_797("Flee car & ped released!");
			break;
	}
}
...
void func_242()//Position - 0x28437
{
	...
	switch (iLocal_48)
	{
		case 0:
			...
			{
				__LIB_11__.func_797("************************************** TIMEOUT - AIM next frame");
				iLocal_48 = 1;
				iLocal_394 = MISC::GET_GAME_TIMER();
			}
			iVar0 = 1;
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (__LIB_0__.func_121(Local_386.f_28[iVar0]))
				{
					...
					{
						__LIB_11__.func_797("************************************** TOO FAR - AIM next frame");
						iLocal_48 = 1;
						iLocal_394 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 2:
			...
			{
				__LIB_11__.func_797("************************************** TIMEOUT - ARREST next frame");
				if (__LIB_0__.func_121(Local_386.f_28[1]))
				{
			...
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (__LIB_0__.func_121(Local_386.f_28[iVar0]))
				{
					...
					{
						__LIB_11__.func_797("************************************** TOO FAR - ATTACK next frame");
						iLocal_48 = 3;
						iLocal_394 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 4:
			...
			while (iVar0 <= (Local_386.f_28 - 1))
			{
				if (__LIB_0__.func_121(Local_386.f_28[iVar0]))
				{
					...
					else if (__LIB_38__.func_135(Local_386.f_28[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
						__LIB_11__.func_797("************************************** THREAT DURING ARREST - ATTACK next frame");
						iLocal_48 = 3;
						iLocal_394 = MISC::GET_GAME_TIMER();
					}
				}
		...
		case 3:
			...
			if (!iLocal_399)
			{
				...
				__LIB_0__.func_203(&uLocal_56, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				__LIB_0__.func_203(&uLocal_56, 3, Local_386.f_28[1], "JOSHCOP", 0, 1);
				if (__LIB_0__.func_75())
				{
					__LIB_0__.func_296();
					__LIB_10__.func_617(&uLocal_56, "JOSH4AU", "JOSH4COP2", 7, 0, 0);
				}
				else
				{
					__LIB_35__.func_536(&uLocal_56, "JOSH4AU", "JOSH4COP2", 7, 0, 0, 0);
				}
				__LIB_11__.func_797("Doing cop fire warning");
				iLocal_399 = 1;
	...
	if (iLocal_48 != 3)
	{
		if (__LIB_0__.func_121(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				__LIB_11__.func_797("************************************** VEHICLE - ATTACK now");
				iLocal_48 = 3;
			}
		}
		iVar0 = 1;
		while (iVar0 <= (Local_386.f_28 - 1))
		{
			if (__LIB_0__.func_121(Local_386.f_28[iVar0]))
			{
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_386.f_28[iVar0]))
				{
					...
					{
						__LIB_11__.func_797("************************************** AIMED WEAPON - ATTACK now");
						iLocal_48 = 3;
					}
				}
				if (__LIB_38__.func_135(Local_386.f_28[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					__LIB_11__.func_797("************************************** ATTACKED/THREATENED - ATTACK now");
					iLocal_48 = 3;
				}
				if (iLocal_48 != 4)
				{
					...
					{
						__LIB_11__.func_797("************************************** TOO CLOSE - ATTACK now");
						iLocal_48 = 3;
					}
				}
			}
...
void func_262()//Position - 0x292AF
{
	if (!iLocal_395)
	{
		__LIB_0__.func_203(&uLocal_56, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		__LIB_0__.func_203(&uLocal_56, 3, Local_386.f_28[1], "JOSHCOP", 0, 1);
		__LIB_35__.func_536(&uLocal_56, "JOSH4AU", "JOSH4GIVEUP", 8, 1, 0, 0);
		iLocal_395 = 1;
	}
	else
	{
			...
			case 1:
				if (!__LIB_0__.func_75() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					if (iLocal_51)
					{
						__LIB_0__.func_203(&uLocal_56, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
						__LIB_0__.func_203(&uLocal_56, 3, Local_386.f_28[1], "JOSHCOP", 0, 1);
						if (__LIB_35__.func_536(&uLocal_56, "JOSH4AU", "JOSH4COP1", 8, 0, 0, 0))
						{
							iLocal_50 = 2;
							iLocal_51 = 0;
						}
					...
					else
					{
						__LIB_0__.func_203(&uLocal_221, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
						__LIB_0__.func_203(&uLocal_221, 4, Local_386.f_28[0], "JOSH", 0, 1);
						if (__LIB_35__.func_536(&uLocal_221, "JOSH4AU", "JOSH4JOSH", 6, 0, 0, 0))
						{
							iLocal_50 = 2;
							iLocal_51 = 1;
						}
...
void func_264()//Position - 0x29404
{
	if (iLocal_45 == 1)
	{
		if (CUTSCENE::IS_CUTSCENE_PLAYING())
		{
			if (CUTSCENE::GET_CUTSCENE_TIME() > 14000 && !iLocal_403)
			{
				...
				__LIB_11__.func_797("Starting 'JOSH4_START'");
				iLocal_403 = 1;
			}
		}
	}
	else if (!iLocal_404)
	{
		...
		__LIB_11__.func_797("Starting 'JOSH4_ACTION'");
		iLocal_404 = 1;
	}
	else if (!iLocal_405)
	{
		if (__LIB_0__.func_121(PLAYER::PLAYER_PED_ID()))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				__LIB_11__.func_797("Starting 'JOSH4_VEHICLE'");
				iLocal_405 = 1;
			}
		}
	}
...
void func_265()//Position - 0x29497
{
	...
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (__LIB_0__.func_121(Local_386.f_28[1]))
		{
			__LIB_11__.func_797("Trying to set Cop 1 component variation (intro loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_standing_idle", Local_386.f_28[1], 0);
		}
		if (__LIB_0__.func_121(Local_386.f_28[2]))
		{
			__LIB_11__.func_797("Trying to set Cop 2 component variation (intro loop)");
	...
	switch (iLocal_46)
	{
		case 0:
			if (!MISC::ARE_STRINGS_EQUAL(sLocal_41, ""))
			{
				if (iLocal_400 == 0)
				{
					__LIB_26__.func_478(sLocal_41, 0);
				}
				iLocal_408 = 0;
				iLocal_46 = 1;
			}
			...
			switch (iLocal_408)
			{
				case 0:
					if (__LIB_18__.func_170(1, 1093140480, 0))
					{
						...
						if (__LIB_1__.func_183(iVar0))
						{
							if (VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(iVar0)))
							{
								__LIB_32__.func_755(-1115.9844f, 285.59244f, 61.942406f, -1097.5992f, 285.1346f, 66.346695f, 33f, Var1, fVar2, 50f, 50f, 50f, 1, 1, 1, 0, 0);
							}
							else
							{
								__LIB_32__.func_755(-1115.9844f, 285.59244f, 61.942406f, -1097.5992f, 285.1346f, 66.346695f, 33f, Var1, fVar2, __LIB_9__.func_996(), 1, 1, 1, 0, 0);
							}
						}
						else
						{
				...
				case 3:
					...
					if (CUTSCENE::WAS_CUTSCENE_SKIPPED())
					{
						...
						{
							AUDIO::TRIGGER_MUSIC_EVENT("JOSH4_START");
							__LIB_11__.func_797("Starting 'JOSH4_START' via cutscene skip");
							iLocal_403 = 1;
						}
					}
					break;
...
void func_276()//Position - 0x29C1D
{
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Josh", 0))
	{
		if (__LIB_0__.func_121(Local_386.f_28[0]))
		{
			__LIB_11__.func_797("Playing Josh's leadout");
			TASK::OPEN_SEQUENCE_TASK(&iLocal_389);
	...
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Security_guard_pistol", 0))
	{
		if (__LIB_0__.func_121(iLocal_387) && __LIB_0__.func_121(Local_386.f_28[1]))
		{
			...
			__LIB_11__.func_797("*** Gave idle cop gun");
		}
	}
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("FBI_Agent_1_Gun", 0))
	{
		if (__LIB_0__.func_121(iLocal_388) && __LIB_0__.func_121(Local_386.f_28[2]))
		{
			...
			__LIB_11__.func_797("*** Gave notepad cop gun");
		}
	}
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_standing_idle", 0))
	{
		if (__LIB_0__.func_121(Local_386.f_28[1]))
		{
			...
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_389);
			__LIB_11__.func_797("*** Idle cop anim");
		}
	}
	if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Cop_with_notepad", 0))
	{
		if (__LIB_0__.func_121(Local_386.f_28[2]))
		{
			...
			TASK::CLEAR_SEQUENCE_TASK(&iLocal_389);
			__LIB_11__.func_797("*** Notepad cop anim");
		}
	}
}
...
void func_292()//Position - 0x2AADF
{
	if (__LIB_0__.func_121(PLAYER::PLAYER_PED_ID()))
	{
		...
		__LIB_11__.func_797("*** Registered Trevor");
	}
	if (__LIB_0__.func_121(Local_386.f_28[0]))
	{
		CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_386.f_28[0], "Josh", 0, 0, 0);
		__LIB_11__.func_797("*** Registered Josh");
	}
	if (__LIB_0__.func_121(Local_386.f_28[1]))
	{
		...
		__LIB_11__.func_797("*** Registered Cop standing");
	}
	if (__LIB_0__.func_121(Local_386.f_28[2]))
	{
...
void func_300(int iParam0)//Position - 0x2AF6E
{
	...
	if (__LIB_1__.func_183(Local_386.f_35[1]))
	{
	...
	iLocal_48 = 0;
	iLocal_49 = 0;
	__LIB_11__.func_797("*** End of intro set up");
}
...
void func_302()//Position - 0x2B273
{
	...
	if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
	{
		if (__LIB_0__.func_121(Local_386.f_28[1]))
		{
			__LIB_11__.func_797("Trying to set Cop 1 component variation (leadin loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_standing_idle", Local_386.f_28[1], 0);
		}
		if (__LIB_0__.func_121(Local_386.f_28[2]))
		{
			__LIB_11__.func_797("Trying to set Cop 2 component variation (leadin loop)");
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_with_notepad", Local_386.f_28[2], 0);
		}
	}
	switch (iLocal_46)
	{
		...
		case 1:
			if (!__LIB_0__.func_2(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.3529f, 281.62604f, 61.46451f, -1099.5205f, 282.50732f, 65.992226f, 16f, false, true, 0))
			{
				if (__LIB_0__.func_121(PLAYER::PLAYER_PED_ID()) && __LIB_1__.func_197(Local_386.f_28[0]))
				{
				...
				if (!iLocal_400)
				{
					if (__LIB_1__.func_197(Local_386.f_28[0]))
					{
				...
				{
					if ((__LIB_0__.func_121(PLAYER::PLAYER_PED_ID()) && __LIB_1__.func_197(Local_386.f_28[0])) && !__LIB_4__.func_739())
					{
						if (!__LIB_4__.func_465(PLAYER::PLAYER_PED_ID(), joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 0);
					...
					if (__LIB_1__.func_197(Local_386.f_28[0]))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_386.f_28[0], "rcmjosh4", "josh_4_leadin_josh") > 0.276f)
							{
								if (iLocal_401 == 0)
								{
									if (__LIB_35__.func_536(&uLocal_221, "JOSH4AU", "JOSH_4_INTLI", 9, 0, 0, 0))
									{
							...
							if (__LIB_0__.func_76(PLAYER::PLAYER_PED_ID(), Local_386.f_28[0], 1) <= 2f)
							{
								...
								__LIB_11__.func_797("Player too close to Josh, starting cutscene early");
								func_299(1);
							}
						}
						else
...
void func_328()//Position - 0x2C2D3
{
	...
	{
		__LIB_10__.func_701(PLAYER::PLAYER_PED_ID(), Local_53, fLocal_54, 1, 1);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	}
	func_300(1);
	...
	if (__LIB_0__.func_294())
	{
		if (!__LIB_29__.func_802(0, 1))
		{
		}
		if (!__LIB_29__.func_801(1, 1))
		{
		}
		if (__LIB_0__.func_295())
		{
...
void func_452()//Position - 0x38FE6
{
	...
	if (__LIB_0__.func_295())
	{
		if (__LIB_29__.func_802(0, 1))
		{
			__LIB_11__.func_797("*** Opened Josh gate for replay");
		}
	}
	__LIB_11__.func_797("*** Set up coords");
}
...
int func_455(var uParam0)//Position - 0x39416
{
	...
	switch (iLocal_37)
	{
		case 0:
			...
			__LIB_11__.func_794(&(uParam0->f_48), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_37 = 1;
			break;
		case 1:
		...
		case 2:
			...
			{
				if (__LIB_26__.func_256(&(uParam0->f_28[0]), 58, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
				{
			...
			{
				__LIB_11__.func_798(&(uParam0->f_28[1]), iVar0[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
			...
			{
				__LIB_11__.func_798(&(uParam0->f_28[2]), iVar0[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
			...
			{
				__LIB_20__.func_649(&(uParam0->f_35[0]), iVar0[3], -1107.5f, 280.33f, 64.01f, 97.97f);
			}
...
void func_456(int* iParam0, bool bParam1)//Position - 0x39810
{
	...
	__LIB_20__.func_649(iParam0, iLocal_39, Var0, fVar1);
...
void func_468()//Position - 0x39B8C
{
	...
	__LIB_32__.func_757(&Local_386, 1, 0, 0);
