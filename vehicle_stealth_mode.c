...
{
	return __LIB_8__::func_356(&(iParam0->f_6), 5);
}
...
int func_10(var uParam0)//Position - 0x24C
{
	if (uParam0->f_2 != 0)
	{
		if (__LIB_9__::func_816("STEALTH_OFF" /* GXT: Press ~INPUT_VEH_ROOF~ to enter Stealth Mode when piloting the ~a~. All pilot and passenger weapons are unavailable in Stealth Mode as the ~a~ will not appear on enemy radars or maps. */, func_15(uParam0->f_2), func_15(uParam0->f_2)) || __LIB_3__::func_56("STEALTH_ON_P" /* GXT: The Pilot has turned on Stealth Mode. All pilot and passenger weapons are unavailable as the ~a~ will not appear on enemy radars or maps. */, func_15(uParam0->f_2)))
		{
			return 1;
		}
	}
...
void func_17(int* iParam0)//Position - 0x33F
{
	...
	if (func_52(iParam0))
	{
		...
		else if (__LIB_8__::func_356(&(iParam0->f_6), 6) && func_50(iParam0))
		{
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iParam0->f_1) && !func_49())
			{
				func_48(iParam0, 0, 0);
				__LIB_2__::func_487(&(iParam0->f_6), 6);
				__LIB_2__::func_487(&(iParam0->f_6), 2);
			}
		}
	}
	if (func_46(iParam0))
...
{
	int iVar0;
	if (((((((!__LIB_8__::func_356(&(iParam0->f_6), 0) && !__LIB_8__::func_356(&(iParam0->f_6), 2)) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && func_33(iParam0)) && !__LIB_0__::func_77(0)) && !__LIB_0__::func_877()) && func_29()) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iParam0->f_1, -1, false)))
	{
		func_25(iParam0, 1);
		__LIB_2__::func_486(&(iParam0->f_6), 3);
		iVar0 = __LIB_0__::func_138(iParam0->f_6.f_2, 3333, 10000);
		iParam0->f_6.f_2 = 0;
		if (func_52(iParam0))
		{
			__LIB_15__::func_307(func_22(iParam0), func_15(iParam0->f_2), func_15(iParam0->f_2), iVar0);
		}
		else
		{
			__LIB_8__::func_159(func_22(iParam0), func_15(iParam0->f_2), iVar0);
		}
		func_19(iParam0);
		__LIB_2__::func_486(&(iParam0->f_6), 0);
	}
}

void func_19(int* iParam0)//Position - 0x552
{
	__LIB_2__::func_486(&(iParam0->f_6), 2);
}
	...
	if (func_52(iParam0))
	{
		switch (iParam0->f_2)
		{
			...
			case joaat("annihilator2"):
				iVar0 = (__LIB_0__::func_253(19004, -1) + iParam1);
				if (iVar0 >= 0)
				{
					__LIB_1__::func_379(19004, iVar0, -1);
				}
				break;
			}
	}
...
{
	return (!BitTest(Global_1853348[PLAYER::PLAYER_ID() /*834*/].f_809, 4) && !__LIB_10__::func_365());
}
...
int func_33(int* iParam0)//Position - 0x736
{
	if (func_52(iParam0))
	{
		...
		{
			case joaat("akula"):
				return __LIB_0__::func_253(19004, -1) < 3;
			}
		default:
	}
	return 1;
...
{
	int iVar0;
	if (((((((!__LIB_8__::func_356(&(iParam0->f_6), 0) && !__LIB_8__::func_356(&(iParam0->f_6), 1)) && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && __LIB_8__::func_356(&(iParam0->f_6), 3)) && !__LIB_0__::func_77(0)) && !__LIB_0__::func_877()) && func_29()) && ENTITY::DOES_ENTITY_EXIST(VEHICLE::GET_PED_IN_VEHICLE_SEAT(iParam0->f_1, -1, false)))
	{
		iVar0 = __LIB_0__::func_138(iParam0->f_6.f_2, 3333, 10000);
		iParam0->f_6.f_2 = 0;
		if (func_52(iParam0))
		...
		{
			__LIB_15__::func_307(func_41(iParam0), func_15(iParam0->f_2), func_15(iParam0->f_2), iVar0);
		}
		func_47(iParam0);
		__LIB_2__::func_486(&(iParam0->f_6), 0);
	}
...
{
	return (!__LIB_8__::func_356(iParam0, 0) && __LIB_8__::func_356(iParam0, 1));
}

void func_44(int* iParam0)//Position - 0xA4D
{
	__LIB_2__::func_487(&(iParam0->f_6), 0);
	if (func_10(iParam0))
	{
		HUD::CLEAR_HELP(true);
	}
	if (!func_52(iParam0))
	{
		if (func_50(iParam0))
		{
			__LIB_2__::func_487(&(iParam0->f_6), 1);
		}
		else
		{
			__LIB_2__::func_487(&(iParam0->f_6), 2);
...
{
	__LIB_2__::func_486(&(iParam0->f_6), 1);
}
...
{
	return __LIB_8__::func_356(iParam0, 0);
}

bool func_51(int* iParam0)//Position - 0xB30
{
	return __LIB_8__::func_356(iParam0, 2);
}
...
{
	if (func_10(iParam0) && (__LIB_0__::func_77(0) || __LIB_0__::func_877()))
	{
		iParam0->f_6.f_2 = 1;
		HUD::CLEAR_HELP(true);
		__LIB_2__::func_487(&(iParam0->f_6), 0);
...
int func_57(int* iParam0)//Position - 0xC6B
{
	...
	if (__LIB_8__::func_148(PLAYER::PLAYER_ID()))
	{
		return 1;
	}
	return 0;
...
void func_67(int* iParam0)//Position - 0x11AB
{
	...
	bool bVar1;
	int iVar2;
	bVar0 = __LIB_8__::func_356(iParam0, 4);
	bVar1 = __LIB_8__::func_356(iParam0, 0);
	func_78(iParam0);
	if (bVar0)
	{
	...
	if (bVar1)
	{
		__LIB_2__::func_486(iParam0, 1);
	}
	else
	{
		__LIB_2__::func_487(iParam0, 1);
	}
	if (func_38(iParam0))
	{
	...
	if (func_66(iParam0))
	{
		if (!VEHICLE::IS_VEHICLE_SEAT_FREE(iParam0->f_1, -1, false))
		{
			...
			if ((ENTITY::DOES_ENTITY_EXIST(iVar2) && !ENTITY::IS_ENTITY_DEAD(iVar2, false)) && PED::IS_PED_A_PLAYER(iVar2))
			{
				...
				if (iVar2 == PLAYER::PLAYER_PED_ID())
				{
					...
					{
						__LIB_2__::func_486(&(iParam0->f_6), 6);
					}
				}
			}
		}
		if (func_38(iParam0))
		{
			iParam0->f_4 = __LIB_0__::func_336(PLAYER::PLAYER_PED_ID(), 0);
		}
		if (func_52(iParam0))
		{
...
{
	__LIB_2__::func_486(&(uParam0->f_6), 4);
...
{
	return __LIB_8__::func_356(&(uParam0->f_6), 4);
}

void func_74(var uParam0)//Position - 0x1403
{
	__LIB_2__::func_487(&(uParam0->f_6), 4);
}
