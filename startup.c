...
void func_15(var* uParam0, int iParam1)//Position - 0x240A
{
	...
	MISC::STOP_SAVE_ARRAY();
	__LIB_31__.func_138(uParam0, "CAR_APP_ORDER");
...
{
	if ((((__LIB_0__.func_176(54) || __LIB_0__.func_176(55)) || __LIB_0__.func_176(56)) || __LIB_0__.func_176(57)) || __LIB_0__.func_176(58))
	{
...
void func_30()//Position - 0x308D
{
	...
	while (iVar0 < 16)
	{
		if (!__LIB_0__.func_43(Global_113386.f_24904[iVar0 /*4*/]))
		{
...
int func_34(var uParam0, int iParam1)//Position - 0x3175
{
	...
	uParam0->f_32 = __LIB_32__.func_463(iParam1);
	uParam0->f_16 = { __LIB_9__.func_26(iParam1) };
	...
	switch (iParam1)
	{
		case 1:
			...
			func_51(uParam0, 10);
			uParam0->f_31 = 1;
			__LIB_40__.func_683(uParam0, uParam0->f_31);
			uParam0->f_34 = 0;
			return 1;
			break;
		case 2:
		...
		case 87:
			...
			func_53(uParam0, uParam0->f_35);
			uParam0->f_31 = 87;
			__LIB_40__.func_683(uParam0, 87);
			uParam0->f_34 = 3;
			return 1;
			break;
		case 88:
			...
			func_53(uParam0, uParam0->f_35);
			uParam0->f_31 = 88;
			__LIB_40__.func_683(uParam0, 88);
			uParam0->f_34 = 3;
			return 1;
			break;
		case 89:
			...
			func_53(uParam0, uParam0->f_35);
			uParam0->f_31 = 89;
			__LIB_40__.func_683(uParam0, 89);
			uParam0->f_34 = 3;
			return 1;
			break;
		case 90:
			...
			func_53(uParam0, uParam0->f_35);
			uParam0->f_31 = 90;
			__LIB_40__.func_683(uParam0, 90);
			uParam0->f_34 = 3;
			return 1;
			break;
		case 5:
		...
		case 64:
			...
			break;
		case 73:
			uParam0->f_35 = __LIB_1__.func_987(iParam1);
			func_53(uParam0, uParam0->f_35);
			func_51(uParam0, 10);
			uParam0->f_31 = 73;
			__LIB_40__.func_683(uParam0, uParam0->f_31);
...
void func_51(var uParam0, int iParam1)//Position - 0xB453
{
	switch (iParam1)
	{
		case 2:
			...
			__LIB_2__.func_829(&(uParam0->f_1742.f_153), 2);
		...
		case 6:
			...
			__LIB_2__.func_829(&(uParam0->f_1742.f_153), 6);
		...
		case 10:
			...
			__LIB_2__.func_829(&(uParam0->f_1742.f_153), 10);
...
void func_53(var uParam0, int iParam1)//Position - 0xBDC2
{
	...
	switch (iParam1)
	{
		case 1:
			*uParam0 = { -773.4775f, 310.6321f, 84.6981f };
			...
			__LIB_37__.func_447(uParam0->f_38[1 /*27*/].f_16, uParam0->f_38[1 /*27*/].f_19, &Var0, uParam0->f_38[1 /*27*/].f_22);
	...
	__LIB_2__.func_489(&(uParam0->f_1912), uParam0->f_35);
}
	...
	switch (iParam1)
	{
		case 68:
			*uParam0 = { -1581.5f, -558.3f, 35f };
			...
			__LIB_37__.func_447(uParam0->f_38[2 /*27*/].f_16, uParam0->f_38[2 /*27*/].f_19, &Var0, uParam0->f_38[2 /*27*/].f_22);
...
int func_61(var uParam0, int iParam1)//Position - 0x209EB
{
	switch (iParam1)
	{
		case 103:
			...
			func_62(uParam0, 103);
			uParam0->f_31 = 103;
			__LIB_40__.func_683(uParam0, 103);
			uParam0->f_34 = 5;
			return 1;
			break;
		case 104:
			...
			func_62(uParam0, 104);
			uParam0->f_31 = 104;
			__LIB_40__.func_683(uParam0, 104);
			uParam0->f_34 = 5;
			return 1;
			break;
		case 105:
			...
			func_62(uParam0, 105);
			uParam0->f_31 = 105;
			__LIB_40__.func_683(uParam0, 105);
			uParam0->f_34 = 5;
			return 1;
			break;
		case 106:
			...
			func_62(uParam0, 106);
			uParam0->f_31 = 106;
			__LIB_40__.func_683(uParam0, 106);
			uParam0->f_34 = 5;
			return 1;
			break;
		case 107:
			...
			func_62(uParam0, 107);
			uParam0->f_31 = 107;
			__LIB_40__.func_683(uParam0, 107);
			uParam0->f_34 = 5;
			return 1;
			break;
		case 108:
			...
			func_62(uParam0, 108);
			uParam0->f_31 = 108;
			__LIB_40__.func_683(uParam0, 108);
			uParam0->f_34 = 5;
			return 1;
			break;
		case 109:
			...
			func_62(uParam0, 109);
			uParam0->f_31 = 109;
			__LIB_40__.func_683(uParam0, 109);
			uParam0->f_34 = 5;
			return 1;
			break;
		case 110:
			...
			func_62(uParam0, 110);
			uParam0->f_31 = 110;
			__LIB_40__.func_683(uParam0, 110);
			uParam0->f_34 = 5;
			return 1;
			break;
		case 111:
			...
			func_62(uParam0, 111);
			uParam0->f_31 = 111;
			__LIB_40__.func_683(uParam0, 111);
			uParam0->f_34 = 5;
			return 1;
			break;
		case 112:
			...
			func_62(uParam0, 112);
			uParam0->f_31 = 112;
			__LIB_40__.func_683(uParam0, 112);
			uParam0->f_34 = 5;
			return 1;
			break;
		case 113:
			...
			func_62(uParam0, 113);
			uParam0->f_31 = 113;
			__LIB_40__.func_683(uParam0, 113);
			uParam0->f_34 = 5;
			return 1;
			break;
		case 114:
			...
			func_62(uParam0, 114);
			uParam0->f_31 = 114;
			__LIB_40__.func_683(uParam0, 114);
			uParam0->f_34 = 5;
			return 1;
			break;
	}
...
void func_62(var uParam0, int iParam1)//Position - 0x20C9B
{
	...
	int iVar1;
	uParam0->f_33 = 20;
	__LIB_18__.func_381(iParam1, 6, &Var0, 109, 0);
	uParam0->f_1742.f_20 = { Var0 };
	uParam0->f_1742.f_23 = Var0.f_3.f_2;
	iVar1 = 0;
	while (iVar1 < 10)
	{
		__LIB_18__.func_381(iParam1, (913 + iVar1), &Var0, 109, 0);
		uParam0->f_1742.f_28[iVar1 /*3*/] = { Var0 };
		uParam0->f_1742.f_62[iVar1] = Var0.f_3.f_2;
		__LIB_18__.func_381(iParam1, (933 + iVar1), &Var0, 109, 0);
		uParam0->f_1742.f_74[iVar1 /*3*/] = { Var0 };
		iVar1++;
	}
	__LIB_18__.func_381(iParam1, 1, &Var0, 109, 0);
	uParam0->f_1742 = { Var0 };
	__LIB_18__.func_381(iParam1, 2, &Var0, 109, 0);
	uParam0->f_1742.f_3 = { Var0 };
	uParam0->f_1742.f_6 = 2f;
	uParam0->f_1742.f_7 = Var0.f_3.f_2;
	__LIB_18__.func_381(iParam1, 15, &Var0, 109, 0);
	uParam0->f_1742.f_136 = { Var0 };
	__LIB_18__.func_381(iParam1, 3, &Var0, 109, 0);
	uParam0->f_1742.f_150 = { Var0 };
	__LIB_18__.func_381(iParam1, 4, &Var0, 109, 0);
	uParam0->f_1742.f_153 = { Var0 };
	__LIB_18__.func_381(iParam1, 5, &Var0, 109, 0);
	uParam0->f_1742.f_153.f_3 = { Var0 };
	uParam0->f_1742.f_153.f_6 = 22.75f;
	uParam0->f_1742.f_149 = 0;
	__LIB_18__.func_381(iParam1, 137, &Var0, 109, 0);
...
int func_63(var uParam0, int iParam1)//Position - 0x20E13
{
	switch (iParam1)
	{
		case 91:
			...
			func_64(uParam0, 91);
			uParam0->f_31 = 91;
			__LIB_40__.func_683(uParam0, 91);
			uParam0->f_34 = 4;
			return 1;
			break;
		case 92:
		...
		case 97:
			...
			func_64(uParam0, 97);
			uParam0->f_31 = 97;
			__LIB_40__.func_683(uParam0, 97);
			uParam0->f_34 = 4;
			return 1;
			break;
		case 98:
