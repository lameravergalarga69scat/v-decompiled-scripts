		...
		if (Local_153[iVar0 /*6*/].f_1 == 1)
		{
			switch (Local_153[iVar0 /*6*/])
			{
				case 0:
					switch (Local_153[iVar0 /*6*/].f_2)
					{
						case 0:
							...
							break;
						case 1:
							__LIB_14__::func_614(1992.8041f, 3053.3103f, 45.777145f, 1989.6813f, 3055.2954f, 49.090008f, 3.25f, 1995.2018f, 3062.1565f, 46.0491f, 59.7235f, 10f, 20f, 9f, 1, 1, 1, 0, 0);
							__LIB_14__::func_614(1994.4274f, 3045.136f, 45.340134f, 1981.9028f, 3053.235f, 49.791527f, 9.5f, 1995.2018f, 3062.1565f, 46.0491f, 59.7235f, 10f, 20f, 9f, 1, 1, 1, 0, 0);
							__LIB_14__::func_614(1985.4037f, 3075.0571f, 44.84953f, 2017.1017f, 3057.4348f, 53.71896f, 33f, 1995.2018f, 3062.1565f, 46.0491f, 59.7235f, 10f, 20f, 9f, 1, 1, 1, 0, 0);
							iLocal_144 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
							if (__LIB_40__::func_827(iLocal_144) && __LIB_0__::func_724(iLocal_144, 1995.2018f, 3062.1565f, 46.0491f, 1) < 5f)
							{
				...
				case 2:
					...
					switch (Local_153[iVar0 /*6*/].f_2)
					{
						case -1:
							...
							break;
						case 0:
							if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2442.55f, 4967.51f, 54.35f, 1) < 1300f || __LIB_0__::func_769(39))
							{
								if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2442.55f, 4967.51f, 54.35f, 1) > 500f)
								{
									Local_153[iVar0 /*6*/].f_2++;
								}
							}
				...
				case 6:
					...
					{
						case 0:
							__LIB_0__::func_544(50, 0, 0, 1, 0);
							__LIB_0__::func_544(51, 0, 0, 1, 0);
							__LIB_0__::func_544(52, 0, 0, 1, 0);
							__LIB_0__::func_544(53, 0, 0, 1, 0);
							__LIB_0__::func_544(54, 1, 0, 1, 0);
							Local_153[iVar0 /*6*/].f_2++;
							break;
						case 1:
							break;
				...
				case 9:
					switch (Local_153[iVar0 /*6*/].f_2)
					{
						case -1:
							...
							break;
						case 0:
							if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2578.5234f, 4982.2837f, 51.4416f, 1) < 500f)
							{
				...
				case 25:
					...
					{
						case 0:
							__LIB_0__::func_377(PLAYER::PLAYER_PED_ID(), 149);
							Local_153[iVar0 /*6*/].f_2++;
							break;
						case 1:
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
							{
								...
								__LIB_0__::func_377(iVar3, 152);
								__LIB_0__::func_505(iVar3, -1);
								Local_153[iVar0 /*6*/].f_2++;
							}
							break;
						case 2:
					...
					if (Local_153[iVar0 /*6*/].f_2 != -1)
					{
						if (!WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_PETROLCAN"), false) || !OBJECT::DOES_PICKUP_EXIST(iLocal_176))
						{
							...
							if (iLocal_180 != 0)
							{
								...
								iLocal_178 = __LIB_0__::func_643(iLocal_180);
								func_12(1);
								__LIB_0__::func_498(0, 157);
							}
						}
						else
						{
							...
							{
								__LIB_0__::func_497(158, (iLocal_167 - WEAPON::GET_AMMO_IN_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_PETROLCAN"))), 1);
							}
						}
						if (func_8())
						{
					...
					else
					{
						switch (Local_153[iVar0 /*6*/].f_2)
						{
							case 0:
								if (!__LIB_0__::func_75())
								{
									__LIB_0__::func_382("FRMSHP", 7500, 1);
									Local_153[iVar0 /*6*/].f_5 = MISC::GET_GAME_TIMER() + 2000;
									iLocal_178 = __LIB_0__::func_488(2450f, 4954f, 45f, 0);
									Local_153[iVar0 /*6*/].f_2++;
								}
								break;
							}
				...
				case 26:
					switch (Local_153[iVar0 /*6*/].f_2)
					{
						...
						case 3:
							...
							break;
						case 4:
							if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 1991.4193f, 3054.915f, 47.533f, 1) > 150f)
							{
								Local_153[iVar0 /*6*/].f_2 = -1;
							}
							break;
...
void func_12(int iParam0)//Position - 0x267C
{
	...
	else if (iLocal_86)
	{
		...
		while (iVar0 < Local_109.f_0)
		{
			...
			{
				Local_109[iVar0 /*5*/].f_3 = __LIB_0__::func_488(Local_109[iVar0 /*5*/], 0);
...
int func_35(char* sParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, char* sParam12, int iParam13)//Position - 0x73E0
{
	if (!iLocal_574)
	{
		...
		if (!__LIB_3__::func_63())
		{
			...
			{
				if (__LIB_2__::func_859(&uLocal_409, "CHI2AUD", sParam0, iParam13, 1, 0, 0))
				{
					iLocal_392 = 1;
					return 1;
				}
			}
			else if (__LIB_2__::func_859(&uLocal_409, "CHI2AUD", sParam0, iParam13, 0, 0, 0))
			{
				iLocal_392 = 0;
				return 1;
			}
...
void func_61(int iParam0, int iParam1, char* sParam2)//Position - 0x7E73
{
	...
	while (iVar0 < iLocal_408)
	{
		...
		{
			__LIB_0__::func_221(&uLocal_409, iVar0);
			iLocal_408[iVar0] = 0;
		}
		iVar0++;
	}
	...
	{
		__LIB_0__::func_221(&uLocal_409, iParam0);
	}
	__LIB_0__::func_222(&uLocal_409, iParam0, iParam1, sParam2, 0, 1);
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(sLocal_51) || !MISC::ARE_STRINGS_EQUAL(sLocal_51, sParam0))
	{
		...
		while (iVar0 <= 15)
		{
			if (Local_77[iVar0 /*10*/].f_7)
			{
				...
				{
					__LIB_0__::func_221(&Local_77, iVar0);
				}
			}
			iVar0++;
		}
...
int func_66(char* sParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, char* sParam9)//Position - 0x8022
{
	if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || HUD::IS_SUBTITLE_PREFERENCE_SWITCHED_ON())
	{
		...
		if (__LIB_3__::func_78(&uLocal_409, 39, "CHI2AUD", sParam0, 9, 0, 0, 1))
		{
			return 1;
		}
	}
							...
							switch (Local_113[iVar0 /*33*/].f_2)
							{
								...
								case 8:
									if (func_107(iVar0, joaat("A_M_M_Hillbilly_02"), 2505.451f, 4970.663f, 43.548f, 49.5021f, joaat("WEAPON_PISTOL"), 1, 0))
									{
										...
										__LIB_15__::func_995(Local_113[iVar0 /*33*/], 20f, 5f, 90f, -90f, 60f);
					...
					if (Local_119[iVar0 /*24*/].f_3 <= 3)
					{
						switch (Local_113[iVar0 /*33*/].f_3)
						{
							...
							case 2:
								...
								{
									__LIB_0__::func_631(Local_113[iVar0 /*33*/], &(Local_113[iVar0 /*33*/].f_25), -1, 0, 1, 0, -1082130432, 0, -1, -1, 1, 0);
								}
								...
								if (ENTITY::DOES_ENTITY_EXIST(Local_113[iVar0 /*33*/].f_20))
								{
									if (Local_113[iVar0 /*33*/].f_5 > 2 && Local_113[iVar0 /*33*/].f_5 <= 6)
									{
										...
										{
											Local_113[iVar0 /*33*/].f_12 = (__LIB_6__::func_252(ENTITY::GET_ENTITY_COORDS(Local_113[iVar0 /*33*/], true), Local_113[iVar0 /*33*/].f_6, 1) - ENTITY::GET_ENTITY_HEADING(Local_113[iVar0 /*33*/]));
											Local_113[iVar0 /*33*/].f_12 = __LIB_0__::func_331((Local_113[iVar0 /*33*/].f_12 / 4f), -15f, 15f);
								...
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									...
									case 1:
										if (ENTITY::DOES_ENTITY_EXIST(Local_113[iVar0 /*33*/].f_20))
										{
											if (__LIB_0__::func_724(Local_113[iVar0 /*33*/], 2495.7786f, 5004.715f, 43.873367f, 1) < 99f)
											{
												if (Local_113[iVar0 /*33*/].f_2 == 4)
												{
													TASK::TASK_PLAY_ANIM(Local_113[iVar0 /*33*/], "misschinese2_barrelroll", "barrel_roll_loop_B", 1000f, -1f, -1, 1, 0f, false, false, false);
									...
									case 6:
										if (ENTITY::IS_ENTITY_AT_COORD(Local_113[iVar0 /*33*/], Local_113[iVar0 /*33*/].f_6, 1.5f, 1.5f, 2f, false, true, 0))
										{
											...
											if (__LIB_40__::func_827(iLocal_145))
											{
												if (Local_113[iVar0 /*33*/].f_2 == 4)
												{
								...
								if (!PED::IS_PED_INJURED(Local_113[iVar0 /*33*/]))
								{
									...
									switch (Local_113[iVar0 /*33*/].f_5)
									{
										...
										case 11:
											...
											break;
										case 12:
											if (PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), Local_113[iVar0 /*33*/]) && __LIB_0__::func_724(Local_113[iVar0 /*33*/], 2448.0027f, 4982.305f, 45.8519f, 1) < 10f)
											{
							...
							case 28:
								...
								{
									case 0:
										if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_113[iVar0 /*33*/]) || (__LIB_13__::func_784(ENTITY::GET_ENTITY_COORDS(Local_113[iVar0 /*33*/], true), 1f, 1120403456) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2448.5833f, 4969.292f, 45.185604f, 2439.5383f, 4978.061f, 46.827618f, 5.75f, false, true, 0)))
										{
							...
							case 30:
								...
								switch (Local_113[iVar0 /*33*/].f_5)
								{
									...
									case 6:
										...
										if (!__LIB_0__::func_75() || (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2430.09f, 4965.93f, 41.55f, 1) > 3.438f && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2427.0789f, 4964.9707f, 41.811687f, 2432.5889f, 4959.331f, 48.754795f, 3.3125f, false, true, 0)))
										{
											__LIB_0__::func_638();
											Local_113[iVar0 /*33*/].f_5++;
										}
							...
							case 31:
								...
								{
									case 0:
										if (__LIB_0__::func_501("FRMFLC", 0, 0))
										{
											Local_113[iVar0 /*33*/].f_5++;
										}
										break;
							...
							case 11:
								switch (Local_119[iVar0 /*24*/].f_4)
								{
									case 1:
										...
										break;
									case 2:
										if (__LIB_0__::func_724(Local_113[iVar0 /*33*/], 2451.6775f, 4954.2515f, 44.988f, 1) < 3f)
										{
											PED::REMOVE_PED_DEFENSIVE_AREA(Local_113[iVar0 /*33*/], false);
											Local_119[iVar0 /*24*/].f_4++;
										}
...
int func_107(int iParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4, bool bParam5, int iParam6)//Position - 0xCD65
{
	...
	else
	{
		...
		__LIB_0__::func_609(Local_113[iParam0 /*33*/], 1);
	}
						...
						if (!PED::IS_PED_DEAD_OR_DYING((*uParam0)[iLocal_61 /*24*/], true))
						{
							switch (iLocal_60)
							{
								case 8:
									if (!bLocal_53)
									{
										if (!bLocal_56)
										{
											if (!iLocal_74)
											{
												if (!__LIB_15__::func_963(Param5.f_1))
												{
													__LIB_0__::func_429();
										...
										else if (!__LIB_15__::func_963(Param4.f_1))
										{
											__LIB_0__::func_429();
								...
								case 6:
									if (!bLocal_56)
									{
										if (((!__LIB_15__::func_963(Param2.f_1) && !__LIB_15__::func_963(Param3.f_1)) && !__LIB_15__::func_963(Param4.f_1)) && !__LIB_15__::func_963(Param5.f_1))
										{
											iLocal_74 = 0;
											__LIB_0__::func_429();
...
int func_111(char* sParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, char* sParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, char* sParam12, int iParam13)//Position - 0xD999
{
	...
	if (!__LIB_3__::func_63())
	{
		...
		{
			if (__LIB_2__::func_859(&Local_77, cLocal_78, sParam0, iParam13, 0, 0, 0))
			{
				iLocal_80 = 0;
				return 1;
			}
...
void func_112(int iParam0, int iParam1, char* sParam2)//Position - 0xDA4C
{
	...
	{
		__LIB_0__::func_221(&Local_77, iParam0);
	}
	__LIB_0__::func_222(&Local_77, iParam0, iParam1, sParam2, 0, 1);
													...
													switch ((uParam0[iVar0 /*24*/])->f_5)
													{
														case 0:
															if ((uParam0[iVar0 /*24*/])->f_10 >= 0)
															{
																...
																{
																	fVar1 = __LIB_16__::func_322((*uParam0)[iVar0 /*24*/], (*uParam0)[(uParam0[iVar0 /*24*/])->f_10 /*24*/]);
														...
														switch ((uParam0[iVar0 /*24*/])->f_5)
														{
															...
															case 3:
																if (ENTITY::IS_ENTITY_PLAYING_ANIM((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "alert_gunshot", 3))
																{
																	...
																	{
																		if (__LIB_40__::func_833(iVar0, uParam0, 0))
																		{
																			(uParam0[iVar0 /*24*/])->f_5 = 4;
																		}
																		else
												...
												case 6:
													switch ((uParam0[iVar0 /*24*/])->f_5)
													{
														...
														case 4:
															if (bLocal_56)
															{
																if (MISC::ABSF(__LIB_16__::func_322((*uParam0)[iVar0 /*24*/], PLAYER::PLAYER_PED_ID())) < 20f)
																{
																	if (ENTITY::IS_ENTITY_PLAYING_ANIM((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "spot_high", 3))
																	{
																		if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "spot_high") > __LIB_40__::func_824(((__LIB_0__::func_76((*uParam0)[iVar0 /*24*/], PLAYER::PLAYER_PED_ID(), 1) + 5f) / 35f), 0.27f, 0.9f))
																		{
																			(uParam0[iVar0 /*24*/])->f_3 = 6;
																			(uParam0[iVar0 /*24*/])->f_1 = 10;
																			(uParam0[iVar0 /*24*/])->f_4 = 0;
																	...
																	{
																		if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "spot_mid") > __LIB_40__::func_824(((__LIB_0__::func_76((*uParam0)[iVar0 /*24*/], PLAYER::PLAYER_PED_ID(), 1) + 5f) / 35f), 0.27f, 0.9f))
																		{
																			(uParam0[iVar0 /*24*/])->f_3 = 6;
																			(uParam0[iVar0 /*24*/])->f_1 = 10;
																			(uParam0[iVar0 /*24*/])->f_4 = 0;
																	...
																	{
																		if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*uParam0)[iVar0 /*24*/], "misschinese2_bank1", "spot_low") > __LIB_40__::func_824(((__LIB_0__::func_76((*uParam0)[iVar0 /*24*/], PLAYER::PLAYER_PED_ID(), 1) + 5f) / 35f), 0.27f, 0.9f))
																		{
																			(uParam0[iVar0 /*24*/])->f_3 = 6;
																			(uParam0[iVar0 /*24*/])->f_1 = 10;
																			(uParam0[iVar0 /*24*/])->f_4 = 0;
	...
	switch ((uParam1[iParam0 /*24*/])->f_5)
	{
		case 0:
			if (!MISC::ARE_STRINGS_EQUAL("chi2_hear", Param3.f_1))
			{
				if (__LIB_0__::func_75())
				{
					if (!__LIB_15__::func_963(Param3.f_1))
					{
						__LIB_0__::func_638();
					}
				}
		...
		case 2:
			if (!MISC::ARE_STRINGS_EQUAL("chi2_hear", Param3.f_1))
			{
				if ((PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), (*uParam1)[iParam0 /*24*/]) || iLocal_73 == 1) && __LIB_0__::func_724((*uParam1)[iParam0 /*24*/], (uParam1[iParam0 /*24*/])->f_12, 1) < (uParam1[iParam0 /*24*/])->f_19)
				{
...
void func_121(var uParam0, struct<2> Param1, var uParam2, struct<2> Param3, var uParam4, struct<2> Param5, var uParam6, struct<2> Param7, var uParam8)//Position - 0xF38B
{
					...
					while (iVar0 < *uParam0)
					{
						if (iVar0 != iLocal_58)
						{
							if (ENTITY::DOES_ENTITY_EXIST((*uParam0)[iVar0 /*24*/]))
							{
								...
								if (fVar7 < 10f)
								{
									fVar8 = __LIB_16__::func_322((*uParam0)[iLocal_58 /*24*/], (*uParam0)[iVar0 /*24*/]);
	...
	if (!iLocal_55)
	{
		if (__LIB_15__::func_963(Param1.f_1) || __LIB_15__::func_963(Param3.f_1))
		{
			iLocal_59 = MISC::GET_GAME_TIMER() + 1000;
			iLocal_55 = 1;
		}
		if (__LIB_15__::func_963(Param5.f_1) || __LIB_15__::func_963(Param7.f_1))
		{
			iLocal_59 = MISC::GET_GAME_TIMER() + 1000;
			iLocal_55 = 1;
		}
	}
	else if (((!__LIB_15__::func_963(Param1.f_1) && !__LIB_15__::func_963(Param3.f_1)) && !__LIB_15__::func_963(Param5.f_1)) && !__LIB_15__::func_963(Param7.f_1))
	{
		iLocal_55 = 0;
	}
		...
		if (!PED::IS_PED_DEAD_OR_DYING((*uParam0)[iVar0 /*24*/], true))
		{
			if ((uParam0[iVar0 /*24*/])->f_3 != 7)
			{
				...
				if ((uParam0[iVar0 /*24*/])->f_3 <= 5)
				{
					...
					if (((PED::IS_PED_RESPONDING_TO_EVENT((*uParam0)[iVar0 /*24*/], 1) || PED::HAS_PED_RECEIVED_EVENT((*uParam0)[iVar0 /*24*/], 1)) || (PED::IS_PED_IN_COMBAT((*uParam0)[iVar0 /*24*/], 0) && PED::CAN_PED_IN_COMBAT_SEE_TARGET((*uParam0)[iVar0 /*24*/], PLAYER::PLAYER_PED_ID()))) || (__LIB_40__::func_826((*uParam0)[iVar0 /*24*/]) && PED::HAS_PED_RECEIVED_EVENT((*uParam0)[iVar0 /*24*/], 1)))
					{
						if ((uParam0[iVar0 /*24*/])->f_3 > 4)
						{
...
void func_123()//Position - 0xFC80
{
	if (iLocal_392)
	{
		if (MISC::IS_STRING_NULL_OR_EMPTY(&Local_397))
		{
			if (__LIB_0__::func_75())
			{
				if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						cLocal_393 = { __LIB_0__::func_485() };
						Local_397 = { __LIB_0__::func_486() };
		...
		else
		{
			if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
			{
				if (!__LIB_15__::func_963(&Local_397))
				{
					iLocal_392 = 0;
					StringCopy(&Local_397, "", 24);
					StringCopy(&cLocal_393, "", 24);
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_113[iVar0 /*33*/]))
			{
				if (!Local_113[iVar0 /*33*/].f_23)
				{
					if (PED::IS_PED_INJURED(Local_113[iVar0 /*33*/]))
					{
						...
						__LIB_0__::func_497(151, 1, 0);
					}
				}
				if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_113[iVar0 /*33*/]) == iLocal_116)
				{
					__LIB_0__::func_631(Local_113[iVar0 /*33*/], &(Local_113[iVar0 /*33*/].f_25), -1, 0, 0, 0, -1082130432, 0, -1, -1, 1, 0);
				}
			}
			else if (Local_113[iVar0 /*33*/] != 0)
			{
				__LIB_0__::func_621(&(Local_113[iVar0 /*33*/].f_25));
		...
		if (func_158(iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1, 0))
		{
			switch (Local_389[iParam0 /*4*/])
			{
				...
				case 5:
					...
					{
						__LIB_0__::func_382("FRMLK", 7500, 1);
						Local_389[iParam0 /*4*/].f_1 = 1;
					}
					break;
				case 2:
					__LIB_0__::func_382("FRMSNP", 7500, 1);
					Local_389[iParam0 /*4*/].f_1 = 1;
					break;
				case 11:
					switch (Local_389[iParam0 /*4*/].f_2)
				...
				case 6:
					...
					break;
				case 7:
					__LIB_0__::func_382("FRMFLC", 7500, 1);
				...
				case 8:
					switch (Local_389[iParam0 /*4*/].f_2)
					{
						...
						case 1:
							if (!__LIB_0__::func_75())
							{
								__LIB_0__::func_229("FRMTRL", 7500, 1);
								Local_389[iParam0 /*4*/].f_2++;
							}
							break;
						case 2:
								...
								if (!__LIB_0__::func_75())
								{
									if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) != 0)
									{
										if (!HUD::DOES_BLIP_EXIST(iLocal_178))
										{
											HUD::CLEAR_PRINTS();
											__LIB_0__::func_382("FRMSHP", 7500, 1);
											iLocal_178 = __LIB_0__::func_488(2454.8953f, 4950.8945f, 44.1488f, 0);
										}
									}
									else if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2454.8953f, 4950.8945f, 44.1488f, 1) < 5f)
									{
										HUD::CLEAR_PRINTS();
										if (HUD::DOES_BLIP_EXIST(iLocal_178))
										{
										...
										__LIB_0__::func_382("FRMIGN", 7500, 1);
						...
						case 4:
							if (func_93(37))
							{
								if (__LIB_0__::func_501("FRMIGN", 0, 0))
								{
									HUD::CLEAR_PRINTS();
								}
							}
				...
				case 10:
					if (func_93(34))
					{
						__LIB_0__::func_382("FRMFRH", 7500, 1);
					}
					else
					{
						__LIB_0__::func_382("FRMFRG", 7500, 1);
					}
					Local_389[iParam0 /*4*/].f_1 = 1;
					break;
				case 12:
					__LIB_0__::func_382("FRMLEAVE", 1, 1);
					if (func_93(48))
					{
						HUD::CLEAR_PRINTS();
						Local_389[iParam0 /*4*/].f_1 = 1;
					...
					break;
				case 13:
					__LIB_0__::func_382("LOSE_WANTED" /* GXT: Lose the Cops. */, 7500, 1);
					break;
				}
			}
	}
		...
		if (func_158(iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9))
		{
			...
			switch (Local_390[iParam0 /*7*/])
			{
				...
				case 19:
					...
					{
						case 0:
							if (__LIB_15__::func_963("ONEILGUARD4") || __LIB_15__::func_963("SEETREVOR"))
							{
								Local_390[iParam0 /*7*/].f_3++;
							}
							break;
		...
		if (bVar0 == 1)
		{
			...
			switch (Local_385[iParam0 /*10*/])
			{
				...
				case 2:
					...
					break;
				case 3:
					if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 1991.05f, 3054.2625f, 46.2147f, 1) > 250f)
					{
				...
				case 5:
					...
					break;
				case 4:
					if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2457.4897f, 4977.0947f, 50.567833f, 1) < 400f)
					{
						func_32(27, 0);
				...
				case 7:
					...
					break;
				case 8:
					fVar1 = __LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2450.2136f, 4979.208f, 60.8422f, 1);
					if (fVar1 < 900f)
					{
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
				...
				case 42:
					switch (Local_385[iParam0 /*10*/].f_6)
					{
						...
						case 3:
							...
							break;
						case 4:
							if (__LIB_40__::func_827(iLocal_144))
							{
						...
						case 5:
							...
							break;
						case 6:
							if (__LIB_15__::func_963("CHI2_rad"))
							{
								Local_385[iParam0 /*10*/].f_6++;
							}
							break;
				...
				case 48:
					...
					break;
				case 49:
					if (!__LIB_13__::func_784(2448.25f, 4974.92f, 55.11f, 20f, 500f) || func_93(49))
					{
						if (iLocal_179 != 0)
						{
							INTERIOR::UNPIN_INTERIOR(iLocal_179);
						...
						iLocal_179 = 0;
						__LIB_0__::func_544(50, 2, 0, 1, 0);
						__LIB_0__::func_544(51, 2, 0, 1, 0);
						__LIB_0__::func_544(52, 2, 0, 1, 0);
						__LIB_0__::func_544(53, 2, 0, 1, 0);
						__LIB_0__::func_544(54, 1, 0, 1, 0);
						__LIB_0__::func_544(55, 1, 0, 1, 0);
						Local_385[iParam0 /*10*/].f_3 = 1;
					}
					break;
				case 50:
					switch (Local_385[iParam0 /*10*/].f_6)
					{
						...
						case 1:
							if (WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_PETROLCAN"), false))
							{
								...
								{
									__LIB_0__::func_497(158, (Local_385[iParam0 /*10*/].f_7 - iVar8), 0);
									Local_385[iParam0 /*10*/].f_7 = iVar8;
								}
							}
				...
				case 51:
					...
					break;
				case 52:
					func_15("CHN2_STOP_TRACK", 0, __LIB_0__::func_591());
					Local_385[iParam0 /*10*/].f_3 = 1;
					break;
				case 53:
				...
				case 41:
					switch (Local_385[iParam0 /*10*/].f_6)
					{
						...
						case 900:
							...
							if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 1991.988f, 3054.51f, 46.215f, 1) > 200f)
							{
					...
					if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 1995.1694f, 3062.1624f, 46.049f, 1) < 7f)
					{
						if (!PED::IS_PED_INJURED(Local_113[11 /*33*/]))
						{
				...
				case 16:
					...
					if (!OBJECT::DOES_PICKUP_EXIST(iLocal_176))
					{
						...
						iLocal_178 = __LIB_16__::func_321(iLocal_176);
								...
								while (Local_385[iParam0 /*10*/].f_7 < Local_113.f_0)
								{
									if (!PED::IS_PED_INJURED(Local_113[Local_385[iParam0 /*10*/].f_7 /*33*/]))
									{
										if (INTERIOR::GET_INTERIOR_FROM_ENTITY(Local_113[Local_385[iParam0 /*10*/].f_7 /*33*/]) == 0)
										{
											...
											__LIB_0__::func_621(&(Local_113[Local_385[iParam0 /*10*/].f_7 /*33*/].f_25));
										}
									}
				...
				case 34:
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == 0)
						{
							if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2451.08f, 4961.4634f, 44.4392f, 1) < 20f)
							{
				...
				case 39:
					switch (Local_385[iParam0 /*10*/].f_6)
					{
						case 0:
							...
							break;
						case 1:
							if (__LIB_0__::func_724(Local_113[Local_385[iParam0 /*10*/].f_7 /*33*/], 2454.8953f, 4950.8945f, 44.1488f, 1) > 100f && __LIB_0__::func_76(Local_113[Local_385[iParam0 /*10*/].f_7 /*33*/], PLAYER::PLAYER_PED_ID(), 1) > 100f)
							{
								iVar16 = func_18(4);
								__LIB_0__::func_621(&(Local_113[iVar16 /*33*/].f_25));
		...
		switch (Local_388[iVar3 /*8*/])
		{
			case 2:
				if (!Local_388[iVar3 /*8*/].f_2)
				{
					...
					{
						if (__LIB_0__::func_501("FRMCHSE_1", 0, 0))
						{
							Local_388[iVar3 /*8*/].f_4 = 1;
						}
					}
					else if (!__LIB_0__::func_501("FRMCHSE_1", 0, 0))
					{
			...
			case 14:
				if (!Local_388[iVar3 /*8*/].f_2)
				{
					if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2451.5173f, 4973.122f, 44.2646f, 1) < 50f)
					{
						Local_388[iVar3 /*8*/].f_2 = 1;
					}
				}
				...
				switch (Local_388[iVar3 /*8*/].f_4)
				{
					...
					case 1:
						if (ENTITY::DOES_ENTITY_EXIST(Local_113[Local_388[iVar3 /*8*/].f_5 /*33*/]))
						{
							...
							{
								if (__LIB_0__::func_724(Local_113[Local_388[iVar3 /*8*/].f_5 /*33*/], 2427.8506f, 4964.9717f, 43.1704f, 1) < 3f)
								{
									Local_388[iVar3 /*8*/].f_2 = 1;
									Local_388[iVar3 /*8*/].f_4++;
								}
			...
			case 24:
				...
				{
					case 0:
						if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2446.6738f, 4977.7876f, 57.4583f, 1) < 250f)
						{
							Local_388[iVar3 /*8*/].f_4++;
						}
						break;
					case 1:
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							...
							{
								if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2446.6738f, 4977.7876f, 57.4583f, 0) > 700f)
								{
									Local_388[iVar3 /*8*/].f_2 = 1;
								}
							}
				...
				break;
			case 26:
				if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2441.065f, 4968.8193f, 45.830746f, 1) < 2.75f)
				{
					if (!PED::IS_PED_INJURED(Local_113[15 /*33*/]))
					{
						if (__LIB_0__::func_724(Local_113[15 /*33*/], 2439.386f, 4962.0493f, 45.904697f, 1) < 3f)
						{
							Local_388[iVar3 /*8*/].f_2 = 1;
						}
					}
					if (!PED::IS_PED_INJURED(Local_113[16 /*33*/]))
					{
						if (__LIB_0__::func_724(Local_113[16 /*33*/], 2439.386f, 4962.0493f, 45.904697f, 1) < 3f)
						{
							Local_388[iVar3 /*8*/].f_2 = 1;
						}
					}
					if (!PED::IS_PED_INJURED(Local_113[17 /*33*/]))
					{
						if (__LIB_0__::func_724(Local_113[17 /*33*/], 2439.386f, 4962.0493f, 45.904697f, 1) < 3f)
						{
							Local_388[iVar3 /*8*/].f_2 = 1;
						}
					}
			...
			case 27:
				switch (Local_388[iVar3 /*8*/].f_4)
				{
					...
					case 1:
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_145, false))
						{
							if (__LIB_13__::func_784(ENTITY::GET_ENTITY_COORDS(iLocal_145, true), 5f, 150f))
							{
			...
			case 40:
				...
				break;
			case 42:
				if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2439.52f, 4969.67f, 52.65f, 1) > 42.5f)
				{
					Local_388[iVar3 /*8*/].f_2 = 1;
				}
				break;
			case 43:
				if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2439.52f, 4969.67f, 52.65f, 1) > 60f)
				{
					Local_388[iVar3 /*8*/].f_2 = 1;
				}
				break;
			...
			case 48:
				...
				if (!Local_388[iVar3 /*8*/].f_2)
				{
					if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2448.25f, 4974.92f, 55.11f, 1) > 300f)
					{
						Local_388[iVar3 /*8*/].f_2 = 1;
					}
				}
			...
			case 49:
				...
				if (!Local_388[iVar3 /*8*/].f_2)
				{
					if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2448.25f, 4974.92f, 55.11f, 1) > 500f)
					{
						Local_388[iVar3 /*8*/].f_2 = 1;
					}
				}
...
void func_181()//Position - 0x17867
{
	...
	if ((__LIB_0__::func_500() && iLocal_150 > 0) && MISC::GET_GAME_TIMER() > iLocal_159)
	{
	...
	switch (iLocal_150)
	{
		case 0:
			...
			func_87(1);
			HUD::CLEAR_PRINTS();
			__LIB_14__::func_592(2467.775f, 4954.4146f, 42.878033f, 2477.0889f, 4945.079f, 46.16654f, 4.0625f, 2486.8542f, 4939.086f, 43.2578f, 230f, 1, 1, 1, 0, 0);
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
	...
	if (bLocal_134)
	{
		...
		if (iLocal_139 == -1 || ((iLocal_139 != -1 && iLocal_139 < 4) && fLocal_138 > (Local_137[iLocal_139 /*18*/].f_13 / 1000f)))
		{
			...
			else if (!bLocal_132)
			{
				CAM::DESTROY_ALL_CAMS(false);
				CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);
				if (__LIB_7__::func_691() && !bLocal_165)
				{
...
void func_202()//Position - 0x18D9E
{
	...
	if ((((func_93(37) && func_93(38)) || iLocal_164) && func_175(13, 10) == 10) && !__LIB_15__::func_963("CHI2_light"))
	{
		func_203(1, 2, 40, 1, 0);
		if (HUD::DOES_BLIP_EXIST(iLocal_178))
		{
...
void func_207()//Position - 0x193FE
{
	...
	if (((__LIB_0__::func_500() && iLocal_150 > 0) && iLocal_150 < 7) && MISC::GET_GAME_TIMER() > iLocal_159)
	{
		iLocal_150 = 10;
		iLocal_158 = 0;
		bLocal_165 = true;
	...
	switch (iLocal_150)
	{
		case 0:
			if (STREAMING::IS_SRL_LOADED())
			{
				...
				iLocal_375 = 1;
				Var0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
				fVar1 = __LIB_6__::func_252(2458.2227f, 4986.0415f, 49.052414f, Var0, 1);
				if (fVar1 > 180f)
				{
					fVar1 = (fVar1 - 360f);
				}
				...
				{
					if (fVar1 < __LIB_0__::func_503(-2.5f) && fVar1 > __LIB_0__::func_503(0.5f))
					{
						iLocal_150 = 6;
				...
				else
				{
					...
					if (fVar1 < __LIB_0__::func_503(-1.33f) && fVar1 > __LIB_0__::func_503(-1.92f))
					{
						iLocal_150 = 1;
						SYSTEM::SETTIMERA(0);
					...
					else if (fVar1 < __LIB_0__::func_503(0.96f) && fVar1 > __LIB_0__::func_503(-1.33f))
					{
						iLocal_150 = 2;
					...
					else if (fVar1 < __LIB_0__::func_503(2.29f) && fVar1 > __LIB_0__::func_503(0.96f))
					{
						iLocal_150 = 3;
					...
					else if (fVar1 < __LIB_0__::func_503(-2.81f) || fVar1 > __LIB_0__::func_503(2.29f))
					{
						iLocal_150 = 4;
				...
				iLocal_376 = 1;
				CAM::DESTROY_ALL_CAMS(false);
				__LIB_13__::func_815(&Local_184, 1, 0);
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
				...
				{
					iLocal_378 = 1;
					__LIB_14__::func_614(2559.0122f, 4958.518f, 36.029594f, 2585.4468f, 4993.435f, 64.62565f, 48f, 2594.6506f, 4948.114f, 38.0899f, 283.7287f, 22f, 22f, 15f, 1, 1, 1, 0, 0);
					if (ENTITY::DOES_ENTITY_EXIST(iVar2))
					{
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar2, false))
						{
		...
		case 11:
			...
			if ((CAM::IS_SCREEN_FADED_OUT() && !CUTSCENE::IS_CUTSCENE_PLAYING()) || (CUTSCENE::IS_CUTSCENE_ACTIVE() && CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(true)))
			{
				...
				RECORDING::REPLAY_STOP_EVENT();
				if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2570.543f, 4982.002f, 50.6795f, 1) < 15f && __LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2570.543f, 4982.002f, 50.6795f, 1) > 1f)
				{
				...
				{
					ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), __LIB_6__::func_252(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2458.2227f, 4986.0415f, 49.052414f, 1));
				}
				CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
				...
				if (__LIB_40__::func_827(iLocal_147))
				{
	...
	else
	{
		switch (iLocal_150)
		{
			case 0:
				...
				break;
			case 1:
				if (__LIB_16__::func_37(&Local_184, 2608.1511f, 4949.754f, 39.4f, 9f, 9f, 2f, 1, "FRMCHSE_1", 1, 1, -1))
				{
			...
			case 2:
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					...
					if (__LIB_0__::func_213(iVar0, 10f, 2, 1056964608, 0, 1, 0))
					{
						if (func_225(5) > 2)
						{
							iLocal_150++;
				...
				break;
			case 3:
				if (__LIB_16__::func_37(&Local_184, 2573.6301f, 4983.677f, 50.6978f, 12f, 12f, 2f, 0, "FRMCHSE_5", 1, 1, -1))
				{
					if (AUDIO::IS_AUDIO_SCENE_ACTIVE("CHI_2_DRIVE_ROCK_RADIO"))
					{
						AUDIO::STOP_AUDIO_SCENE("CHI_2_DRIVE_ROCK_RADIO");
...
void func_272()//Position - 0x1E103
{
	...
	switch (iLocal_150)
	{
		case 0:
			...
			__LIB_0__::func_222(&uLocal_203, 0, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			__LIB_0__::func_222(&uLocal_203, 8, 0, "PED8", 0, 1);
			func_32(9, 1);
			func_32(29, 1);
			func_32(21, 1);
			func_379();
			...
			func_209(&Local_119, &uLocal_203, cLocal_131, 12f, 2482.1965f, 4975.3667f, 44.7288f, 121f, 1);
			__LIB_40__::func_831(&Local_120, "ONEILGUARD4", 5, "ONEILGUARD1");
			__LIB_40__::func_831(&Local_121, "ONEILGUARD4", 5, "ONEILGUARD1");
			__LIB_40__::func_831(&Local_125, "CHI2_nope", 8, "ONEILGUARD1");
			__LIB_40__::func_831(&Local_122, "SEETREVOR", 3, "chin2goon1");
			__LIB_40__::func_831(&Local_123, "CHI2_hear", 8, "ONEILGUARD1");
			__LIB_40__::func_831(&Local_124, "CHI2_hear", 8, "ONEILGUARD1");
			__LIB_40__::func_831(&Local_126, "ONEILGUARD3", 5, "ONEILGUARD1");
			__LIB_40__::func_831(&Local_127, "ONEILGUARD2", 5, "ONEILGUARD1");
			__LIB_40__::func_831(&Local_128, "ONEILGUARD4", 5, "ONEILGUARD1");
			__LIB_40__::func_831(&Local_129, "GOON2TREV", 4, "CHIN2goon2");
			func_32(6, 1);
			func_32(25, 1);
...
void func_273(int iParam0, bool bParam1, bool bParam2)//Position - 0x1F0DF
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			while (!__LIB_12__::func_754(&(Local_113[11 /*33*/]), 21, 1985.6656f, 3052.6606f, 46.2151f, 0, 1))
			{
				SYSTEM::WAIT(0);
			}
		...
		case 2:
			if (bParam1)
			{
				__LIB_0__::func_427(1992.8784f, 3057.8464f, 46.0568f, 311f, 1, 0);
			}
			else
			{
				if (__LIB_40__::func_827(iLocal_144))
			...
			if (bParam1)
			{
				if (__LIB_40__::func_827(iLocal_144))
				{
					__LIB_0__::func_433(iLocal_144, -1, 1);
				}
				else
				{
		...
		case 3:
			if (bParam1)
			{
				__LIB_0__::func_427(2574.0486f, 4981.8237f, 50.44f, 50f, 1, 0);
			}
			else
			{
			...
			while (!__LIB_0__::func_494(1, 0, 1))
			{
				func_28(6, 1);
			}
			func_15("CHN2_MISSION_START", 1, "CHN2_EXPLODE");
		...
		case 4:
			if (bParam1)
			{
				__LIB_0__::func_427(__LIB_38__::func_204(), __LIB_40__::func_829(), 1, 0);
			}
			else
			{
				ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 2570.543f, 4982.002f, 50.6795f, false, true, false, true);
			...
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(__LIB_38__::func_204(), 2570.5376f, 4982.0312f, 50.6239f, true) < 10f)
			{
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				__LIB_14__::func_808(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
			}
			break;
		case 5:
			STREAMING::SET_VEHICLE_POPULATION_BUDGET(1);
		...
		case 6:
			if (bParam1)
			{
				__LIB_0__::func_427(2450.8713f, 4960.9985f, 44.3759f, 351f, 1, 0);
			}
			else
			{
		...
		case 7:
			if (bParam1)
			{
				__LIB_0__::func_427(2435.3193f, 4966.153f, 41.3476f, 104.2964f, 1, 0);
			}
			else
			{
		...
		case 8:
			if (bParam1)
			{
				__LIB_0__::func_427(2453.124f, 4952.071f, 45.125f, 285f, 1, 0);
			}
			else
			{
		...
		case 9:
			if (bParam1)
			{
				__LIB_0__::func_427(2472.3f, 4948.1807f, 44.0937f, 220f, 1, 0);
			}
			else
			{
		...
		case 10:
			...
			if (bParam1)
			{
				__LIB_0__::func_427(2625.776f, 4802.2173f, 32.5747f, 206f, 1, 0);
			}
			else
			{
...
void func_285(bool bParam0, bool bParam1, bool bParam2)//Position - 0x201E9
{
	if (bParam0)
	{
		...
		{
			if (__LIB_14__::func_660(__LIB_16__::func_848(), 10f, 20f, 9f, 1))
			{
				__LIB_16__::func_869();
				while (!__LIB_16__::func_868())
				{
					func_28(54455, 1);
				}
				if (bParam2)
				{
					iLocal_144 = __LIB_17__::func_771(1994.3872f, 3061.9397f, 46.0491f, 50f);
				}
				else
				{
					iLocal_144 = __LIB_17__::func_771(0f, 0f, 0f, 0f);
				}
			}
		}
	}
	else if (__LIB_13__::func_821())
	{
		__LIB_14__::func_532();
		...
		iLocal_144 = __LIB_14__::func_616(0f, 0f, 0f, 0f);
	}
	if (bParam1)
	{
		if (func_278())
...
void func_371(int iParam0)//Position - 0x280AE
{
	...
	{
		if (__LIB_40__::func_827(iLocal_146))
		{
...
void func_380()//Position - 0x28BC6
{
	switch (iLocal_575)
	{
		case 0:
			if (iLocal_149 >= 4)
			{
				__LIB_14__::func_874(1, "Snipe from hill", 0, 0, 0, 1);
				iLocal_575++;
			}
			break;
		case 1:
			if (iLocal_149 >= 4 && iLocal_149 < 7)
			{
				...
				{
					__LIB_14__::func_874(2, "Inside House", 0, 0, 0, 1);
					iLocal_575++;
				}
			}
		...
		case 2:
			if (iLocal_149 >= 7)
			{
				__LIB_14__::func_874(3, "Pour petrol trail", 0, 0, 0, 1);
				iLocal_575++;
			}
			break;
		case 3:
			if (iLocal_149 == 9)
			{
				__LIB_14__::func_874(4, "Leave the farm house", 1, 0, 0, 1);
				iLocal_575++;
			}
			break;
	}
...
void func_454(int iParam0)//Position - 0x30F37
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) != 0)
		{
			if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), 2444.0984f, 4977.795f, 48.9959f, 1) < 100f)
			{
	...
	if (iParam0 == 1 || iParam0 == 2)
	{
		...
		__LIB_0__::func_544(52, 0, 0, 1, 0);
		__LIB_0__::func_544(53, 0, 0, 1, 0);
		__LIB_0__::func_544(54, 0, 0, 1, 0);
		__LIB_0__::func_544(55, 0, 0, 1, 0);
	}
