	...
	while (true)
	{
		...
		if (func_175())
		{
			...
			if (iLocal_39 > 3)
			{
				if (fLocal_31 < 600f)
				{
					if (__LIB_0__::func_540(0) == 0 && (MISC::GET_GAME_TIMER() - iLocal_59) > 2000)
					{
		...
		else
		{
			if (!bLocal_38)
			{
				if (__LIB_15__::func_276(105))
				{
					__LIB_14__::func_622(105, 0, 0);
			...
			if (!bLocal_38)
			{
				if (__LIB_15__::func_276(106))
				{
					__LIB_14__::func_622(106, 0, 0);
...
{
	__LIB_14__::func_591(&(Global_103950.f_2890), &Global_103950, 0, 1, 1, 0);
}
...
void func_31(int iParam0)//Position - 0x14D4
{
	...
	if (iLocal_43 != 9)
	{
		if (!Global_113386.f_19983.f_13)
		{
			...
			{
				if (!__LIB_0__::func_703(Global_113386.f_19983, 32))
				{
					__LIB_0__::func_697("MG_TRAF_AVAIL" /* GXT: Trevor can now do air and ground trafficking missions, available at ~BLIP_ARMS_DEALING_AIR~ and ~BLIP_ARMS_DEALING~ */, 0, 0, -1, 10000, 7, 0, 0, 0);
					__LIB_1__::func_330(&(Global_113386.f_19983), 32);
				}
			}
			__LIB_14__::func_622(106, 1, 0);
	...
	switch (iLocal_43)
	{
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Ground"))
			{
				...
				{
					iVar3 = __LIB_15__::func_282(&iLocal_33, 6, 9, 0, 0);
					iLocal_37 = 1;
				}
				if (iVar3 == 1)
				{
		...
		case 7:
			...
			{
				iLocal_43 = 9;
				if (__LIB_0__::func_703(Global_112037, 2))
				{
					iLocal_43 = 8;
				}
				else
				{
					__LIB_15__::func_281(&iLocal_33);
					__LIB_14__::func_860();
					iLocal_34 = 1;
					iVar5 = __LIB_11__::func_762();
					__LIB_13__::func_827(&iVar5, 0, 0, 3, 0, 0, 0);
					Global_113386.f_19983.f_12 = iVar5;
					__LIB_14__::func_622(106, 0, 0);
					Global_113386.f_19983.f_13 = 0;
				}
				*iParam0 = 0;
				__LIB_2__::func_712(&Global_112037, 2);
			}
			break;
		case 8:
			if (Global_100441 == 10)
			...
			break;
		case 9:
			if (fLocal_31 >= 50625f && __LIB_14__::func_793(Global_113386.f_19983.f_12))
			{
				func_165(0);
				iLocal_43 = 1;
			}
...
void func_173(int iParam0)//Position - 0xF49E
{
	...
	switch (iLocal_39)
	{
		...
		case 3:
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("cuban800")))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_40))
				{
					...
					__LIB_1__::func_330(&(Global_113386.f_19983), 128);
					iLocal_39 = 4;
				}
				else
				{
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_30))
			{
				if (__LIB_0__::func_703(Global_112037, 1))
				{
					iLocal_39 = 8;
				}
				else
				{
					__LIB_15__::func_281(&iLocal_33);
					__LIB_14__::func_860();
					uVar4 = __LIB_11__::func_762();
					__LIB_13__::func_827(&uVar4, 0, 0, 3, 0, 0, 0);
				...
				*iParam0 = 0;
				__LIB_2__::func_712(&Global_112037, 1);
			}
			break;
		case 8:
			if (Global_100441 == 10)
			...
			break;
		case 9:
			if (fLocal_31 >= 50625f && __LIB_14__::func_793(Global_113386.f_19983.f_11))
			{
				func_174(0);
				iLocal_39 = 1;
			}
...
void func_174(bool bParam0)//Position - 0xF9EB
{
	...
	if (__LIB_0__::func_703(Global_113386.f_19983, 128))
	{
		__LIB_2__::func_712(&(Global_113386.f_19983), 128);
	}
	iLocal_41 = 0;
}
