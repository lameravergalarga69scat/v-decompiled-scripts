...
void __EntryFunction__()//Position - 0x0
{
	...
	__LIB_9__::func_408(&Local_41, 2);
	Local_41.f_4 = 3;
	MISC::CLEAR_AREA_OF_VEHICLES(Local_40, 5f, false, false, false, false, false, false, 0);
	__LIB_14__::func_827(&Local_61, -691.9059f, 515.8249f, 108.61385f, -684.06055f, 493.01712f, 110.850395f, 8.25f);
	...
	__LIB_14__::func_822(-688.5f, 503.7f, 110.2f, 30f, &Var0, &Var1);
	...
	while (true)
	{
		...
		if (MISC::GET_MISSION_FLAG() || __LIB_0__::func_683() != 0)
		{
			func_70();
		}
		switch (iLocal_46)
		...
		if (func_48(&Local_41))
		{
			if (func_42(&Local_41))
			{
				...
				__LIB_0__::func_210();
				__LIB_0__::func_222(&uLocal_65, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
				__LIB_0__::func_787(&uLocal_65, "EPS3AUD", "EP3_MCS1", 6, 0, 0, 0);
...
int func_42(var uParam0)//Position - 0x1ECF
{
	...
	while (iVar0 < iVar1)
	{
		if (__LIB_0__::func_715(uVar3[iVar0]))
		{
		...
		case 2:
			switch (iLocal_50)
			{
				case 0:
					...
					if (__LIB_0__::func_715(iVar0) && VEHICLE::GET_VEHICLE_NUMBER_OF_PASSENGERS(iVar0, false, true) > 0)
					{
					...
					if (!Local_41.f_26)
					{
						if (iLocal_56 == 0)
						{
							if (__LIB_0__::func_695(iVar0))
							{
								...
								{
									__LIB_0__::func_229("EPS_DROP_EXIT" /* GXT: Exit the vehicle. */, 7500, 1);
									iLocal_58 = 0;
									iLocal_56 = 1;
									iLocal_55 = 0;
								}
						...
						if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), Local_41.f_14, 0) < 3f)
						{
							__LIB_0__::func_714(&iLocal_44);
						}
						if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), Local_41, 0) > (15f + 5f))
						{
							__LIB_9__::func_408(&Local_41, 2);
							Local_41.f_4 = 3;
							iLocal_56 = 0;
...
void func_67(int iParam0)//Position - 0x307E
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			...
			if (__LIB_0__::func_724(PLAYER::PLAYER_PED_ID(), Local_41, 0) < 15f)
			{
				*iParam0 = 4;
				return;
			}
...
{
	func_72();
	while (MISC::GET_MISSION_FLAG() || __LIB_0__::func_683() != 0)
	{
		SYSTEM::WAIT(0);
	}
	func_71();
...
{
	__LIB_0__::func_364(44, bParam0);
	__LIB_0__::func_364(45, bParam0);
	__LIB_0__::func_364(46, bParam0);
	__LIB_0__::func_364(47, bParam0);
	__LIB_0__::func_364(48, bParam0);
	__LIB_0__::func_364(49, bParam0);
	__LIB_0__::func_364(50, bParam0);
}
...
void func_90(var uParam0, int iParam1, struct<3> Param2, struct<3> Param3, struct<3> Param4, struct<3> Param5, float fParam6, struct<3> Param7, struct<3> Param8)//Position - 0x37D7
{
	...
	*uParam0 = { Param2 };
	...
	uParam0->f_14 = { Param3 };
	__LIB_14__::func_827(&(uParam0->f_6), Param4, Param5, fParam6);
}
...
void func_96()//Position - 0x39AA
{
	...
	func_73(&Local_41);
	Global_113386.f_10049.f_103 = iLocal_51;
	if (func_92() || __LIB_0__::func_425(90) == 1)
	{
		__LIB_0__::func_681(90, 1);
		__LIB_0__::func_693(6);
	}
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(-683.4503f, 492.99225f, 108.873665f, -688.8357f, 506.99966f, 112.19278f, 11.25f, 1);
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(Local_61[0 /*3*/], Local_61[1 /*3*/], 8.25f, 1);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_64, false);
