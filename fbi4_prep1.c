...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		__LIB_0__::func_427(918.8851f, -269.789f, 67.2145f, 68.2149f, 1, 0);
	}
	__LIB_17__::func_541();
	while (true)
	{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (__LIB_0__::func_695(iVar0) && ENTITY::GET_ENTITY_MODEL(iVar0) == joaat("towtruck"))
				{
					__LIB_0__::func_679(iVar0, 2);
				}
			}
...
{
	__LIB_8__::func_397(&Local_199);
	__LIB_8__::func_397(&iLocal_201);
	__LIB_8__::func_397(&iLocal_200);
	__LIB_0__::func_0(&Local_197);
	__LIB_0__::func_0(&Local_198);
	__LIB_8__::func_397(&iLocal_202);
	func_3();
}

void func_3()//Position - 0x274
{
	__LIB_0__::func_714(&(Local_45[0 /*11*/].f_4));
	__LIB_0__::func_714(&(Local_45[1 /*11*/].f_4));
...
{
	__LIB_0__::func_507(918.8851f, -269.789f, 67.2145f, 325.9081f);
	__LIB_14__::func_555(917.5291f, -263.8595f, 67.3489f, 188.0605f);
}
...
void func_39()//Position - 0x1626
{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			break;
		case 1:
			if (!__LIB_0__::func_725(PLAYER::PLAYER_PED_ID(), Local_186, 270f, 1))
			{
				iLocal_69 = 2;
			}
			else if (!__LIB_0__::func_501("PRA_LEVAREA", 0, 0))
			{
				__LIB_0__::func_229("PRA_LEVAREA", 60000, 0);
			}
			break;
		case 2:
			bVar0 = __LIB_0__::func_683();
			if (__LIB_0__::func_501("PRA_LEVAREA", 0, 0))
			{
				HUD::CLEAR_PRINTS();
			}
			if (bVar0 == 0)
			{
				if (__LIB_33__::func_560(&uLocal_72, &cLocal_370, &uLocal_205))
				{
					func_63();
					func_58();
				}
			...
			{
				__LIB_17__::func_535(func_57(bVar0), -621899663, -621899663, 5, 0, bVar0, __LIB_17__::func_522(bVar0), 0, 6000, 6000, -1, 0, 0);
				func_63();
				func_58();
			}
			break;
...
void func_63()//Position - 0x1F25
{
	...
	__LIB_0__::func_377(0, 318);
	__LIB_0__::func_498(1, 320);
}

void func_108()//Position - 0x317F
{
	__LIB_33__::func_630(&iLocal_200, &iLocal_201, &iLocal_71, &iLocal_183, &iLocal_182, Local_186, Local_199.f_0, 0, 1090519040);
	func_214();
	func_155();
	switch (iLocal_69)
	{
		case 0:
			if (func_122(iLocal_68, bLocal_28))
			{
				...
				{
					if (__LIB_0__::func_695(iLocal_200))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_200, false))
						{
							__LIB_17__::func_528("PRA_LEVVEH", &iLocal_181);
						}
					}
				}
				iLocal_69 = 1;
			...
			break;
		case 1:
			__LIB_17__::func_764(&iLocal_182, Local_186, &iLocal_70, iLocal_71, &iLocal_181, &iLocal_195);
			if (__LIB_17__::func_774(iLocal_200, Local_186, &iLocal_182, iLocal_71, iLocal_70, &iLocal_193, &iLocal_196, &iLocal_192, &iLocal_191, &iLocal_181, 1090519040))
			{
				if (!__LIB_33__::func_558())
				{
					if (__LIB_33__::func_560(&uLocal_72, &cLocal_370, &uLocal_205))
					{
						func_63();
			...
			break;
		case 3:
			if (__LIB_0__::func_695(Local_199.f_0))
			{
				...
				{
					__LIB_14__::func_659(Local_199.f_0, Local_186, 126.0705f, 0, 1);
					__LIB_17__::func_398(1, 1, 1);
					iLocal_69 = 1;
				}
			}
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_149(1, Local_185, 0))
			{
				if (func_148())
				{
					...
					iLocal_68 = 2;
					__LIB_0__::func_714(&iLocal_182);
					__LIB_0__::func_345(&uLocal_56, 0, 0);
					__LIB_37__::func_736(190, 1244.338f, -339.3197f, 68.0823f);
					func_142();
				...
				else if (((func_149(2, Local_199.f_1, Local_199.f_4) && func_149(3, Local_197.f_1, Local_197.f_4)) && func_149(4, Local_198.f_1, Local_198.f_4)) && func_141(0))
				{
					func_142();
					__LIB_0__::func_468(33);
					if (__LIB_0__::func_692(Local_197.f_0))
					{
						func_140(Local_197.f_0);
					}
					if (__LIB_0__::func_692(Local_198.f_0))
					{
						func_139(Local_198.f_0);
					}
					func_138(Local_199.f_0);
					if (__LIB_0__::func_692(Local_198.f_0) && __LIB_0__::func_692(Local_197.f_0))
					{
					...
					__LIB_17__::func_538(&iLocal_182, Local_199.f_0, 1);
					__LIB_37__::func_736(190, 1244.338f, -339.3197f, 68.0823f);
					TASK::SET_SCENARIO_TYPE_ENABLED("DRIVE", false);
					TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_ATTRACTOR", false);
					TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_PASSENGERS", false);
		...
		case 1:
			if (bParam1)
			{
				...
				{
					__LIB_17__::func_517(PLAYER::PLAYER_PED_ID(), 1197.8611f, -353.011f, 68.0929f, 278.9647f);
					func_123();
					bLocal_28 = false;
					TASK::SET_SCENARIO_TYPE_ENABLED("DRIVE", false);
					TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_ATTRACTOR", false);
...
int func_132()//Position - 0x3F3B
{
	...
	float fVar7;
	int iVar8;
	if (__LIB_0__::func_695(iLocal_43))
	{
		...
		fVar7 = __LIB_0__::func_158(Local_46[iVar0 /*25*/] - Var1, ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_43));
		iVar3 = iVar0;
		iVar8 = 0;
		while (fVar7 < 0f && iVar8 < 40)
		{
			...
			Var1 = { ENTITY::GET_ENTITY_COORDS(iLocal_43, true) };
			fVar7 = __LIB_0__::func_158(Local_46[iVar3 /*25*/] - Var1, ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_43));
			iVar8++;
		}
		if (iVar8 >= 40)
		{
...
{
	__LIB_17__::func_545(&uLocal_205);
}
...
int func_149(int iParam0, struct<3> Param1, float fParam2)//Position - 0x456F
{
	...
	{
		case 0:
			if (__LIB_0__::func_490(Param1, Local_185, 1056964608, 0) && fParam2 == 0f)
			{
				return 1;
			}
			break;
		...
		case 2:
			if (__LIB_0__::func_695(Global_96938[0]))
			{
				...
				if (__LIB_0__::func_695(Local_199.f_0))
				{
					__LIB_0__::func_679(Local_199.f_0, 0);
			...
			else if (__LIB_17__::func_762(&Local_199, Local_199.f_5, Local_199.f_1, Local_199.f_4, 1))
			{
				__LIB_0__::func_679(Local_199.f_0, 0);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(Local_199.f_0, true);
				ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(Local_199.f_0, true);
		...
		case 3:
			...
			else if (__LIB_33__::func_559(&Local_197, Local_197.f_5, Local_197.f_1, Local_197.f_4, 1, 0, 1, 1))
			{
				if (__LIB_0__::func_695(Local_199.f_0))
				{
		...
		case 4:
			...
			else if (__LIB_33__::func_559(&Local_198, Local_198.f_5, Local_198.f_1, Local_198.f_4, 1, 0, 1, 1))
			{
				if (__LIB_0__::func_695(Local_199.f_0))
				{
...
void func_156(int* iParam0, int iParam1)//Position - 0x4A69
{
	...
	else
	{
		...
		__LIB_0__::func_714(&(iParam0->f_4));
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), *iParam0, 150f, 1) && !bLocal_52)
			{
...
void func_158(int* iParam0)//Position - 0x4C09
{
	...
	switch (iParam0->f_6)
	{
		case 5:
			...
			{
				if (__LIB_6__::func_572(*iParam0, joaat("SCRIPT_TASK_COMBAT")))
				{
		...
		case 21:
			...
			{
				if (__LIB_17__::func_768(*iParam0, PLAYER::PLAYER_PED_ID(), 1126825984, 1, 250, 7))
				{
					func_176(iParam0, 1);
					return;
				}
			...
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_3)
			{
				...
				{
					iParam0->f_4 = __LIB_0__::func_666(*iParam0, 1, 145);
				}
				iParam0->f_6 = 22;
				iParam0->f_1 = MISC::GET_GAME_TIMER();
			}
		...
		case 10:
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_3)
			{
				...
				else if (!__LIB_6__::func_572(*iParam0, joaat("SCRIPT_TASK_COWER")))
				{
					if (__LIB_6__::func_572(*iParam0, joaat("SCRIPT_TASK_COMBAT")))
					{
						TASK::CLEAR_PED_TASKS(*iParam0);
		...
		case 11:
			...
			{
				if (!__LIB_6__::func_572(*iParam0, joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")))
				{
					if (ENTITY::DOES_ENTITY_EXIST(Local_45[__LIB_17__::func_512(iParam0->f_10) /*11*/]))
					{
			...
			break;
		case 18:
			if (!__LIB_6__::func_572(*iParam0, joaat("SCRIPT_TASK_PLAY_ANIM")))
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar1);
				if (__LIB_0__::func_932(ENTITY::GET_ENTITY_COORDS(*iParam0, true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) > 1.5f)
				{
		...
		case 6:
			...
			{
				if (!__LIB_0__::func_687(*iParam0, PLAYER::PLAYER_PED_ID(), 15f, 1))
				{
					__LIB_0__::func_714(&(iParam0->f_4));
					iParam0->f_6 = 7;
					iParam0->f_1 = MISC::GET_GAME_TIMER();
		...
		case 7:
			if (PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, true))
			{
				...
				if (!__LIB_0__::func_687(*iParam0, PLAYER::PLAYER_PED_ID(), 120f, 1))
				{
					__LIB_0__::func_124(iParam0, 1, 0, 1);
				}
			}
		...
		case 9:
			...
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) > iParam0->f_2 || !__LIB_6__::func_572(*iParam0, joaat("SCRIPT_TASK_DRIVE_BY")))
			{
				func_163(iParam0);
			}
			break;
		...
		case 13:
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) >= iParam0->f_2)
			{
				...
				else if (__LIB_17__::func_768(Local_45[__LIB_17__::func_512(iParam0->f_10) /*11*/], *iParam0, 1126825984, 1, 250, 7))
				{
					func_176(iParam0, 0);
				}
				else
		...
		case 20:
			...
			if ((MISC::GET_GAME_TIMER() - iParam0->f_1) >= 6000)
			{
				...
				{
					func_168(iParam0);
					func_168(&(Local_45[__LIB_17__::func_512(iParam0->f_10) /*11*/]));
				}
				iParam0->f_1 = MISC::GET_GAME_TIMER();
			}
			func_172(iParam0);
		...
		case 23:
			...
			func_172(iParam0);
			if (__LIB_0__::func_725(*iParam0, Local_54, 2f, 1))
			{
				if (__LIB_14__::func_711(*iParam0, Local_54, 1126825984, 0))
				{
					TASK::CLEAR_PED_TASKS(*iParam0);
					iParam0->f_6 = 19;
					iParam0->f_5 = 1;
...
void func_163(int* iParam0)//Position - 0x56AB
{
	...
	switch (iParam0->f_8)
	{
		...
		case 8:
			...
			break;
		case 3:
			if (!__LIB_6__::func_572(*iParam0, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
			{
				if (iLocal_48 <= 20 && iLocal_48 != -1)
				{
					Local_46[iLocal_48 /*25*/].f_18 = 1;
...
{
	if (!__LIB_6__::func_572(*uParam0, joaat("SCRIPT_TASK_PUT_PED_DIRECTLY_INTO_MELEE")))
	{
		...
		{
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_46[iLocal_48 /*25*/].f_19, 1f, 20000, -1f, 0, __LIB_6__::func_252(Local_46[iLocal_48 /*25*/].f_19, ENTITY::GET_ENTITY_COORDS(*uParam0, true), 1));
		}
		if (__LIB_0__::func_695(iLocal_43))
		{
...
{
	if (__LIB_0__::func_695(iLocal_43) && __LIB_0__::func_692(PLAYER::PLAYER_PED_ID()))
	{
...
{
	if (__LIB_0__::func_695(iLocal_43) && (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_43, false) && !PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, false)))
	{
...
void func_176(int* iParam0, int iParam1)//Position - 0x5C7F
{
	...
	{
		if (!__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), *iParam0, 10f, 1))
		{
			if (!__LIB_6__::func_572(*iParam0, joaat("SCRIPT_TASK_SMART_FLEE_PED")))
			{
				iParam0->f_6 = 5;
				iParam0->f_5 = 1;
				iParam0->f_1 = MISC::GET_GAME_TIMER();
	...
	{
		if (!__LIB_6__::func_572(*iParam0, joaat("SCRIPT_TASK_COMBAT")) && !__LIB_6__::func_572(*iParam0, joaat("SCRIPT_TASK_PUT_PED_DIRECTLY_INTO_MELEE")))
		{
			iParam0->f_5 = 1;
			iParam0->f_6 = 21;
			iParam0->f_1 = MISC::GET_GAME_TIMER();
...
void func_185(var uParam0)//Position - 0x6155
{
	...
	switch (uParam0->f_7)
	{
		...
		case 2:
			...
			{
				if (!__LIB_6__::func_572(*uParam0, joaat("SCRIPT_TASK_ENTER_VEHICLE")))
				{
					if (uParam0->f_10 == 0)
					{
						func_130(0);
		...
		case 3:
			...
			if (bLocal_51)
			{
				if (iLocal_48 <= 20 && iLocal_48 != -1)
				{
					if (!Local_46[iLocal_48 /*25*/].f_18)
					{
						if (__LIB_0__::func_725(*uParam0, Local_46[iLocal_48 /*25*/], 20f, 1))
						{
			...
			break;
		case 4:
			if (__LIB_0__::func_725(*uParam0, Local_46[iLocal_48 /*25*/], 25f, 1))
			{
		...
		case 5:
			...
			break;
		case 6:
			if (!__LIB_6__::func_572(*uParam0, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) && VEHICLE::IS_VEHICLE_STOPPED(iLocal_43))
			{
				if (bLocal_51)
				{
					uParam0->f_8 = uParam0->f_7;
			...
			break;
		case 7:
			if (__LIB_0__::func_692(Local_45[1 /*11*/]))
			{
...
void func_186(var uParam0)//Position - 0x63C0
{
	...
	{
		case 1:
			if (!__LIB_6__::func_572(*uParam0, joaat("SCRIPT_TASK_GOTO_ENTITY_OFFSET")))
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
				if (__LIB_0__::func_932(ENTITY::GET_ENTITY_COORDS(*uParam0, true), Local_46[iLocal_48 /*25*/].f_19) > 1.5f)
				{
			...
			break;
		case 2:
			if (__LIB_6__::func_572(*uParam0, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
			{
			...
			else if (!__LIB_6__::func_572(*uParam0, joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")))
			{
				if (__LIB_0__::func_695(iLocal_43))
				{
		...
		case 3:
			if (__LIB_0__::func_695(iLocal_43))
			{
				if (!func_191(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 0f, -5.5f, 0f), iLocal_43, 1.9f, 1.9f, 8f))
				{
					...
					{
						if (!__LIB_6__::func_572(*uParam0, joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")))
						{
							TASK::OPEN_SEQUENCE_TASK(&iVar1);
							if (__LIB_0__::func_932(ENTITY::GET_ENTITY_COORDS(*uParam0, true), ENTITY::GET_ENTITY_COORDS(iLocal_43, true)) > 3f)
							{
...
void func_188(var uParam0)//Position - 0x6830
{
	...
	{
		uParam0->f_4 = __LIB_0__::func_666(*uParam0, 1, 145);
	}
...
void func_196(var uParam0, bool bParam1)//Position - 0x6C74
{
	...
	if (func_191(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(bParam1)), iLocal_43, 1.9f, 1.9f, 8f))
	{
		...
		else if (!__LIB_6__::func_572(*uParam0, joaat("SCRIPT_TASK_GO_TO_ENTITY")) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, 5f, 0f, -2f), ENTITY::GET_ENTITY_COORDS(iLocal_43, true) + Vector(2f, 0f, 0f), 9f, false, true, 0))
		{
			TASK::CLEAR_PED_TASKS(*uParam0);
			TASK::TASK_GO_TO_ENTITY(*uParam0, PLAYER::PLAYER_PED_ID(), -1, 4f, 1f, 2f, 0);
		}
	}
	else if (__LIB_0__::func_725(*uParam0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_43, func_137(bParam1)), 5f, 1))
	{
		iVar0 = -1;
		if (!bParam1)
		{
...
void func_198(var uParam0)//Position - 0x6E77
{
	if (uParam0->f_5 != 1)
	{
		if (__LIB_0__::func_695(iLocal_43) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (!__LIB_6__::func_572(*uParam0, joaat("SCRIPT_TASK_DRIVE_BY")) && PED::IS_PED_IN_VEHICLE(*uParam0, iLocal_43, false))
			{
				if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), iLocal_43, 10f, 1))
				{
...
void func_199()//Position - 0x6F07
{
	...
	while (iVar0 <= (iLocal_41 - 1))
	{
		if (Local_46[iVar0 /*25*/].f_23 != 0)
		{
			...
			{
				if (__LIB_0__::func_725(PLAYER::PLAYER_PED_ID(), Local_46[iVar0 /*25*/], 100f, 1) || __LIB_0__::func_725(Local_45[0 /*11*/], Local_46[iVar0 /*25*/], 120f, 1))
				{
...
int func_200(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x6FFA
{
	...
	{
		if (__LIB_17__::func_530(iParam1, "Loading", 0))
		{
...
void func_202(int* iParam0, int iParam1, int iParam2)//Position - 0x70C5
{
	...
	{
		if (!__LIB_0__::func_692(Local_45[__LIB_17__::func_512(iParam1) /*11*/]))
		{
			if (!bLocal_52)
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_45[__LIB_17__::func_512(iParam1) /*11*/]))
				{
					if (__LIB_14__::func_736(*iParam0, Local_45[__LIB_17__::func_512(iParam1) /*11*/], 140f, 0) || __LIB_0__::func_687(Local_45[__LIB_17__::func_512(iParam1) /*11*/], *iParam0, 3f, 1))
					{
						func_176(iParam0, 0);
						bLocal_52 = true;
						return;
					...
					{
						Local_54 = { ENTITY::GET_ENTITY_COORDS(Local_45[__LIB_17__::func_512(iParam1) /*11*/], true) };
						iParam0->f_1 = MISC::GET_GAME_TIMER();
						iParam0->f_8 = iParam0->f_7;
						iParam0->f_5 = 1;
						iParam0->f_6 = 11;
		...
		else if (Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_6 == 22)
		{
			if (__LIB_14__::func_736(*iParam0, Local_45[__LIB_17__::func_512(iParam1) /*11*/], 140f, 0) && __LIB_0__::func_687(Local_45[__LIB_17__::func_512(iParam1) /*11*/], PLAYER::PLAYER_PED_ID(), 15f, 1))
			{
				iParam0->f_5 = 1;
				iParam0->f_6 = 21;
			}
		}
		else if (Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_6 == 5 || Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_6 == 7)
		{
			if (__LIB_0__::func_687(Local_45[__LIB_17__::func_512(iParam1) /*11*/], *iParam0, 10f, 1))
			{
				func_176(iParam0, 0);
			}
		}
		...
		if (__LIB_38__::func_619(*iParam0, 1, 70f, 170f, 0, 1, 0, 0) && !func_203(iParam0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				if (__LIB_0__::func_695(iLocal_43))
				{
					if (PED::IS_PED_IN_VEHICLE(*iParam0, iLocal_43, false))
					{
						if (ENTITY::GET_ENTITY_SPEED(iLocal_43) > 5f)
						{
							if (iParam1 == 0)
							{
								...
								iParam0->f_6 = 7;
								TASK::TASK_COWER(Local_45[__LIB_17__::func_512(iParam1) /*11*/], -1);
								Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_6 = 10;
								Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_5 = 1;
								iParam0->f_5 = 1;
								iParam0->f_1 = MISC::GET_GAME_TIMER();
								Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_1 = MISC::GET_GAME_TIMER();
							}
							else
							{
								TASK::TASK_COWER(*iParam0, -1);
								iParam0->f_6 = 12;
								TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_45[__LIB_17__::func_512(iParam1) /*11*/], iLocal_43, PLAYER::PLAYER_PED_ID(), 8, 30f, 786469, 300f, 2f, true);
								Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_6 = 5;
								Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_5 = 1;
								iParam0->f_5 = 1;
								iParam0->f_1 = MISC::GET_GAME_TIMER();
								Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_1 = MISC::GET_GAME_TIMER();
						...
						else
						{
							...
							if (ENTITY::DOES_ENTITY_EXIST(Local_45[__LIB_17__::func_512(iParam1) /*11*/]))
							{
								if (__LIB_14__::func_736(Local_45[__LIB_17__::func_512(iParam1) /*11*/], PLAYER::PLAYER_PED_ID(), 1126825984, 0))
								{
									func_176(&(Local_45[__LIB_17__::func_512(iParam1) /*11*/]), 0);
								}
							}
						}
					...
					else
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(Local_45[__LIB_17__::func_512(iParam1) /*11*/]))
						{
							if (__LIB_17__::func_768(Local_45[__LIB_17__::func_512(iParam1) /*11*/], *iParam0, 1126825984, 1, 250, 7))
							{
								func_176(&(Local_45[__LIB_17__::func_512(iParam1) /*11*/]), 0);
							}
						}
			...
			else
			{
				...
				{
					Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_1 = MISC::GET_GAME_TIMER();
					Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_8 = iParam0->f_7;
					Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_5 = 1;
					Local_45[__LIB_17__::func_512(iParam1) /*11*/].f_6 = 21;
					ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(Local_45[__LIB_17__::func_512(iParam1) /*11*/]);
				}
			}
			iParam0->f_5 = 1;
		}
	...
	if (iParam0->f_5 != 1)
	{
		if (__LIB_0__::func_692(Local_45[__LIB_17__::func_512(iParam1) /*11*/]))
		{
			if (PED::IS_PED_BEING_JACKED(Local_45[__LIB_17__::func_512(iParam1) /*11*/]))
			{
				func_169(iParam0);
...
{
	if (__LIB_0__::func_687(iParam0, PLAYER::PLAYER_PED_ID(), 6f, 1))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(iParam0, false))
		{
...
void func_214()//Position - 0x7B05
{
	if (__LIB_0__::func_695(Local_199.f_0))
	{
		if (__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), Local_199.f_0, 100f, 1) && !iLocal_194)
		{
		...
		else if (!__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), Local_199.f_0, 120f, 1) && iLocal_194)
		{
	...
	switch (iLocal_69)
	{
		case 0:
			if (func_122(iLocal_68, bLocal_28))
			{
				...
				{
					__LIB_17__::func_537(&iLocal_182, Local_186, 1);
					__LIB_17__::func_528("PRA_TAKBACK", &iLocal_181);
				}
				iLocal_69 = 1;
			}
			break;
		case 1:
			__LIB_17__::func_764(&iLocal_182, Local_186, &iLocal_70, iLocal_71, &iLocal_181, &iLocal_195);
			func_227();
			if (__LIB_17__::func_767(iLocal_200, Local_186, &iLocal_182, iLocal_70, iLocal_71, &iLocal_181, &iLocal_196, 0, 0, 1086324736))
			{
		...
		case 3:
			if (__LIB_0__::func_695(iLocal_200))
			{
				...
				{
					__LIB_14__::func_659(iLocal_200, Local_186, 146.5443f, 0, 1);
					__LIB_17__::func_398(1, 1, 1);
					iLocal_69 = 1;
				}
			}
...
void func_227()//Position - 0x8302
{
	...
	while (iVar0 < 3)
	{
		iVar2 = __LIB_16__::func_911(iVar0);
		if (!PED::IS_PED_INJURED(iVar2))
		{
			if (__LIB_17__::func_521(iVar2, 0))
			{
				if (!bVar1)
				{
				...
				if (!iLocal_374[iVar0])
				{
					if (iVar0 == 0)
					{
						__LIB_0__::func_222(&uLocal_205, iVar0, iVar2, "MICHAEL", 0, 1);
					}
					else if (iVar0 == 1)
					{
						__LIB_0__::func_222(&uLocal_205, iVar0, iVar2, "FRANKLIN", 0, 1);
					}
					else if (iVar0 == 2)
					{
						__LIB_0__::func_222(&uLocal_205, iVar0, iVar2, "TREVOR", 0, 1);
					}
					iLocal_374[iVar0] = 1;
				}
			}
			if (!__LIB_17__::func_547(iVar2))
			{
				if (__LIB_17__::func_521(iVar2, 0))
				{
					if (func_231(iVar2) || func_229(iVar2))
					{
						if (__LIB_17__::func_548(iVar2, 0))
						{
			...
			else if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iVar2, true))
			{
				...
				else if (func_229(iVar2))
				{
					if (__LIB_0__::func_695(Local_199.f_0))
					{
						if (!__LIB_0__::func_687(iVar2, Local_199.f_0, 17f, 1))
						{
							if (TASK::GET_SCRIPT_TASK_STATUS(iVar2, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iVar2, joaat("SCRIPT_TASK_VEHICLE_MISSION")) != 0)
							{
	...
	if (iLocal_68 > 1)
	{
		if (iLocal_70 > 0)
		{
			if (!BitTest(Local_73[iParam0 /*8*/].f_7, 0) && iLocal_71 == 1)
			{
				...
				{
					if (__LIB_2__::func_859(&uLocal_205, cLocal_204, Local_73[iParam0 /*8*/][0], 8, 0, 0, 0))
					{
		...
		else
		{
			if ((BitTest(Local_73[iParam0 /*8*/].f_7, 0) && !BitTest(Local_73[iParam0 /*8*/].f_7, 1)) && iLocal_71 == 1)
			{
				if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					if (__LIB_2__::func_859(&uLocal_205, cLocal_204, Local_73[iParam0 /*8*/][1], 7, 0, 0, 0))
					{
			...
			{
				if (__LIB_0__::func_724(iLocal_200, Local_186, 1) < 15f && iLocal_71 == 1)
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (__LIB_2__::func_859(&uLocal_205, cLocal_204, Local_73[iParam0 /*8*/][5], 7, 0, 0, 0))
						{
...
void func_233(int iParam0, bool bParam1)//Position - 0x888D
{
	if (!BitTest(Local_73[iParam0 /*8*/].f_7, bParam1))
	{
		if (iLocal_375 != -1)
		{
			if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
			{
				if (__LIB_2__::func_859(&uLocal_205, cLocal_204, Local_73[iParam0 /*8*/][bParam1], 7, 0, 0, 0))
				{
...
{
	if (__LIB_0__::func_725(PLAYER::PLAYER_PED_ID(), Local_186, 220f, 1))
	{
		if (!iLocal_203 && !__LIB_0__::func_725(PLAYER::PLAYER_PED_ID(), Local_186, 100f, 1))
		{
			iLocal_203 = __LIB_17__::func_762(&iLocal_202, joaat("cavalcade2"), 1370.9122f, -2060.055f, 50.9983f, 312.8686f, 1);
		}
	}
	else if (__LIB_0__::func_725(PLAYER::PLAYER_PED_ID(), Local_186, 240f, 1))
	{
		if (iLocal_203)
		{
...
void func_239()//Position - 0x8A75
{
	...
	switch (iLocal_69)
	{
		case 0:
			...
			{
				__LIB_17__::func_538(&iLocal_182, Local_199.f_0, 1);
				__LIB_17__::func_528("PRA_GOVAN", &iLocal_181);
				iLocal_69 = 1;
			}
			break;
		case 1:
			...
			if (__LIB_0__::func_695(Local_199.f_0))
			{
				__LIB_17__::func_68(&uLocal_56, Local_199.f_0, 0, 0, 1, 1, 1);
			}
			if (!bLocal_190)
			{
				if (__LIB_0__::func_692(Local_197.f_0) && PED::IS_PED_BEING_JACKED(Local_197.f_0))
				{
					func_241();
				}
				if (__LIB_0__::func_692(Local_198.f_0) && PED::IS_PED_BEING_JACKED(Local_198.f_0))
				{
					func_241();
				}
			}
...
void func_241()//Position - 0x8C13
{
	...
	bLocal_190 = __LIB_2__::func_859(&uLocal_205, "FBIPRAU", sVar0, 7, 0, 0, 0);
	if (bLocal_190)
	{
		...
		case 0:
			if (func_122(iLocal_68, 0))
			{
				...
				else
				{
					...
					{
						__LIB_17__::func_517(PLAYER::PLAYER_PED_ID(), 1228.6351f, -348.4277f, 68.0929f, 86.7244f);
						__LIB_14__::func_748(1228.6351f, -348.4277f, 68.0929f, 1112014848, 12, 5000, 0, 0);
						__LIB_0__::func_84(500, 1);
					}
					__LIB_0__::func_467();
					if (iLocal_68 == 2)
...
void func_336()//Position - 0x107EE
{
	if (!iLocal_188)
	{
		if (__LIB_0__::func_695(iLocal_200))
		{
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_200, false))
			{
				__LIB_0__::func_505(iLocal_200, -1);
				__LIB_0__::func_377(iLocal_200, 318);
				iLocal_188 = 1;
			}
		}
	}
	if (!iLocal_189)
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
		{
			__LIB_0__::func_499(320, 0);
			iLocal_189 = 1;
		}
	}
	else if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
	{
		__LIB_0__::func_498(0, 320);
		iLocal_189 = 0;
	}
}
...
void func_340()//Position - 0x108DB
{
	...
	if (!__LIB_0__::func_695(iLocal_200))
	{
		if (!__LIB_0__::func_695(iLocal_201) && !__LIB_0__::func_695(Local_199.f_0))
		{
			func_342(1);
			return;
		}
		if (__LIB_0__::func_695(Local_199.f_0) && !__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), Local_199.f_0, fVar0, 1))
		{
			func_342(2);
		}
	}
	...
	{
		iVar1 = 0;
		if (!__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), iLocal_200, fVar0, 1))
		{
			iVar1++;
		}
		if (__LIB_0__::func_695(iLocal_201))
		{
			if (!__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), iLocal_201, fVar0, 1))
			{
				iVar1++;
			}
		}
		...
		if (__LIB_0__::func_695(Local_199.f_0))
		{
			if (!__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), Local_199.f_0, fVar0, 1))
			{
				iVar1++;
			}
		}
		...
		iVar1 = 0;
		if (__LIB_17__::func_533(iLocal_200))
		{
			iVar1++;
		}
		if (__LIB_0__::func_695(iLocal_201))
		{
			if (__LIB_17__::func_533(iLocal_201))
			{
				iVar1++;
			}
		}
		...
		if (__LIB_0__::func_695(Local_199.f_0))
		{
			if (__LIB_17__::func_533(Local_199.f_0))
			{
				iVar1++;
			}
		}
...
{
	int iVar0;
	__LIB_16__::func_329(&uLocal_74);
	iVar0 = 0;
	while (iVar0 <= (iParam1 - 1))
	{
		__LIB_16__::func_328(&uLocal_74, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	__LIB_16__::func_327(&uLocal_74);
	__LIB_17__::func_519(&uLocal_126, &uLocal_74, 50f);
}
...
{
	Local_199 = { __LIB_17__::func_534(1203.1462f, -337.3543f, 67.9314f, 189.7047f, joaat("trash")) };
}
