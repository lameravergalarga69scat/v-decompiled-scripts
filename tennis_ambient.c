...
void __EntryFunction__()//Position - 0x0
{
	...
	if (((__LIB_0__::func_540(10) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("tennis")) == 0) || Global_97369) && !ScriptParam_616.f_1)
	{
	...
	Var1.f_28 = 1;
	fVar2 = __LIB_0__::func_373(ScriptParam_616.f_1, ScriptParam_616.f_2, 150f);
	iVar3 = 0;
	iVar4 = 0;
	iVar5 = (1 - iVar4);
