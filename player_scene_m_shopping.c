...
void __EntryFunction__()//Position - 0x0
{
	...
	func_146();
	__LIB_17__::func_504();
	while (iLocal_257 && __LIB_38__::func_711(1, 0))
	{
		SYSTEM::WAIT(0);
		switch (iLocal_66)
		{
...
int func_3(int* iParam0)//Position - 0x12C
{
	...
	{
		if (!__LIB_38__::func_711(1, *iParam0))
		{
		...
		switch (iLocal_258)
		{
			...
			case 5:
				...
				else
				{
					...
					Var4 = { __LIB_38__::func_726(Local_264 + Local_266, (fLocal_267 * 0.9f), 0f) };
...
void func_7(int iParam0)//Position - 0x96A
{
	...
	__LIB_42__::func_530(iParam0, 138, &uLocal_68, "FMMAUD", &uLocal_233, &iLocal_254, 3);
...
int func_135()//Position - 0x5A4C
{
	if (!__LIB_17__::func_680())
	{
		...
		switch (__LIB_37__::func_882(Global_100162))
		{
			case 0:
				__LIB_0__::func_222(&uLocal_68, 1, Global_100162, __LIB_17__::func_249(0), 0, 1);
				break;
			case 1:
				__LIB_0__::func_222(&uLocal_68, 2, Global_100162, __LIB_17__::func_249(1), 0, 1);
				break;
			case 2:
				__LIB_0__::func_222(&uLocal_68, 3, Global_100162, __LIB_17__::func_249(2), 0, 1);
				break;
			default:
				break;
		}
...
void func_146()//Position - 0x5E52
{
	...
	__LIB_38__::func_713(&Global_100162, Global_95444);
