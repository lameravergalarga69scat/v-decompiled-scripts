...
void __EntryFunction__()//Position - 0x0
{
	...
	func_146();
	__LIB_26__::func_563();
	while (iLocal_257 && __LIB_39__::func_523(1, 0))
	{
		SYSTEM::WAIT(0);
		switch (iLocal_66)
		{
...
int func_3(int* iParam0)//Position - 0x12C
{
	...
	{
		if (!__LIB_39__::func_523(1, *iParam0))
		{
		...
		switch (iLocal_258)
		{
					...
					else
					{
						...
						else
						{
							if (fLocal_306 >= 0f)
							{
								if (fVar0 >= fLocal_306)
								{
									__LIB_5__::func_759(*iParam0, "DISMISS_MICHAEL", "AMANDA_NORMAL", 24);
									fLocal_306 = -1f;
								}
							}
							if (fVar0 >= fVar1)
			...
			case 5:
				...
				else
				{
					...
					Var4 = { __LIB_37__::func_496(Local_264 + Local_266, (fLocal_267 * 0.9f), 0f) };
...
void func_7(int iParam0)//Position - 0x96A
{
	...
	__LIB_42__::func_712(iParam0, 138, &uLocal_68, "FMMAUD", &uLocal_233, &iLocal_254, 3);
...
int func_135()//Position - 0x5A4C
{
	if (!__LIB_12__::func_114())
	{
		...
		switch (__LIB_34__::func_937(Global_100162))
		{
			case 0:
				__LIB_0__::func_203(&uLocal_68, 1, Global_100162, __LIB_11__::func_905(0), 0, 1);
				break;
			case 1:
				__LIB_0__::func_203(&uLocal_68, 2, Global_100162, __LIB_11__::func_905(1), 0, 1);
				break;
			case 2:
				__LIB_0__::func_203(&uLocal_68, 3, Global_100162, __LIB_11__::func_905(2), 0, 1);
				break;
			default:
				break;
		}
...
void func_146()//Position - 0x5E52
{
	...
	__LIB_30__::func_706(&Global_100162, Global_95444);
