...
void __EntryFunction__()//Position - 0x0
{
	...
	if (__LIB_39__::func_46(Local_74, -1, 0, 0, 0))
	{
		__LIB_39__::func_9(-1);
	}
	else
...
void func_22()//Position - 0xDC8
{
	switch (iLocal_71)
	{
		case 0:
			...
			__LIB_39__::func_321(&Local_283, joaat("S_M_M_DockWork_01"));
			__LIB_39__::func_321(&Local_283, joaat("prop_generator_01a"));
			__LIB_39__::func_321(&Local_283, joaat("p_amb_phone_01"));
			__LIB_42__::func_587(&Local_283);
			if ((AUDIO::REQUEST_SCRIPT_AUDIO_BANK("CONSTRUCTION_ACCIDENT_1", false, -1) && STREAMING::HAS_ANIM_DICT_LOADED("re@construction")) && __LIB_39__::func_82(&Local_283))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_80, false))
				{
					...
					__LIB_0__::func_222(&uLocal_108, 3, iLocal_78, "RECONACWorker", 0, 1);
					...
					__LIB_39__::func_4(&uLocal_108, "CONACAU", "CONAC_CHAT", 4, 0, 0, 0, 0);
					...
					if (!PED::IS_PED_INJURED(iLocal_78))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -532.2208f, -849.2668f, 19.7038f, -531.6973f, -1065.341f, 60.7893f, 190.8125f, false, true, 0))
						{
							if (!ENTITY::IS_ENTITY_DEAD(iLocal_80, false))
							{
								if (!HUD::DOES_BLIP_EXIST(iLocal_85))
								{
									iLocal_85 = __LIB_0__::func_639(iLocal_80, 0, 0);
								}
							}
						}
						...
						if ((((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), -473.1686f, -984.6405f, 22.487f, 40f, 40f, 5f, false, true, 0) && !PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID())) && __LIB_0__::func_494(1, 0, 1)) && STREAMING::HAS_MODEL_LOADED(joaat("prop_ld_pipe_single_01")))
						{
							if (!__LIB_39__::func_8())
							{
				...
				else
				{
					if (!PED::IS_PED_INJURED(iLocal_78))
					{
						...
						else if (!HUD::DOES_BLIP_EXIST(iLocal_84))
						{
							...
							iLocal_84 = __LIB_0__::func_666(iLocal_78, 0, 145);
						}
					}
					func_52();
					func_49();
					...
					if (iLocal_103 >= 3)
					{
						...
						else if (!PED::IS_PED_INJURED(iLocal_78) && !ENTITY::IS_ENTITY_DEAD(iLocal_80, false))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_78, false) && HUD::DOES_BLIP_EXIST(iLocal_85))
							{
								...
								if (!HUD::DOES_BLIP_EXIST(iLocal_86))
								{
									iLocal_86 = __LIB_0__::func_639(iLocal_81, 0, 0);
								}
							}
						}
					}
						...
						if (!PED::IS_PED_INJURED(iLocal_78))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_78, false))
							{
								...
								if (!bLocal_95)
								{
									__LIB_0__::func_429();
									SYSTEM::WAIT(0);
									__LIB_0__::func_787(&uLocal_108, "CONACAU", "CONAC_DIE", 4, 0, 0, 0);
	...
	switch (iLocal_103)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				...
				{
					__LIB_0__::func_787(&uLocal_108, "CONACAU", "CONAC_HELP", 4, 0, 0, 0);
		...
		case 2:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				if ((MISC::GET_GAME_TIMER() - iLocal_101) > 5000 && !__LIB_0__::func_75())
				{
					...
					{
						__LIB_0__::func_787(&uLocal_108, "CONACAU", "CONAC_HELP2", 4, 0, 0, 0);
					}
					else
					{
						__LIB_0__::func_787(&uLocal_108, "CONACAU", "CONAC_HELP3", 4, 0, 0, 0);
					}
					iLocal_101 = MISC::GET_GAME_TIMER();
					iLocal_103++;
				}
		...
		case 3:
			if (MISC::GET_GAME_TIMER() - iLocal_101) > MISC::GET_RANDOM_INT_IN_RANGE(5000, 8000)
			{
				...
				{
					__LIB_0__::func_787(&uLocal_108, "CONACAU", "CONAC_HURRY", 4, 0, 0, 0);
					iLocal_101 = MISC::GET_GAME_TIMER();
				}
			}
			break;
	...
	switch (iLocal_98)
	{
					...
					if (VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_78, iLocal_80, -1, false, false) || VEHICLE::IS_ENTRY_POINT_FOR_SEAT_CLEAR(iLocal_78, iLocal_80, 0, false, false))
					{
						...
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), Local_77, 4.2f, 4f, 5f, false, true, 0))
						{
							if (!bLocal_93)
							{
								__LIB_0__::func_429();
								SYSTEM::WAIT(0);
								__LIB_0__::func_787(&uLocal_108, "CONACAU", "CONAC_FREE", 4, 0, 0, 0);
								bLocal_93 = true;
							}
						}
						else
		...
		case 2:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				if ((MISC::GET_GAME_TIMER() - iLocal_101) > 500 && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_78, false))
				{
					...
					__LIB_0__::func_429();
					SYSTEM::WAIT(0);
					__LIB_0__::func_787(&uLocal_108, "CONACAU", "CONAC_BOOM", 4, 0, 0, 0);
					iLocal_101 = MISC::GET_GAME_TIMER();
					iLocal_98++;
				}
			}
		...
		case 3:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				...
				{
					__LIB_0__::func_787(&uLocal_108, "CONACAU", "CONAC_AAAH", 4, 0, 0, 0);
					iLocal_98++;
				}
			}
			break;
		...
		case 6:
			if (!PED::IS_PED_INJURED(iLocal_78))
			{
				if ((MISC::GET_GAME_TIMER() - iLocal_101) > 6400)
				{
					...
					TASK::TASK_PERFORM_SEQUENCE(iLocal_78, iLocal_107);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_107);
					__LIB_0__::func_787(&uLocal_108, "CONACAU", "CONAC_THANK", 4, 0, 0, 0);
					func_53();
				}
			}
			else
...
void func_53()//Position - 0x2829
{
	...
	__LIB_17__::func_219(__LIB_0__::func_683(), 4, 2);
	...
	switch (iLocal_72)
	{
		...
		case 1:
			if ((MISC::GET_GAME_TIMER() - iLocal_104) > 3500)
			{
				...
				__LIB_39__::func_485(iLocal_276);
				__LIB_39__::func_485(iLocal_277);
		...
		case 5:
			if ((MISC::GET_GAME_TIMER() - iLocal_104) > 500)
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_80, false))
				{
					...
					__LIB_0__::func_787(&uLocal_108, "CONACAU", "CONAC_SCREAM", 4, 0, 0, 0);
...
{
	int iVar0;
	__LIB_39__::func_321(&Local_283, joaat("bulldozer"));
	__LIB_39__::func_321(&Local_283, joaat("utillitruck2"));
	__LIB_39__::func_321(&Local_283, joaat("prop_pipe_stack_01"));
	if (__LIB_39__::func_82(&Local_283))
	{
		...
		__LIB_39__::func_322(&Local_283, 0);
		iLocal_280 = 1;
		iLocal_70 = 1;
	}
}
	...
	if (iLocal_280)
	{
		if (!iLocal_281)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_83, false))
			{
				...
				{
					__LIB_17__::func_200(iLocal_83, 0, 145);
				}
			}
			iLocal_97 = 0;
			while (iLocal_97 < 11)
