		...
		if (Global_55453[iVar0 /*36*/].f_8)
		{
			if (Global_55453[iVar0 /*36*/].f_35 > -1)
			{
				...
				if (Global_55453[iVar0 /*36*/].f_9 > 0f)
				{
					...
					fVar3 = (fVar3 / 5f);
					fVar6 = __LIB_39__::func_799(iVar0);
...
void func_11(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xAAB
{
	...
	iVar0 = (iVar0 - iParam6);
	__LIB_36__::func_18(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
void func_28(bool bParam0)//Position - 0xFCD
{
	...
	while (iVar0 < 80)
	{
		__LIB_42__::func_762(iVar0, bParam0);
		SYSTEM::WAIT(0);
		if (!bParam0)
		{
			func_68();
...
int func_30()//Position - 0x110E
{
	...
	if (iLocal_20 == -15)
	{
		iLocal_20 = __LIB_36__::func_13();
		iVar0 = __LIB_0__::func_199(iLocal_20);
		if (iVar0 == 24)
		{
			iVar0 = 0;
		}
		if (__LIB_3__::func_114(iVar0, 0, 8))
		{
			__LIB_17__::func_863(&iLocal_20, 8);
		}
		else if (__LIB_3__::func_114(iVar0, 8, 16))
		{
			__LIB_17__::func_863(&iLocal_20, 16);
		}
		else if (__LIB_3__::func_114(iVar0, 16, 24))
		{
			__LIB_17__::func_863(&iLocal_20, 0);
			__LIB_38__::func_193(&iLocal_20, 0, 0, 0, 1, 0, 0);
		}
		__LIB_17__::func_864(&iLocal_20, 0);
		__LIB_17__::func_865(&iLocal_20, 0);
		iLocal_21 = iLocal_20;
		return 0;
	}
	if (func_34(iLocal_20))
	{
		...
		__LIB_38__::func_193(&iLocal_20, 0, 480, 0, 0, 0, 0);
		return 1;
	}
	return 0;
}
...
int func_31(int iParam0, bool bParam1, int iParam2)//Position - 0x11C8
{
	...
	if (__LIB_3__::func_423(Global_1574629))
	{
		if (bParam1)
		{
			...
			iVar1 = __LIB_0__::func_199(Global_1574629);
			iVar2 = __LIB_0__::func_198(Global_1574629);
			__LIB_17__::func_863(&iVar0, iVar1);
			__LIB_17__::func_864(&iVar0, iVar2);
			__LIB_17__::func_865(&iVar0, 0);
			if (__LIB_11__::func_761(__LIB_36__::func_13(), iVar0))
			{
				__LIB_38__::func_193(&iVar0, 0, 0, 0, 1, 0, 0);
			}
			iVar3 = 0;
			while (__LIB_11__::func_761(iVar0, *iParam0) && iVar3 < 24)
			{
				__LIB_38__::func_193(iParam0, 0, 0, iParam2, 0, 0, 0);
				iVar3 = (iVar3 + iParam2);
			}
		}
		return 1;
...
{
	return __LIB_11__::func_761(__LIB_36__::func_13(), iParam0);
}
...
void func_39()//Position - 0x16DB
{
	...
	if (iLocal_26 != iVar0)
	{
		if (iLocal_25 > 48)
		{
			switch (__LIB_39__::func_795(iLocal_26))
			{
				case 1:
...
void func_41()//Position - 0x1836
{
	...
	while (iVar0 < 80)
	{
		if (!Global_55453[iVar0 /*36*/].f_8)
		{
			...
			fVar5 = __LIB_0__::func_331(fVar5, -Global_58608[iVar4 /*7*/].f_5, Global_58608[iVar4 /*7*/].f_5);
			iVar6 = 61;
			if (((iVar0 == iVar6 && __LIB_0__::func_178(44)) && !__LIB_0__::func_178(64)) && fVar5 > 0f)
			{
...
float func_43(int iParam0)//Position - 0x1CD1
{
	...
	iVar0 = __LIB_16__::func_579(0, iParam0);
	iVar1 = __LIB_16__::func_579(1, iParam0);
	iVar2 = __LIB_16__::func_579(2, iParam0);
	...
	while (iVar6 < 10)
	{
		iVar7 = __LIB_16__::func_579(0, iVar6);
		if (iVar7 > 0)
		{
			fVar5 = (fVar5 + (__LIB_39__::func_799(__LIB_16__::func_580(0, iVar6)) * IntToFloat(iVar7)));
		}
		if (__LIB_16__::func_579(1, iVar6) > 0)
		{
			fVar5 = (fVar5 + (__LIB_39__::func_799(__LIB_16__::func_580(1, iVar6)) * IntToFloat(iVar7)));
		}
		if (__LIB_16__::func_579(2, iVar6) > 0)
		{
			fVar5 = (fVar5 + (__LIB_39__::func_799(__LIB_16__::func_580(2, iVar6)) * IntToFloat(iVar7)));
		}
		iVar6++;
	}
...
{
	int iVar0;
	iVar0 = __LIB_39__::func_796(iParam0);
	switch (iVar0)
	{
		case 0:
...
{
	switch (__LIB_17__::func_866(iParam0))
	{
		case 0:
...
int func_61(int iParam0, var uParam1)//Position - 0x2566
{
	...
	while (iVar0 < 68)
	{
		...
		{
			if (__LIB_14__::func_527(&(Global_77137.f_555[0 /*21*/]), iVar0))
			{
...
int func_67()//Position - 0x405E
{
	...
	if (func_34(iLocal_21))
	{
		...
		__LIB_38__::func_193(&iLocal_21, 0, iLocal_22, 0, 0, 0, 0);
		return 1;
	}
	return 0;
}
...
void func_68()//Position - 0x409D
{
	...
	{
		Global_60333 = 0;
		switch (__LIB_17__::func_866(Global_60334))
		{
			case 0:
			case 1:
			case 2:
				...
				if (bVar4)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iVar1))
					{
						if (ENTITY::IS_ENTITY_A_PED(iVar1))
						{
							...
							if (__LIB_0__::func_683() == 0 && iVar3 != PLAYER::PLAYER_PED_ID())
							{
...
int func_75(int iParam0)//Position - 0x47B6
{
	...
	if (__LIB_0__::func_402(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX())) == iVar0)
	{
		return 1;
	}
	return 0;
...
void func_80()//Position - 0x4AC3
{
	...
	if (__LIB_0__::func_322(PLAYER::GET_PLAYER_INDEX(), -1))
	{
		iLocal_29 = 0;
		return;
	}
...
{
	__LIB_42__::func_763(0);
	__LIB_42__::func_763(1);
	__LIB_42__::func_763(2);
}
...
int func_89(int iParam0)//Position - 0x50A0
{
	...
	Global_55453[iVar0 /*36*/].f_14[Global_55453[iVar0 /*36*/].f_13] = __LIB_39__::func_799(iVar0);
	iVar5 = 0;
	iVar6 = 0;
	iVar7 = 0;
	iVar8 = iVar3 + 1;
		...
		if (iVar0 < 42)
		{
			...
			if ((Global_55453[iVar1 /*36*/].f_32 > 0f && Global_55453[iVar1 /*36*/].f_31 > 0f) && Global_55453[iVar1 /*36*/].f_9 > 0f)
			{
				...
				while (iVar3 >= 0)
				{
					...
					fVar10 = __LIB_1__::func_712(fVar10, Global_55453[iVar1 /*36*/].f_14[iVar3]);
					fVar11 = __LIB_3__::func_480(fVar11, Global_55453[iVar1 /*36*/].f_14[iVar3]);
				...
				fVar16 = __LIB_33__::func_456(iVar1);
				if (fVar16 != 1f)
				{
					fVar5 = 0f;
					fVar17 = (fVar16 - 1f);
					...
					while (iVar3 <= 15)
					{
						...
						fVar5 = (fVar5 + Global_55453[iVar1 /*36*/].f_14[iVar3]);
						Global_55453[iVar1 /*36*/].f_32 = __LIB_1__::func_712(Global_55453[iVar1 /*36*/].f_32, Global_55453[iVar1 /*36*/].f_14[iVar3]);
						Global_55453[iVar1 /*36*/].f_31 = __LIB_3__::func_480(Global_55453[iVar1 /*36*/].f_31, Global_55453[iVar1 /*36*/].f_14[iVar3]);
						iVar3++;
					}
					fVar5 = (fVar5 / 16f);
					Global_55453[iVar1 /*36*/].f_33 = (Global_55453[iVar1 /*36*/].f_9 - fVar5);
	...
	if (!Global_113386.f_20564.f_101)
	{
		...
		while (iVar1 <= 15)
		{
			...
			while (iVar0 < 80)
			{
				...
				Global_55453[iVar0 /*36*/].f_9 = __LIB_1__::func_712(__LIB_3__::func_480(MISC::ABSF(Global_55453[iVar0 /*36*/].f_9), 3.5f), 290f);
				iVar0++;
			}
			iVar1++;
		}
