...
void __EntryFunction__()//Position - 0x0
{
	...
	else if ((((PLAYER::HAS_FORCE_CLEANUP_OCCURRED(19) || __LIB_26__::func_421(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_WEARING_HELMET(PLAYER::PLAYER_PED_ID())) || __LIB_6__::func_854(9)) || (__LIB_0__::func_569() && !__LIB_0__::func_568()))
	{
		func_453();
	}
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_41))
		{
			if ((((BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(iLocal_41) && !ENTITY::IS_ENTITY_DEAD(iLocal_41, false)) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && __LIB_40__::func_684()) && __LIB_30__::func_519(iLocal_41))
			{
				switch (iLocal_312)
				{
					case 0:
						if (func_424() && __LIB_35__::func_37())
						{
							iLocal_312 = 1;
						}
						break;
	...
	switch (iLocal_313)
	{
		case 0:
			if (!iLocal_315)
			{
				...
				if (ENTITY::DOES_ENTITY_HAVE_DRAWABLE(__LIB_35__::func_33()))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(__LIB_35__::func_33(), iLocal_324, __LIB_30__::func_507(0), __LIB_30__::func_506(), 8f, -8f, 0, 1000f);
					PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_324, 1f);
					PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_324, true);
					iLocal_315 = 1;
				}
			}
			iLocal_322 = __LIB_30__::func_518(PLAYER::PLAYER_PED_ID());
			if (((((__LIB_35__::func_34(Local_334, Var0) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) >= (__LIB_30__::func_514() - 90f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) <= (__LIB_30__::func_514() + 90f)) && __LIB_30__::func_513()) && iLocal_322 != 1) && iLocal_322 != 0)
			{
		...
		case 1:
			...
			{
				if (((__LIB_35__::func_34(Local_334, Var0) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) >= (__LIB_30__::func_514() - 90f)) && ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()) <= (__LIB_30__::func_514() + 90f)) && __LIB_30__::func_513())
				{
		...
		case 2:
			...
			PAD::DISABLE_CONTROL_ACTION(0 /*PLAYER_CONTROL*/, 0 /*INPUT_NEXT_CAMERA*/, true);
			iLocal_324 = PED::CREATE_SYNCHRONIZED_SCENE(__LIB_30__::func_509(), __LIB_30__::func_508(), 2);
			TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_324, __LIB_30__::func_506(), __LIB_30__::func_502(0), 8f, -4f, 0, 0, 1000f, 4);
			ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(__LIB_35__::func_33(), iLocal_324, __LIB_30__::func_507(0), __LIB_30__::func_506(), 8f, -1000f, 0, 1000f);
			ENTITY::PLAY_SYNCHRONIZED_MAP_ENTITY_ANIM(Local_334, 2f, joaat("prop_wine_bot_01"), iLocal_324, __LIB_35__::func_35(), __LIB_30__::func_506(), 8f, -1000f, 0, 1000f);
			...
			if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
			{
				...
				CAM::PLAY_SYNCHRONIZED_CAM_ANIM(iLocal_319, iLocal_324, __LIB_35__::func_38(), __LIB_30__::func_506());
		...
		case 3:
			...
			else
			{
				iLocal_314 = 0;
				iLocal_324 = PED::CREATE_SYNCHRONIZED_SCENE(__LIB_30__::func_509(), __LIB_30__::func_508(), 2);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_324, __LIB_30__::func_506(), __LIB_35__::func_31(), 8f, -8f, 0, 0, 1000f, 4);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(__LIB_35__::func_33(), iLocal_324, __LIB_35__::func_30(), __LIB_30__::func_506(), 1000f, -8f, 0, 1000f);
		...
		case 4:
			...
			else
			{
				...
				{
					fVar1 = PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_324);
					if (ENTITY::FIND_ANIM_EVENT_PHASE(__LIB_30__::func_506(), __LIB_35__::func_31(), "WalkInterruptible", &fVar2, &fVar3))
					{
						if (fVar1 >= fVar2 && fVar1 <= fVar3)
						{
							iLocal_324 = PED::CREATE_SYNCHRONIZED_SCENE(__LIB_30__::func_509(), __LIB_30__::func_508(), 2);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(__LIB_35__::func_33(), iLocal_324, __LIB_35__::func_30(), __LIB_30__::func_506(), 2f, -8f, 0, 1000f);
							PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_324, 1f);
							PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_324, true);
...
{
	if (!__LIB_0__::func_394(Local_275, 0f, 0f, 0f, 1056964608, 0))
	{
		return Local_275;
	}
	return Local_275;
...
{
	if (!__LIB_0__::func_394(Local_274, 0f, 0f, 0f, 1056964608, 0))
	{
		return Local_274;
	}
	return Local_274;
...
void func_87()//Position - 0x3E11
{
	...
	switch (iLocal_313)
	{
		case 0:
			...
			iLocal_322 = __LIB_30__::func_518(PLAYER::PLAYER_PED_ID());
			if (__LIB_39__::func_497(3))
			{
				if ((((((__LIB_35__::func_34(Local_334, Var0) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && func_403()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_337, Local_338, 1.5f, false, true, 0)) && iLocal_322 != 2) && iLocal_322 != 1) && iLocal_322 != 0)
				{
					__LIB_0__::func_187(sLocal_333);
					iLocal_313 = 1;
				}
			}
			break;
		case 1:
			if (__LIB_0__::func_398(1, 0, 1))
			{
				if (((__LIB_35__::func_34(Local_334, Var0) && func_403()) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_337, Local_338, 1.5f, false, true, 0)) && __LIB_39__::func_497(3))
				{
		...
		case 3:
			...
			else
			{
				iLocal_314 = 0;
				iLocal_324 = PED::CREATE_SYNCHRONIZED_SCENE(Local_335, Local_336, 2);
				TASK::TASK_SYNCHRONIZED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_324, sLocal_327, __LIB_35__::func_31(), 8f, -8f, 1, 0, 1000f, 4);
		...
		case 4:
			...
			if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_324) > 0.99f)
			{
				iLocal_317 = 0;
				iLocal_324 = PED::CREATE_SYNCHRONIZED_SCENE(Local_335, Local_336, 2);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_41, iLocal_324, __LIB_35__::func_30(), sLocal_327, 1000f, -8f, 0, 1000f);
				PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_324, 1f);
				ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(iLocal_41);
				iLocal_313 = 6;
			}
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11, bool bParam12, bool bParam13)//Position - 0x534E
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_78130[1 /*14*/] = { __LIB_35__::func_544(iVar5, iVar0, func_245(iParam0, iVar0, -1), -1) };
	...
	else
	{
		...
		else if (iParam1 == 8)
		{
			...
			if (iParam5 == 0)
			{
				iVar6 = func_227(iVar5, iParam2, __LIB_6__::func_795(iParam0, 11), __LIB_6__::func_795(iParam0, 4));
			}
		}
		else if (iParam1 == 9)
		{
		...
		else if (iParam1 == 4)
		{
			...
			if (iParam5 == 0)
			{
				iVar6 = func_227(iVar5, __LIB_6__::func_795(iParam0, 8), __LIB_6__::func_795(iParam0, 11), iParam2);
			}
				...
				while (iVar2 < 15)
				{
					...
					if (iVar3 != -99)
					{
						...
						else if (iVar2 == 8)
						{
							if (iVar6 != -99)
							{
								iVar6 = func_227(iVar5, iVar3, __LIB_6__::func_795(iParam0, 11), __LIB_6__::func_795(iParam0, 4));
							}
						}
					}
					iVar2++;
	...
	if (iVar10 != -1)
	{
		iVar84 = __LIB_0__::func_254(iVar5, func_245(iParam0, 3, -1), iVar10);
		if (iVar84 != -1)
		{
			if (iVar5 == joaat("MP_M_Freemode_01"))
			{
			...
			switch (iVar0)
			{
				...
				case 1:
					switch (iVar1)
					{
						...
						case 7:
						case 12:
							iVar2 = __LIB_18__::func_431(joaat("MP_M_Freemode_01"), 11, func_245(iParam0, 11, -1), 0);
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar7 = __LIB_18__::func_431(joaat("MP_F_Freemode_01"), 11, func_245(iParam0, 11, -1), 0);
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar10 = __LIB_18__::func_431(joaat("MP_F_Freemode_01"), 11, func_245(iParam0, 11, -1), 0);
				...
				case 1:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar11 = __LIB_18__::func_431(joaat("MP_F_Freemode_01"), 11, func_245(iParam0, 11, -1), 0);
	...
	switch (iParam0)
	{
		case joaat("MP_M_Freemode_01"):
			...
			else if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar2, joaat("BIKER_VEST"), 0) && !FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar2, joaat("JACKET_ONLY"), 0))
			{
				...
				{
					iVar0 = func_227(iParam0, -99, __LIB_6__::func_807(iParam0, iParam1, 0), iParam3);
					if (iVar0 == -99)
					{
						iVar0 = 0;
					}
...
int func_369(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x6367D
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_78130[1 /*14*/] = { __LIB_35__::func_896(iVar10, iVar0, func_373(iParam0, iVar0, -1), -1) };
				if (BitTest(Global_78130[1 /*14*/].f_6, 3))
				{
					if (iVar0 == 2)
					{
