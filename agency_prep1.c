...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		switch (iLocal_969)
		{
			...
			case 0:
				...
				else
				{
					...
					{
						__LIB_0__::func_505(iLocal_800, -1);
						__LIB_0__::func_377(iLocal_800, -1);
						__LIB_0__::func_499(541, 0);
						iLocal_975 = 1;
					}
			...
			case 1:
				...
				{
					if (__LIB_0__::func_213(iLocal_800, 1093140480, 1, 1056964608, 0, 1, 0))
					{
						if (!iLocal_978)
						{
							__LIB_0__::func_229("AHP_GETOUT", 7500, 1);
							iLocal_978 = 1;
						}
			...
			case 100:
				...
				if (!__LIB_0__::func_425(13))
				{
					__LIB_0__::func_681(13, 1);
				}
				iLocal_969++;
				break;
			case 101:
				...
				else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_800, false))
				{
					...
					else if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_800))
					{
						if (!iLocal_977)
						{
							__LIB_0__::func_229("AHP_LOSECOPS", 7500, 1);
							iLocal_977 = 1;
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_800))
		{
			if (!__LIB_0__::func_385(iLocal_800))
			{
				__LIB_0__::func_679(iLocal_800, 0);
			}
		}
		SYSTEM::WAIT(0);
	}
...
void func_14(char* sParam0)//Position - 0xC8B
{
	...
	{
		__LIB_0__::func_507(229.1676f, -1614.9794f, 28.2892f, 142.5156f);
	}
	func_107();
}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
		{
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
			{
				...
				{
					iLocal_799 = __LIB_0__::func_639(iParam0, 0, 0);
				}
			}
		}
		else if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iParam0, false))
		{
			...
			if (!HUD::DOES_BLIP_EXIST(iLocal_798))
			{
				...
				if (!iLocal_973)
				{
					__LIB_0__::func_382("AHP_DROPOFF", 7500, 1);
					iLocal_973 = 1;
				}
				iLocal_798 = __LIB_0__::func_488(Local_971, 1);
		...
		else
		{
			...
			if (!HUD::DOES_BLIP_EXIST(iLocal_799))
			{
				...
				if (!iLocal_972)
				{
					__LIB_0__::func_382("AHP_GETBAKIN", 7500, 1);
					iLocal_972 = 1;
				}
				iLocal_799 = __LIB_0__::func_639(iParam0, 0, 0);
			}
...
void func_45()//Position - 0x2140
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		switch (iLocal_982)
		{
			...
			case 1:
				...
				{
					if ((((PED::IS_PED_INJURED(__LIB_16__::func_914(iLocal_983)) || VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar0, -1, false) != __LIB_16__::func_914(iLocal_983)) || !PED::IS_PED_IN_VEHICLE(__LIB_16__::func_914(iLocal_983), iVar0, false)) || !__LIB_17__::func_550(__LIB_16__::func_914(iLocal_983))) || !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0, false))
					{
						__LIB_17__::func_549(__LIB_16__::func_914(iLocal_983));
						iLocal_982 = 0;
					}
					else
					{
						switch (iLocal_1003)
						{
							...
							case 1:
								...
								break;
							case 2:
								TASK::TASK_VEHICLE_DRIVE_TO_COORD(__LIB_16__::func_914(iLocal_983), iVar0, Local_971, 15f, 0, joaat("firetruk"), 786484, 5f, 5f);
							...
							case 3:
								if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, 697.6884f, -1013.3638f, 27.496796f, 688.3482f, -1013.17914f, 22.329676f, 29.25f, false, true, 0))
								{
									if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iVar0, true), Local_984) < SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(iVar0, true), Local_985))
									{
										if (bLocal_980)
										{
											TASK::TASK_VEHICLE_DRIVE_TO_COORD(__LIB_16__::func_914(iLocal_983), iVar0, Local_985, 5f, 0, ENTITY::GET_ENTITY_MODEL(iVar0), 262144, 2f, 2f);
										}
										else
										{
											TASK::TASK_VEHICLE_PARK(__LIB_16__::func_914(iLocal_983), iVar0, Local_971, 180f, 1, 15f, false);
										}
									}
									else if (bLocal_980)
									{
										TASK::TASK_VEHICLE_DRIVE_TO_COORD(__LIB_16__::func_914(iLocal_983), iVar0, Local_984, 5f, 0, ENTITY::GET_ENTITY_MODEL(iVar0), 262144, 2f, 2f);
									}
									else
									{
										TASK::TASK_VEHICLE_PARK(__LIB_16__::func_914(iLocal_983), iVar0, Local_971, 0f, 1, 15f, false);
									}
									iLocal_1003++;
								}
								break;
	...
	{
		if (__LIB_17__::func_549(__LIB_16__::func_914(iLocal_983)))
		{
			iLocal_982 = 0;
		}
	}
...
void func_46()//Position - 0x244A
{
	...
	var uVar1;
	bVar0 = false;
	if (!PED::IS_PED_INJURED(__LIB_16__::func_914(iLocal_983)) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
	{
		if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_800) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_800, false)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_800, false)) && PED::IS_PED_IN_VEHICLE(__LIB_16__::func_914(iLocal_983), iLocal_800, false)) || (((ENTITY::DOES_ENTITY_EXIST(iLocal_801) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_801, false)) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_801, false)) && PED::IS_PED_IN_VEHICLE(__LIB_16__::func_914(iLocal_983), iLocal_801, false)))
		{
			bVar0 = true;
		}
	}
	...
	{
		case 0:
			uVar1 = __LIB_34__::func_685();
			if (func_71(0, 1, 145, 0, uVar1, &cLocal_991, &cLocal_995, 1))
			{
				__LIB_0__::func_221(&uLocal_804, 0);
				__LIB_0__::func_221(&uLocal_804, 1);
				__LIB_0__::func_221(&uLocal_804, 2);
				if (__LIB_0__::func_683() == 1)
				{
					__LIB_0__::func_222(&uLocal_804, 0, __LIB_16__::func_914(0), "MICHAEL", 0, 1);
					__LIB_0__::func_222(&uLocal_804, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
				}
				else
				{
					__LIB_0__::func_222(&uLocal_804, 1, __LIB_16__::func_914(1), "FRANKLIN", 0, 1);
					__LIB_0__::func_222(&uLocal_804, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
				}
				if (!iLocal_1000)
				{
		...
		case 1:
			if (bVar0)
			{
				...
				{
					if (__LIB_2__::func_859(&uLocal_804, &cLocal_991, &cLocal_995, 8, 0, 0, 0))
					{
						iLocal_1000 = 1;
						iLocal_990 = 2;
					}
		...
		case 2:
			if (!bLocal_999)
			{
				if (!bVar0)
				{
					cLocal_1001 = { __LIB_0__::func_485() };
					__LIB_0__::func_325();
					bLocal_999 = true;
				}
			}
			...
			{
				if (__LIB_14__::func_782(&uLocal_804, &cLocal_991, &cLocal_995, &cLocal_1001, 8, 0, 0))
				{
					bLocal_999 = false;
				}
			}
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, char* sParam5, char* sParam6, bool bParam7)//Position - 0x2FD7
{
	...
	iVar2 = __LIB_14__::func_791(iParam2);
	...
	if (iVar2 == 7)
	{
		iVar5 = __LIB_13__::func_95(iVar0, iVar1);
		if (iVar5 >= 9)
		{
			return 0;
		}
	...
	{
		iVar6 = __LIB_37__::func_373(iVar0, iVar1, iVar2);
		if (iVar6 >= 2)
		{
			return 0;
		}
	...
	*sParam6 = { __LIB_34__::func_689(iVar0, iVar1, iVar2, 2) };
	*sParam5 = { *sParam6 };
...
void func_99()//Position - 0x4112
{
	...
	if (__LIB_0__::func_2(0))
	{
		...
		{
			__LIB_0__::func_427(354.3055f, -1722.2062f, 28.259f, 109.6154f, 1, 0);
...
void func_111()//Position - 0x4771
{
	if (iLocal_976 == 1)
	{
		__LIB_0__::func_507(354.3055f, -1722.2062f, 28.259f, 109.6154f);
	}
}
