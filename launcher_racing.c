...
void func_11()//Position - 0x5C0
{
	...
	if (Local_43.f_1 != 3)
	{
		__LIB_15__::func_811(__LIB_0__::func_683(), 1, Local_43.f_3);
		iVar0 = MISC::GET_GAME_TIMER() + 1500;
		iVar1 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		if (__LIB_0__::func_695(iVar1))
		{
			while (!__LIB_0__::func_213(iVar1, 3f, 2, 1056964608, 0, 1, 0) || MISC::GET_GAME_TIMER() < iVar0)
			{
				SYSTEM::WAIT(0);
			}
		}
...
{
	int iVar0;
	iVar0 = __LIB_0__::func_782(&(Local_43.f_2), 0, 9, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
int func_79()//Position - 0x26A1
{
	...
	else
	{
		...
		if (bVar5 || bVar4)
		{
			...
			__LIB_3__::func_781(iLocal_50, 1, 1);
		}
	}
...
void func_123()//Position - 0x72CF
{
	...
	if (Local_43.f_1 == 3)
	{
		__LIB_1__::func_767("SEA_MENU" /* GXT: Sea Races */);
	}
	else
	{
		__LIB_1__::func_767("STREET_MENU" /* GXT: Street Races */);
	}
	__LIB_3__::func_572(0, "RACES_OPT_SP" /* GXT: Standard Race */, 0, 1, 0, 0, 0);
	__LIB_3__::func_572(1, "RACES_OPT_MP" /* GXT: Play Online */, 0, 1, 0, 0, 0);
	__LIB_1__::func_791(201, "ITEM_SELECT" /* GXT: Select */, -1);
	__LIB_1__::func_791(202, "ITEM_EXIT" /* GXT: Exit */, -1);
	__LIB_6__::func_170(11, "ITEM_SCROLL" /* GXT: Scroll */, -1);
...
void func_133()//Position - 0x7C84
{
	...
	if (func_163())
	{
		if (func_146())
		{
			...
			func_144(iVar0);
			if (__LIB_0__::func_692(iLocal_56[iVar0]))
			{
				if (bLocal_55)
				{
		...
		switch (iLocal_77)
		{
			...
			case 2:
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_56[iParam0], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) != 1 || PED::IS_PED_FACING_PED(iLocal_56[iParam0], PLAYER::PLAYER_PED_ID(), 20f))
				{
					...
					if (!iLocal_79)
					{
						__LIB_0__::func_709(iLocal_56[iParam0], "PRERACE_CHAT", "A_M_Y_RACER_01_WHITE_MINI_01", 11);
					}
					else
					{
						__LIB_0__::func_709(iLocal_56[iParam0], "PRERACE_TAUNT", "A_M_Y_RACER_01_WHITE_MINI_01", 11);
					}
					iLocal_77 = 3;
				}
				break;
			...
			case 4:
				...
				if (__LIB_37__::func_602(&iLocal_80) >= 5f && !iLocal_78)
				{
					iLocal_78 = 1;
					iLocal_77 = 1;
				}
				else if (__LIB_37__::func_602(&iLocal_80) >= 10f && !iLocal_79)
				{
					iLocal_79 = 1;
					iLocal_77 = 1;
				}
...
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !__LIB_7__::func_691())
	{
		if (__LIB_0__::func_692(iLocal_56[iParam0]))
		{
...
int func_146()//Position - 0x828B
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		...
		if (__LIB_12__::func_295(__LIB_0__::func_683()) < Local_43.f_3)
		{
			if (Local_43.f_1 == 3)
			{
...
void func_147()//Position - 0x83FD
{
	...
	if (Local_43.f_1 == 3)
	{
		if (__LIB_0__::func_695(iLocal_57))
		{
	...
	else if (Local_43.f_1 == 1)
	{
		...
		{
			__LIB_0__::func_190("STREET_NA_BIKE" /* GXT: A motorcycle is needed to enter this street race. */);
			iLocal_45 = 1;
			iLocal_48 = MISC::GET_GAME_TIMER() + 1000;
		}
	}
	...
	{
		__LIB_0__::func_190("STREET_NA_CAR" /* GXT: A car is needed to enter this street race. */);
		iLocal_45 = 1;
		iLocal_48 = MISC::GET_GAME_TIMER() + 1000;
	}
}
...
void func_164()//Position - 0x8D17
{
	...
	int iVar1;
	int iVar2;
	if (__LIB_38__::func_393(&uLocal_90))
	{
		if (Local_43.f_1 == 2)
		{
			if (func_166())
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(cLocal_73))
				{
					if (iLocal_75)
					{
						...
						while (iVar0 <= (iLocal_70 - 1))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_56[iVar0], false) && !__LIB_6__::func_572(iLocal_56[iVar0], joaat("SCRIPT_TASK_PLAY_ANIM")))
								{
						...
						if ((((((((__LIB_0__::func_692(iLocal_56[0]) && __LIB_0__::func_692(iLocal_56[1])) && __LIB_0__::func_692(iLocal_56[2])) && __LIB_0__::func_692(iLocal_56[3])) && __LIB_0__::func_692(iLocal_56[4])) && __LIB_0__::func_692(iLocal_56[5])) && __LIB_0__::func_692(iLocal_56[6])) && __LIB_0__::func_695(iLocal_57)) && __LIB_0__::func_695(iLocal_61))
						{
							bLocal_55 = true;
							iVar0 = 0;
							while (iVar0 <= (iLocal_70 - 1))
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(cLocal_73))
				{
					if (iLocal_75)
					{
						...
						while (iVar1 <= (iLocal_70 - 3))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_56[iVar1], false) && !__LIB_6__::func_572(iLocal_56[iVar1], joaat("SCRIPT_TASK_PLAY_ANIM")))
								{
						...
						if ((((__LIB_0__::func_692(iLocal_56[0]) && __LIB_0__::func_692(iLocal_56[1])) && __LIB_0__::func_692(iLocal_56[2])) && __LIB_0__::func_692(iLocal_56[3])) && __LIB_0__::func_692(iLocal_56[4]))
						{
			...
			if (func_166())
			{
				...
				while (iVar2 < 3)
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_68[iVar2]))
					{
						...
						{
							if (!PED::IS_PED_INJURED(iLocal_69[iVar2]) && __LIB_0__::func_695(iLocal_68[iVar2]))
							{
						...
						else if (__LIB_0__::func_695(iLocal_68[iVar2]) && STREAMING::HAS_MODEL_LOADED(joaat("A_M_Y_Jetski_01")))
						{
...
int func_166()//Position - 0x946F
{
	...
	if (__LIB_0__::func_692(PLAYER::PLAYER_PED_ID()))
	{
		if (!__LIB_0__::func_725(PLAYER::PLAYER_PED_ID(), Local_59, 100f, 1) || CAM::IS_SCREEN_FADED_OUT())
		{
			return 1;
		}
	}
...
void func_176()//Position - 0x980B
{
	...
	if (Local_43.f_1 == 1 || Local_43.f_1 == 2)
	{
		...
		__LIB_37__::func_663(Local_43.f_0, &Local_85, &Local_86, &fLocal_87);
		...
		else
		{
			...
			__LIB_38__::func_431(&uLocal_90, iLocal_72);
		}
		iLocal_71 = __LIB_37__::func_662(Local_43.f_1);
		iVar0 = 0;
		while (iVar0 <= (iLocal_70 - 1))
		{
			__LIB_38__::func_431(&uLocal_90, iLocal_70[iVar0]);
			iVar0++;
		}
		__LIB_38__::func_431(&uLocal_90, iLocal_71);
		__LIB_38__::func_430(&uLocal_90, cLocal_73);
	...
	else if (Local_43.f_1 == 3)
	{
		...
		__LIB_38__::func_431(&uLocal_90, iLocal_71);
		__LIB_38__::func_431(&uLocal_90, joaat("A_M_Y_Jetski_01"));
	}
}
...
int func_182()//Position - 0xA3FF
{
	...
	if (Local_43.f_1 != 3 && __LIB_0__::func_683() != 1)
	{
		return 0;
	}
	...
	if (__LIB_0__::func_692(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (((__LIB_0__::func_695(iVar0) && PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iVar0)) && !__LIB_1__::func_606(PLAYER::PLAYER_PED_ID(), iVar0, -1)) && ENTITY::GET_ENTITY_MODEL(iVar0) != joaat("taxi"))
		{
			return 0;
		}
	}
	...
	if (!func_168())
	{
		...
		while (iVar1 <= (iLocal_70 - 1))
		{
			if (__LIB_0__::func_692(iLocal_56[iVar1]))
			{
		...
		{
			if (__LIB_0__::func_692(iLocal_69[iVar1]))
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar2);
				TASK::TASK_PAUSE(0, iVar1 * 110);
				if (__LIB_0__::func_695(iLocal_68[iVar1]) && PED::IS_PED_IN_VEHICLE(iLocal_69[iVar1], iLocal_68[iVar1], false))
				{
		...
		{
			if (__LIB_0__::func_695(iLocal_57) && PED::IS_PED_IN_VEHICLE(iLocal_58, iLocal_57, false))
			{
	...
	if (func_184())
	{
		...
		{
			if (__LIB_0__::func_692(iLocal_56[iVar4]))
			{
				...
				if ((iVar4 % 2) == 0)
				{
					__LIB_14__::func_731(iLocal_56[iVar4], 1);
				}
		...
		{
			if (__LIB_0__::func_695(iLocal_68[iVar4]) && Local_43.f_1 == 3)
			{
				VEHICLE::SET_BOAT_ANCHOR(iLocal_68[iVar4], false);
			}
			if (__LIB_0__::func_692(iLocal_69[iVar4]))
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar3);
				TASK::TASK_PAUSE(0, iVar4 * 60);
				if (__LIB_0__::func_695(iLocal_68[iVar4]) && PED::IS_PED_IN_VEHICLE(iLocal_69[iVar4], iLocal_68[iVar4], false))
				{
				...
				if ((iVar4 % 2) == 0)
				{
					__LIB_14__::func_731(iLocal_69[iVar4], 1);
				}
			}
			iVar4++;
		}
		if (__LIB_0__::func_695(iLocal_57) && Local_43.f_1 == 3)
		{
...
int func_184()//Position - 0xA9C4
{
	...
	if (__LIB_0__::func_725(PLAYER::PLAYER_PED_ID(), Local_44, 50f, 1) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	{
		return 1;
	}
...
bool func_188(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAD60
{
	...
	if (!__LIB_0__::func_121(iParam0) || !__LIB_0__::func_121(iParam1))
	{
		if (iVar2 != -1)
		{
			__LIB_13__::func_439(&(Local_40[iVar2 /*4*/]));
		}
		return 0;
	}
...
void func_206()//Position - 0xB6A5
{
	...
	if (Local_43.f_0 == 1)
	{
		iLocal_89 = __LIB_16__::func_619(374.00833f, 279.59192f, 102.330574f, 40f);
		MISC::CLEAR_AREA_OF_VEHICLES(374.00833f, 279.59192f, 102.330574f, 25f, false, false, false, false, false, false, 0);
	}
	if (Local_43.f_1 == 1 || Local_43.f_1 == 2)
	{
		iLocal_88 = __LIB_16__::func_619(Local_44, 60f);
	}
}
...
void func_208(bool bParam0)//Position - 0xB76E
{
	if (bParam0)
	{
		switch (Local_43.f_0)
		{
			...
			case 2:
			case 3:
				__LIB_38__::func_431(&uLocal_90, joaat("banshee"));
				__LIB_38__::func_431(&uLocal_90, joaat("feltzer2"));
				__LIB_38__::func_431(&uLocal_90, joaat("sentinel"));
				break;
			case 4:
				__LIB_38__::func_431(&uLocal_90, joaat("bati"));
				__LIB_38__::func_431(&uLocal_90, joaat("ruffian"));
				break;
			case 5:
			case 6:
			case 7:
			case 8:
				__LIB_38__::func_431(&uLocal_90, joaat("seashark"));
				break;
		}
	}
	else
	{
		__LIB_38__::func_394(&uLocal_90);
	}
}
...
{
	if (__LIB_0__::func_490(__LIB_15__::func_962(86, 0), Local_44, 1f, 0))
	{
		Local_43.f_0 = 0;
		Local_43.f_1 = 2;
		Local_43.f_3 = 100;
	...
	else if (__LIB_0__::func_490(__LIB_15__::func_962(87, 0), Local_44, 1f, 0))
	{
		Local_43.f_0 = 1;
		Local_43.f_1 = 2;
		Local_43.f_3 = 500;
	...
	else if (__LIB_0__::func_490(__LIB_15__::func_962(88, 0), Local_44, 1f, 0))
	{
		Local_43.f_0 = 2;
		Local_43.f_1 = 2;
		Local_43.f_3 = 1000;
	...
	else if (__LIB_0__::func_490(__LIB_15__::func_962(89, 0), Local_44, 1f, 0))
	{
		Local_43.f_0 = 3;
		Local_43.f_1 = 2;
		Local_43.f_3 = 1250;
	...
	else if (__LIB_0__::func_490(__LIB_15__::func_962(90, 0), Local_44, 1f, 0))
	{
		Local_43.f_0 = 4;
		Local_43.f_1 = 1;
		Local_43.f_3 = 1500;
	...
	else if (__LIB_0__::func_490(__LIB_15__::func_962(82, 0), Local_44, 1f, 0))
	{
		Local_43.f_0 = 5;
		Local_43.f_1 = 3;
		Local_43.f_3 = 0;
	...
	else if (__LIB_0__::func_490(__LIB_15__::func_962(83, 0), Local_44, 1f, 0))
	{
		Local_43.f_0 = 6;
		Local_43.f_1 = 3;
		Local_43.f_3 = 0;
	...
	else if (__LIB_0__::func_490(__LIB_15__::func_962(84, 0), Local_44, 1f, 0))
	{
		Local_43.f_0 = 7;
		Local_43.f_1 = 3;
		Local_43.f_3 = 0;
	...
	else if (__LIB_0__::func_490(__LIB_15__::func_962(85, 0), Local_44, 1f, 0))
	{
		Local_43.f_0 = 8;
		Local_43.f_1 = 3;
		Local_43.f_4 = 24;
...
void func_217(bool bParam0)//Position - 0xBC31
{
	...
	__LIB_38__::func_451(&uLocal_90, 0);
