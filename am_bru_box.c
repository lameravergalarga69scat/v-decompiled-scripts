...
void __EntryFunction__()//Position - 0x0
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		{
			if (__LIB_1__::func_448(PLAYER::PLAYER_ID()) != 1 && !BitTest(Global_2815059.f_900.f_7, 0))
			{
				func_226();
			}
		}
	...
	while (true)
	{
		...
		if (ScriptParam_69.f_16 >= 32)
		{
			if (__LIB_1__::func_448(PLAYER::PLAYER_ID()) != 1 && Global_1888323 == 0)
			{
				func_226();
			}
		}
		...
		switch (__LIB_1__::func_447(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			...
			case 1:
				...
				{
					if ((!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_60.f_3, 500f, 500f, 500f, false, true, 0) && __LIB_1__::func_448(PLAYER::PLAYER_ID()) != 1) && !BitTest(Global_2815059.f_900.f_7, 0))
					{
				...
				break;
			case 3:
				__LIB_1__::func_399(&(Local_60.f_9));
				if (__LIB_1__::func_398(&(Local_60.f_9)))
				{
					Local_62[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 4;
				}
				break;
...
{
	if (Local_60.f_7 >= 32 && __LIB_1__::func_448(PLAYER::PLAYER_ID()) == 1)
	{
	...
	if (!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_60.f_2))
	{
		if (func_215())
		{
			if (NETWORK::CAN_REGISTER_MISSION_OBJECTS(1))
			{
				...
				if (__LIB_1__::func_448(PLAYER::PLAYER_ID()) == 7)
				{
	...
	if (uParam2->f_5)
	{
		if (!Global_2667225.f_701)
		{
			...
			if (!__LIB_0__::func_822(Param0, 0.5f))
			{
				if (func_52(Var12))
				{
					if (!func_13(&Param0, 0, 0, 0, 1) && !__LIB_2__::func_784(&Param0, 0))
					{
						iVar8 += 512;
					}
				}
			...
			if (iVar0 >= (40 + iVar13) || iVar0 >= 100)
			{
				...
				else
				{
					...
					else
					{
						...
						if (func_45(uParam2->f_35, &Var27, &(uParam2->f_38), &(uParam2->f_45), bVar29, 1) || __LIB_1__::func_572(&Var27, bVar29))
						{
							if (!uParam2->f_50)
							{
								uParam2->f_33 = 0;
...
int func_200()//Position - 0xB0EB
{
	...
	if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_60.f_2))
	{
		...
		{
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(NETWORK::NET_TO_OBJ(Local_60.f_2), PLAYER::PLAYER_PED_ID()) && __LIB_0__::func_953(Local_60.f_2))
			{
				__LIB_1__::func_445(&(Local_60.f_2));
