		...
		if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		{
			switch (iLocal_43)
			{
				...
				case 3:
					...
					if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
					{
						if ((__LIB_0__::func_321(PLAYER::PLAYER_ID(), 0) && __LIB_0__::func_896(PLAYER::PLAYER_ID()) == 5) && Global_1963926)
						{
							if (Global_1963927 == 0)
							{
								Global_1963927 = 1;
				...
				case 4:
					...
					else if (MISC::CREATE_INCIDENT(3, Local_45, 4, 3f, &iLocal_47, 0, 0))
					{
						...
						else if (__LIB_0__::func_178(67) && !__LIB_0__::func_178(68))
						{
							Global_96868 = 1;
						}
						iLocal_46 = MISC::GET_GAME_TIMER();
	...
	while (iVar13 < 2)
	{
		switch (iVar13)
		{
			case 0:
				...
				if (__LIB_6__::func_177(fVar8, fVar10, 90f))
				{
					*uParam2 = fVar10;
				}
				else
