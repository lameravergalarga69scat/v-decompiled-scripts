...
void func_7()//Position - 0x1E7
{
	...
	__LIB_0__::do_TEXT_COMMAND_SCALEFORM_STRING(&Global_4541518);
	...
	{
		__LIB_2__::concatAndDo_SCALEFORM_MOVIE_METHOD(Global_20247, "SET_SOFT_KEYS", 3f, 0f, 27f, -1f, -1f, 0, 0, 0, 0, 0);
	}
}
...
{
	func_7();
	__LIB_2__::concatAndDo_SCALEFORM_MOVIE_METHOD(Global_20247, "SET_SOFT_KEYS", 2f, 0f, 27f, -1f, -1f, 0, 0, 0, 0, 0);
}
