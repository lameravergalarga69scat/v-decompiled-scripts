...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_52 = __LIB_17__::func_29(64);
	uLocal_53 = __LIB_17__::func_29(63);
	...
	if (!__LIB_37__::func_305(&iVar4, &Var0, Var1, 1f))
	{
		__LIB_37__::func_262();
	...
	while (true)
	{
		...
		__LIB_37__::func_297(&iLocal_68, &(Var0.f_9), Var1);
		if (Var0.f_0 == 42)
		{
			if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
			{
				CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION(__LIB_38__::func_298(), 4, 0, 0, __LIB_38__::func_297());
		...
		{
			__LIB_37__::func_294(Var0.f_28[1], &uLocal_56, Var0.f_0);
		}
		if (Var0.f_0 == 37)
		{
			__LIB_37__::func_331(&Var0, Var1, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_70);
		}
		else if (Var0.f_0 == 42)
		{
			__LIB_37__::func_296(&Var0, Var1, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (Var0.f_0 == 43)
		{
			func_193(&Var3, &(Var0.f_35[0]), &(Var0.f_28[1]));
			__LIB_37__::func_296(&Var0, -44.75f, -1289.86f, 29.16f, "NIGE3AU", "NIGEL3_AMB", 4, "NIGEL", 8000, 1101004800);
		}
		bVar5 = false;
		if (Var0.f_0 == 41)
		{
		...
		else if (__LIB_37__::func_320(&Var0, 0))
		{
			bVar5 = true;
		}
		if (bVar5)
		{
			...
			{
				__LIB_37__::func_264(Var0.f_0, &iLocal_69);
			}
			if (!func_2(&Var0))
			{
				func_299(&Var0, &Var3, 1);
...
int func_2(int iParam0)//Position - 0x39D
{
	...
	if (!__LIB_0__::func_323())
	{
		if (iParam0->f_16 == 2)
		{
			__LIB_37__::func_316(&(iParam0->f_1), 0);
		}
		else
		{
			__LIB_37__::func_316(&(iParam0->f_1), 1);
		}
	}
...
{
	int iVar0;
	if (__LIB_37__::func_257(&(uParam0->f_1)))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&(uParam0->f_9)))
		{
			__LIB_17__::func_114(1);
			__LIB_14__::func_800(uParam0, 1, __LIB_37__::func_238(*uParam0));
		}
		if (uParam0->f_27)
		{
			if (__LIB_37__::func_237(*uParam0))
			{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_28[iVar0]))
			{
				if (__LIB_0__::func_121(iParam0->f_28[iVar0]))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0->f_28[iVar0], PLAYER::PLAYER_PED_ID(), true) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iParam0->f_28[iVar0], true), 7.5f, true))
					{
						...
						{
							__LIB_37__::func_299(iParam0->f_27, *iParam0);
							return 1;
						}
						else
						{
...
{
	if (__LIB_16__::func_328(uParam1, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
	{
		if (__LIB_37__::func_233(2))
		{
			if (__LIB_37__::func_265(iParam0->f_27))
			{
				__LIB_37__::func_299(iParam0->f_27, *iParam0);
				return 1;
			}
...
int func_218(var uParam0, bool bParam1)//Position - 0xDE8C
{
	...
	if (__LIB_30__::func_871(*uParam0))
	{
		if (*uParam0 == 19)
		{
			__LIB_37__::func_249(uParam0->f_28[0]);
		}
	...
	{
		if (!__LIB_37__::func_260(uParam0, 1, 1))
		{
			if (*uParam0 == 16)
			{
				__LIB_37__::func_259(uParam0);
			}
			else
			{
	...
	{
		if (!__LIB_37__::func_260(uParam0, 0, 1))
		{
			__LIB_37__::func_295(uParam0);
			return 0;
		}
	...
	{
		if (!__LIB_37__::func_260(uParam0, 1, 0))
		{
			__LIB_37__::func_295(uParam0);
			return 0;
		}
	...
	{
		if (!__LIB_37__::func_260(uParam0, 0, 0))
		{
			__LIB_37__::func_295(uParam0);
			return 0;
		}
	...
	{
		__LIB_37__::func_294(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (__LIB_37__::func_248(*uParam0))
					{
						...
						if (__LIB_42__::func_583(uParam0->f_28[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								__LIB_37__::func_295(uParam0);
					...
					if (!__LIB_37__::func_245(*uParam0))
					{
...
int func_253(var uParam0)//Position - 0xF549
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				if (!__LIB_37__::func_267(&(uParam0->f_28[0]), 64, -44.6f, -1289.86f, 29.16f, 22.9f, "RC NIGEL", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				__LIB_17__::func_25(&(uParam0->f_35[0]), iLocal_55, -39.9688f, -1285.9615f, 28.3505f, 181.02f);
				if (__LIB_0__::func_121(uParam0->f_35[0]))
				{
...
int func_263(var uParam0)//Position - 0xFAAA
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!__LIB_37__::func_267(&(uParam0->f_28[0]), 64, -1310.65f, -640.17f, 26.52f, 153.43f, "RC NIGEL", 1))
				{
					bVar2 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				__LIB_17__::func_25(&(uParam0->f_35[0]), iLocal_55, -1304.01f, -644.58f, 25.91f, 127.67f);
				if (__LIB_0__::func_121(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[0], 65, 0);
					VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(uParam0->f_35[0], 5, false);
			...
			{
				__LIB_17__::func_25(&(uParam0->f_35[1]), iVar0[2], -1290.73f, -634.603f, 26.1004f, 126.961f);
...
int func_273(var uParam0)//Position - 0x10BDE
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				__LIB_17__::func_25(&(uParam0->f_35[0]), iVar0[3], -1010.97f, 359.91f, 70.65f, 331.46f);
				if (__LIB_0__::func_121(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_35[0], 5f);
		...
		case 3:
			...
			__LIB_17__::func_25(&(uParam0->f_35[1]), iVar0[4], -1018.26f, 357.76f, 70.2f, 339.52f);
			if (__LIB_0__::func_121(uParam0->f_35[1]))
			{
				VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[1], 27, 27);
			}
			__LIB_17__::func_42(&(uParam0->f_28[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			...
			__LIB_17__::func_42(&(uParam0->f_28[1]), iVar0[1], -1058.43f, 362.78f, 69.86f, 130.45f, 26);
			...
			__LIB_17__::func_42(&(uParam0->f_28[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
...
int func_277(var uParam0)//Position - 0x111C9
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			...
			break;
		case 2:
			__LIB_17__::func_42(&(uParam0->f_28[0]), iVar0[0], -552.66f, 287.75f, 82.18f, 123.75f, 26);
			__LIB_17__::func_42(&(uParam0->f_28[1]), iVar0[1], -553.46f, 287.34f, 82.18f, -65.86f, 26);
			if (__LIB_0__::func_692(uParam0->f_28[1]))
			{
			...
			__LIB_17__::func_42(&(uParam0->f_28[2]), iVar0[2], -559.94f, 285.99f, 85.38f, -59.06f, 26);
			__LIB_17__::func_42(&(uParam0->f_28[3]), iVar0[3], -558.87f, 289.79f, 85.38f, 162.44f, 26);
			__LIB_17__::func_42(&(uParam0->f_28[4]), iVar0[4], -559f, 286.09f, 85.38f, 65.92f, 26);
			__LIB_17__::func_42(&(uParam0->f_28[5]), iVar0[5], -558.84f, 288.97f, 85.38f, -7.72f, 26);
			if (__LIB_0__::func_692(uParam0->f_28[2]))
			{
			...
			__LIB_17__::func_25(&(uParam0->f_35[0]), iVar0[6], -553.55f, 308.61f, 82.81f, 202.78f);
			if (__LIB_0__::func_121(uParam0->f_35[0]))
			{
...
int func_285(var uParam0)//Position - 0x14CB4
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			bVar3 = true;
			if (!__LIB_37__::func_267(&(uParam0->f_28[0]), 64, -1100.5f, 789.8f, 164.34f, 1.82f, "RC: NIGEL", 1))
			{
				bVar3 = false;
			}
			if (!__LIB_37__::func_267(&(uParam0->f_28[1]), 63, -1099.35f, 789.15f, 164.47f, 0f, "RC: MRS THORNHILL", 1))
			{
				bVar3 = false;
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				__LIB_17__::func_25(&(uParam0->f_35[0]), iLocal_55, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
				if (__LIB_0__::func_121(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[0], 65, 0);
					VEHICLE::SET_DOOR_ALLOWED_TO_BE_BROKEN_OFF(uParam0->f_35[0], 5, false);
