...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		if (iLocal_228 == 1)
		{
			if (bLocal_176 == 0)
			{
				__LIB_33__::func_304(&uLocal_211);
			}
			else
			{
				__LIB_2__::func_819(&Local_178, 1, 1, 0, 0, 1045220557, 0, 1065353216, 0);
...
void func_8()//Position - 0xB88
{
	...
	{
		__LIB_33__::func_305(&uLocal_211);
		__LIB_2__::func_816(&Local_178, 0, 1);
		__LIB_15__::func_808(&uLocal_188, &uLocal_227, 0, 0, 1, 1);
...
void func_15(bool bParam0)//Position - 0xE40
{
	...
	if (__LIB_0__::func_715(PLAYER::PLAYER_PED_ID()))
	{
		if (bParam0)
		{
			__LIB_15__::func_231(&uLocal_227, 0);
		}
		Local_178.f_20 = 160;
		Local_178.f_21 = 20;
		if (bLocal_176)
		{
			...
			__LIB_15__::func_234(&Local_178, Var0, ENTITY::GET_ENTITY_ROTATION(PLAYER::PLAYER_PED_ID(), 2), 50f, Local_178.f_20, Local_178.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
			CAM::ATTACH_CAM_TO_PED_BONE(Local_178.f_0, PLAYER::PLAYER_PED_ID(), 31086, 0f, -0.25f, 0f, true);
		}
		else
		{
			__LIB_15__::func_233(&uLocal_211, 1);
			__LIB_15__::func_237(&uLocal_211, 0, 3000);
		}
...
void func_24()//Position - 0x131E
{
	...
	if (__LIB_0__::func_715(iLocal_161))
	{
...
void func_31()//Position - 0x14FC
{
	...
	__LIB_14__::func_813(&uLocal_40, 0, iLocal_158);
	__LIB_14__::func_813(&uLocal_40, 1, iLocal_159);
	__LIB_14__::func_814(&uLocal_40, 2, 2, sLocal_160, 0);
	__LIB_14__::func_814(&uLocal_40, 3, 4, "SCRIPT\FERRIS_WHALE_01", 0);
	__LIB_14__::func_814(&uLocal_40, 4, 4, "SCRIPT\FERRIS_WHALE_02", 0);
	while (!__LIB_15__::func_238(&uLocal_40))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (__LIB_0__::func_715(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
	{
		...
		{
			__LIB_14__::func_592(-1663.7396f, -1111.4716f, 11.591353f, -1663.5123f, -1139.9479f, 24.017221f, 16.5f, -1673.8156f, -1133.745f, 12.0226f, 92.5556f, 1, 1, 1, 0, 0);
		}
		else if (__LIB_39__::func_426(PLAYER::GET_PLAYERS_LAST_VEHICLE(), joaat("sandking")))
		{
			__LIB_14__::func_592(-1663.7396f, -1111.4716f, 11.591353f, -1663.5123f, -1139.9479f, 24.017221f, 16.5f, -1684.36f, -1129.6064f, 12.1347f, 105.6507f, 1, 1, 1, 0, 0);
		}
		else
		{
			__LIB_14__::func_592(-1663.7396f, -1111.4716f, 11.591353f, -1663.5123f, -1139.9479f, 24.017221f, 16.5f, -1570.8074f, -1022.1135f, 12.018f, 215.3015f, 1, 1, 1, 0, 0);
		}
	}
	if (__LIB_0__::func_715(PLAYER::PLAYER_PED_ID()))
	{
		...
		ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), false, false);
		__LIB_14__::func_808(PLAYER::PLAYER_PED_ID(), -1668.4982f, -1125.6273f, 12.0699f);
		ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), 44.1132f);
	}
	__LIB_0__::func_544(64, 1, 0, 1, 0);
	__LIB_15__::func_809(&uLocal_188, -1703.854f, -1082.2223f, 42.006f, -8.3096f, 0f, -111.8213f, 0, 0);
	func_33();
	if (__LIB_0__::func_715(PLAYER::PLAYER_PED_ID()))
	{
		ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), true, false);
...
void func_34(var uParam0, int iParam1, bool bParam2)//Position - 0x190E
{
	...
	while (iVar0 < 2)
	{
		...
		if (iVar2 != 0)
		{
			...
			if (__LIB_0__::func_715(uParam0->f_4[iVar0]))
			{
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x6F24
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_78130[1 /*14*/] = { __LIB_13__::func_798(iVar10, iVar0, func_80(iParam0, iVar0, -1), -1) };
...
void func_211(bool bParam0)//Position - 0x25A23
{
	...
	__LIB_15__::func_231(&uLocal_227, 0);
	__LIB_15__::func_231(&iLocal_177, 0);
	__LIB_2__::func_816(&Local_178, 0, 1);
	if (AUDIO::IS_AUDIO_SCENE_ACTIVE("FAIRGROUND_RIDES_FERRIS_WHALE"))
	{
		AUDIO::STOP_AUDIO_SCENE("FAIRGROUND_RIDES_FERRIS_WHALE");
	...
	if (bParam0)
	{
		...
		SYSTEM::WAIT(125);
		__LIB_0__::func_84(500, 0);
		__LIB_16__::func_48(8, 1);
	}
	__LIB_15__::func_239(&uLocal_40);
	__LIB_0__::func_716(303, 0, 0);
...
void func_256()//Position - 0x2783E
{
	...
	__LIB_2__::func_814(&iLocal_174);
	__LIB_2__::func_814(&iLocal_174);
	__LIB_2__::func_814(&iLocal_171);
	__LIB_2__::func_814(&iLocal_172);
	__LIB_14__::func_808(PLAYER::PLAYER_PED_ID(), -1658.5f, -1125.5f, 13f);
