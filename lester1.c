				...
				case 2:
					if (!bLocal_2268)
					{
						if (func_450() > 0)
						{
							...
							__LIB_0__::do_TEXT_COMMAND_SCALEFORM_STRING("LES1A_AV2");
							GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
							if (!iLocal_391)
							{
						...
						else
						{
							GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_171, "OPEN_ANTIVIRUS");
							GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
							__LIB_0__::do_TEXT_COMMAND_SCALEFORM_STRING("LES1A_AV1");
							GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
							bLocal_2268 = true;
							if (iLocal_2264 != 4)
							{
