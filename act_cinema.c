		...
		switch (iLocal_187)
		{
			...
			case 1:
				...
				if (func_1217(PLAYER::PLAYER_ID()))
				{
					...
					if ((PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && (__LIB_0__::func_39(6) || __LIB_0__::func_39(7))) && __LIB_34__::func_688(Local_163.f_14))
					{
