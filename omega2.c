...
void func_5()//Position - 0x280
{
	...
	{
		case 0:
			__LIB_0__::func_222(&uLocal_60, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			__LIB_14__::func_878(&iLocal_59, &(Local_39.f_35[0]));
			bLocal_225 = false;
		...
		case 1:
			if (__LIB_0__::func_121(PLAYER::PLAYER_PED_ID()))
			{
				...
				else if (!bLocal_225)
				{
					...
					{
						bLocal_225 = __LIB_0__::func_787(&uLocal_60, "SCRAPAU", "SCRAP_DOCK", 7, 0, 0, 0);
					}
				}
			}
			break;
...
void func_46()//Position - 0x1016
{
	switch (iLocal_41)
	{
		case 0:
			...
			Global_32209 = 0;
			__LIB_14__::func_851("SCRAP_2_RCM", 0);
			if (__LIB_14__::func_740(1, 1093140480, 0))
			{
				...
				SYSTEM::WAIT(0);
				__LIB_14__::func_592(2314.6006f, 2592.442f, 43.6477f, 2331.976f, 2571.0579f, 50.62959f, 19f, 2313.334f, 2600.8425f, 45.8162f, 352.0448f, 1, 1, 1, 0, 0);
...
int func_65(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x17E1
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_78130[1 /*14*/] = { __LIB_13__::func_798(iVar10, iVar0, func_74(iParam0, iVar0, -1), -1) };
...
void func_219()//Position - 0x22337
{
	...
	if (func_221())
	{
		if (MISC::GET_GAME_TIMER() < iLocal_44 && !__LIB_0__::func_687(PLAYER::PLAYER_PED_ID(), Local_39.f_28[0], 5f, 1))
		{
...
void func_241()//Position - 0x22E27
{
	...
	else if (!iLocal_57)
	{
		if (__LIB_0__::func_121(Local_39.f_35[0]))
		{
			...
			__LIB_8__::func_397(&(Local_39.f_35[0]));
...
int func_271(var uParam0)//Position - 0x23DDE
{
	...
	switch (iLocal_37)
	{
		...
		case 2:
			...
			{
				if (!__LIB_14__::func_842(&(uParam0->f_28[0]), 69, 2319.443f, 2583.5881f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
