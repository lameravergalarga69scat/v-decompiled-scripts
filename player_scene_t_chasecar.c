...
void __EntryFunction__()//Position - 0x0
{
	...
	func_89();
	__LIB_17__::func_501();
	while (iLocal_446 && __LIB_39__::func_36(4, 0))
	{
		SYSTEM::WAIT(0);
		switch (iLocal_267)
		{
...
int func_2()//Position - 0x1D4
{
			...
			while (iVar2 < 4)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_447[iVar2]))
				{
					if (!PED::IS_PED_INJURED(iLocal_447[iVar2]))
					{
						...
						{
							__LIB_0__::func_345(&uLocal_434, 0, 0);
							iLocal_483 = iVar1;
						}
						return 0;
					}
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_464))
	{
		...
		{
			__LIB_14__::func_615(&uLocal_434, iLocal_447[iVar1], &Local_464, 0, 1, 1, 1);
			if (CAM::IS_GAMEPLAY_HINT_ACTIVE())
			{
				iLocal_483 = iVar1;
			}
...
int func_3(char* sParam0, int* iParam1, int iParam2)//Position - 0x317
{
	...
	if (!__LIB_37__::func_437(iParam1, fVar1))
	{
		return 0;
	}
	...
	__LIB_0__::func_222(&uLocal_269, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	if (__LIB_0__::func_787(&uLocal_269, "PRSAUD", &Var0, 3, 0, 0, 0))
	{
		if (iLocal_470 > 0)
		{
			iLocal_470++;
...
int func_78(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)//Position - 0x2CC3
{
	...
	{
		if (!__LIB_0__::func_787(&uLocal_269, "PRSAUD", &Local_474, 3, 0, 0, 0))
		{
			return 0;
		}
		else
...
void func_90()//Position - 0x324F
{
	...
	__LIB_17__::func_688(iLocal_268, &Local_458, &uVar1, &fLocal_462, &fLocal_463, &uVar2, &uVar3, &uVar4);
	switch (iLocal_268)
	{
		case 281:
