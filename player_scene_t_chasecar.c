...
void __EntryFunction__()//Position - 0x0
{
	...
	func_89();
	__LIB_17__::func_504();
	while (iLocal_446 && __LIB_38__::func_711(4, 0))
	{
		SYSTEM::WAIT(0);
		switch (iLocal_267)
		{
...
int func_3(char* sParam0, int* iParam1, int iParam2)//Position - 0x317
{
	...
	if (!__LIB_37__::func_111(iParam1, fVar1))
	{
		return 0;
	}
...
void func_90()//Position - 0x324F
{
	...
	__LIB_17__::func_691(iLocal_268, &Local_458, &uVar1, &fLocal_462, &fLocal_463, &uVar2, &uVar3, &uVar4);
	switch (iLocal_268)
	{
		case 281:
