...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		{
			case 0:
				if (__LIB_0__::func_792())
				{
					if (__LIB_0__::func_787(&uLocal_53, "TOWAUD", "TONYA_HANG", 8, 0, 0, 0))
					{
						iLocal_37 = 1;
					}
				}
...
int func_1()//Position - 0x1F5
{
	...
	if ((SYSTEM::VDIST2(Var0, Var1) > 10000f || ENTITY::IS_ENTITY_DEAD(iLocal_38, false)) || __LIB_0__::func_789())
	{
	...
	switch (iLocal_40)
	{
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_38) && !ENTITY::IS_ENTITY_DEAD(iLocal_38, false))
			{
				...
				else if (TASK::GET_SEQUENCE_PROGRESS(iLocal_38) == 2)
				{
					...
					if (iVar4 == 0)
					{
						if (__LIB_0__::func_787(&uLocal_53, "TOWAUD", "TONYA_CALL1", 8, 0, 0, 0))
						{
							iLocal_40 = 2;
						}
					}
					else if (__LIB_0__::func_787(&uLocal_53, "TOWAUD", "TONYA_CALL2", 8, 0, 0, 0))
					{
						iLocal_40 = 2;
					}
				}
		...
		case 3:
			...
			if (SYSTEM::VDIST2(Var0, Var1) < 25f)
			{
				...
				{
					if (__LIB_0__::func_787(&uLocal_53, "TOWAUD", "TONYA_MESS", 8, 0, 0, 0))
					{
						SYSTEM::SETTIMERA(0);
						iLocal_40 = 4;
					}
