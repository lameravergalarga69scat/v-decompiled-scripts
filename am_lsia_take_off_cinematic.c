...
void func_55()//Position - 0x1311
{
	...
	{
		__LIB_2__.func_335(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
		__LIB_39__.func_711();
	}
}
...
int func_158(var uParam0)//Position - 0xABAC
{
	...
	if (!__LIB_0__.func_121(__LIB_18__.func_363()))
	{
		return 0;
	}
	iVar0 = __LIB_25__.func_11();
	...
	{
		uParam0->f_23 = PED::CLONE_PED_ALT(__LIB_18__.func_363(), false, false, true, true);
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23))
		{
			return 0;
		}
	...
	{
		uParam0->f_23 = PED::CLONE_PED_ALT(__LIB_18__.func_363(), false, false, false, false);
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23))
		{
			return 0;
		}
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar5 < 127)
		{
			if (BitTest((*uParam1)[(iVar5 / 32)], (iVar5 % 32)))
			{
				...
				{
					if (__LIB_25__.func_10(iParam0, &Var0, iVar5, Var0.f_4, Var0.f_8, bVar2, bVar3, bParam2, bVar4))
					{
		...
		while (iVar6 < iVar7)
		{
			if (FILES::GET_TATTOO_SHOP_DLC_ITEM_DATA(iVar1, iVar6, &Var8))
			{
				if (!FILES::IS_CONTENT_ITEM_LOCKED(Var8.f_0))
				{
					...
					{
						if (__LIB_25__.func_10(iParam0, &(Var8.f_7), iVar9, Var8.f_2, Var8.f_6, bVar2, bVar3, bParam2, bVar4))
						{
			...
			switch (iVar0)
			{
				...
				case 1:
					switch (iVar1)
					{
						...
						case 7:
						case 12:
							iVar2 = __LIB_18__.func_431(joaat("MP_M_Freemode_01"), 11, func_181(iParam0, 11, -1), 0);
				...
				case 5:
					if (!bParam1)
					{
						if (__LIB_18__.func_338(13, -1))
						{
							return 1;
						}
						else if (__LIB_18__.func_338(14, -1))
						{
							return 1;
						}
						else if (__LIB_18__.func_338(15, -1))
						{
							return 1;
						}
						else if (__LIB_18__.func_338(16, -1))
						{
							return 1;
						}
						else if (__LIB_18__.func_338(71, -1))
						{
							return 1;
						}
						else if (__LIB_18__.func_338(72, -1))
						{
						}
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar7 = __LIB_18__.func_431(joaat("MP_F_Freemode_01"), 11, func_181(iParam0, 11, -1), 0);
			...
			switch (iVar0)
			{
				case 0:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar10 = __LIB_18__.func_431(joaat("MP_F_Freemode_01"), 11, func_181(iParam0, 11, -1), 0);
				...
				case 1:
					switch (iVar1)
					{
						...
						case 4:
						case 9:
							iVar11 = __LIB_18__.func_431(joaat("MP_F_Freemode_01"), 11, func_181(iParam0, 11, -1), 0);
...
void func_287()//Position - 0x33132
{
	...
	__LIB_2__.func_171(&uLocal_93, joaat("nimbus"), "Plane_1");
	__LIB_2__.func_163(&uLocal_93, 1);
	__LIB_7__.func_168(&uLocal_93, -1249.1444f, -3200.4622f, 13.5621f, 1.8349f, -0.2505f, 59.0838f, "hs4_lsa_take_nimb2", 0, 0, 1, 0);
}
